...
*/
  ...
  String getAscii(int length) =>
      bytes.getAscii(offset: rIndex, length: length);
  ...
  String getUtf8(int length) => bytes.getUtf8(offset: rIndex, length: length);
  ...
  Uint8List get contentsRead =>
      bytes.buffer.asUint8List(bytes.offset, rIndex);
