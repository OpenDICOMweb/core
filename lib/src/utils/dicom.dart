...
const int kGroup4Length = 0x00040000;
...
const int kOffsetOfTheNextDirectoryRecord = 0x00041400;
const int kRecordInUseFlag = 0x00041410;
const int kOffsetOfReferencedLowerLevelDirectoryEntity = 0x00041420;
const int kDirectoryRecordType = 0x00041430;
const int kPrivateRecordUID = 0x00041432;
const int kReferencedFileID = 0x00041500;
const int kMRDRDirectoryRecordOffset = 0x00041504;
const int kReferencedSOPClassUIDInFile = 0x00041510;
const int kReferencedSOPInstanceUIDInFile = 0x00041511;
const int kReferencedTransferSyntaxUIDInFile = 0x00041512;
const int kReferencedRelatedGeneralSOPClassUIDInFile = 0x0000151A;
const int kNumberOfReferences = 0x00041600;
const int kGroup8Length = 0x00080000;
...
const int kPrivateDataElementCharacteristicsSequence = 0x0080300;
const int kPrivateGroupReference = 0x00080301;
const int kPrivateCreatorReference = 0x00080302;
const int kBlockIdentifyingInformationStatus = 0x00080303;
const int kNonidentifyingPrivateElements = 0x00080304;
const int kDeidentificationActionSequence = 0x00080305;
...
const int kGroup10Length = 0x00100000;
...
const int kSourcePatientGroupIdentificationSequence = 0x00100026;
const int kGroupOfPatientsIdentificationSequence = 0x00100027;
const int kSubjectRelativePositionInImage = 0x00100028;
...
const int kStrainDescription = 0x00100212;
const int kStrainNomenclature = 0x00100213;
const int kStrainStockNumber = 0x00100214;
const int kStrainSourceRegistryCodeSequence = 0x00100215;
const int kStrainStockSequence = 0x00100216;
const int kStrainSource = 0x00100217;
const int kStrainAdditionalInformation = 0x00100218;
const int kStrainCodeSequence = 0x00100219;
const int kGeneticModificationsSequence = 0x00100221;
const int kGeneticModificationsDescription = 0x00100222;
...
const int kGroup12Length = 0x00120000;
...
const int kGroup14Length = 0x000140000;
...
const int kLongPrimitivePointIndexList = 0x00660040;
const int kLongTrianglePointIndexList = 0x00660041;
const int kLongEdgePointIndexList = 0x00660042;
const int kLongVertexPointIndexList = 0x00660043;
const int kTrackSetSequence = 0x00660101;
const int kTrackSequence = 0x00660102;
const int kRecommendedDisplayCIELabValueList = 0x00660103;
const int kTrackingAlgorithmIdentificationSequence = 0x00660104;
const int kTrackSetNumber = 0x00660105;
const int kTrackSetLabel = 0x00660106;
const int kTrackSetDescription = 0x00660107;
const int kTrackSetAnatomicalTypeCodeSequence = 0x00660108;
const int kMeasurementsSequence = 0x00660121;
const int kTrackSetStatisticsSequence = 0x00660124;
...
const int kRowsForNthOrderCoefficients = 0x002804F0;
const int kColumnsForNthOrderCoefficients = 0x002804F1;
const int kCoefficientCoding = 0x002804F2;
const int kCoefficientCodingPointers = 0x002804F3;
