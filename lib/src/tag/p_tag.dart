...
*/
 ...
 // int get index => pTagCodes.indexOf(code);
  ...
  static PTag lookupByCode(int code, [int vrIndex = kUNIndex, bool shouldThrow = false]) {
  ...
  static PTag lookupByKeyword(String keyword, [int vrIndex, bool shouldThrow = true]) {
...
*/
  ...
  static const PTag kTransferSyntaxUID = const PTag._(
      'TransferSyntaxUID', 0x00020010, 'Transfer Syntax UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kImplementationVersionName = const PTag._('ImplementationVersionName',
      0x00020013, 'Implementation Version Name', kSHIndex, VM.k1, false);
  ...
  static const PTag kPrivateInformation = const PTag._(
      'PrivateInformation', 0x00020102, 'Private Information', kOBIndex, VM.k1, false);

  //**** DICOM Directory Tags begin here ****
  static const PTag kFileSetID =
      const PTag._('FileSetID', 0x00041130, 'File-set ID', kCSIndex, VM.k1, false);
  ...
  static const PTag kRecordInUseFlag = const PTag._(
      'RecordInUseFlag', 0x00041410, 'Record In-use Flag', kUSIndex, VM.k1, false);
  ...
  static const PTag kDirectoryRecordType = const PTag._(
      'DirectoryRecordType', 0x00041430, 'Directory​Record​Type', kCSIndex, VM.k1, false);

  static const PTag kPrivateRecordUID = const PTag._(
      'PrivateRecordUID', 0x00041432, 'Private Record UID', kUIIndex, VM.k1, false);

  static const PTag kReferencedFileID = const PTag._(
      'ReferencedFileID', 0x00041500, 'Referenced File ID', kCSIndex, VM.k1_8, false);

  static const PTag kMRDRDirectoryRecordOffset = const PTag._('MRDRDirectoryRecordOffset',
      0x00041504, 'MRDR Directory Record Offset', kULIndex, VM.k1, true);
  ...
  static const PTag kNumberOfReferences = const PTag._(
      'NumberOfReferences', 0x00041600, 'Number of References', kULIndex, VM.k1, true);

  //**** Standard Dataset Tags begin here ****

  static const PTag kLengthToEnd
      //(0008,0001) '00080001'
      = const PTag._('LengthToEnd', 0x00080001, 'Length to End', kULIndex, VM.k1, true);
  static const PTag kSpecificCharacterSet
      //(0008,0005)
      = const PTag._('SpecificCharacterSet', 0x00080005, 'Specific Character Set', kCSIndex,
          VM.k1_n, false);
  static const PTag kLanguageCodeSequence
      //(0008,0006)
      = const PTag._('LanguageCodeSequence', 0x00080006, 'Language Code Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kImageType
      //(0008,0008)
      = const PTag._('ImageType', 0x00080008, 'Image Type', kCSIndex, VM.k2_n, false);
  static const PTag kRecognitionCode
      //(0008,0010)
      = const PTag._(
          'RecognitionCode', 0x00080010, 'Recognition Code', kSHIndex, VM.k1, true);
  static const PTag kInstanceCreationDate
      //(0008,0012)
      = const PTag._('InstanceCreationDate', 0x00080012, 'Instance Creation Date', kDAIndex,
          VM.k1, false);
  static const PTag kInstanceCreationTime
      //(0008,0013)
      = const PTag._('InstanceCreationTime', 0x00080013, 'Instance Creation Time', kTMIndex,
          VM.k1, false);
  static const PTag kInstanceCreatorUID
      //(0008,0014)
      = const PTag._(
          'InstanceCreatorUID', 0x00080014, 'Instance Creator UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kSOPClassUID
      //(0008,0016)
      = const PTag._('SOPClassUID', 0x00080016, 'SOP Class UID', kUIIndex, VM.k1, false);
  static const PTag kSOPInstanceUID
      //(0008,0018)
      = const PTag._(
          'SOPInstanceUID', 0x00080018, 'SOP Instance UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kStudyDate
      //(0008,0020)
      = const PTag._('StudyDate', 0x00080020, 'Study Date', kDAIndex, VM.k1, false);
  static const PTag kSeriesDate
      //(0008,0021)
      = const PTag._('SeriesDate', 0x00080021, 'Series Date', kDAIndex, VM.k1, false);
  static const PTag kAcquisitionDate
      //(0008,0022)
      = const PTag._(
          'AcquisitionDate', 0x00080022, 'Acquisition Date', kDAIndex, VM.k1, false);
  static const PTag kContentDate
      //(0008,0023)
      = const PTag._('ContentDate', 0x00080023, 'Content Date', kDAIndex, VM.k1, false);
  static const PTag kOverlayDate
      //(0008,0024)
      = const PTag._('OverlayDate', 0x00080024, 'Overlay Date', kDAIndex, VM.k1, true);
  static const PTag kCurveDate
      //(0008,0025)
      = const PTag._('CurveDate', 0x00080025, 'Curve Date', kDAIndex, VM.k1, true);
  static const PTag kAcquisitionDateTime
      //(0008,002A)
      = const PTag._('AcquisitionDateTime', 0x0008002A, 'Acquisition DateTime', kDTIndex,
          VM.k1, false);
  static const PTag kStudyTime
      //(0008,0030)
      = const PTag._('StudyTime', 0x00080030, 'Study Time', kTMIndex, VM.k1, false);
  static const PTag kSeriesTime
      //(0008,0031)
      = const PTag._('SeriesTime', 0x00080031, 'Series Time', kTMIndex, VM.k1, false);
  static const PTag kAcquisitionTime
      //(0008,0032)
      = const PTag._(
          'AcquisitionTime', 0x00080032, 'Acquisition Time', kTMIndex, VM.k1, false);
  static const PTag kContentTime
      //(0008,0033)
      = const PTag._('ContentTime', 0x00080033, 'Content Time', kTMIndex, VM.k1, false);
  static const PTag kOverlayTime
      //(0008,0034)
      = const PTag._('OverlayTime', 0x00080034, 'Overlay Time', kTMIndex, VM.k1, true);
  static const PTag kCurveTime
      //(0008,0035)
      = const PTag._('CurveTime', 0x00080035, 'Curve Time', kTMIndex, VM.k1, true);
  static const PTag kDataSetType
      //(0008,0040)
      = const PTag._('DataSetType', 0x00080040, 'Data Set Type', kUSIndex, VM.k1, true);
  static const PTag kDataSetSubtype
      //(0008,0041)
      =
      const PTag._('DataSetSubtype', 0x00080041, 'Data Set Subtype', kLOIndex, VM.k1, true);
  ...
  static const PTag kAccessionNumber
      //(0008,0050)
      = const PTag._(
          'AccessionNumber', 0x00080050, 'Accession Number', kSHIndex, VM.k1, false);
  ...
  static const PTag kQueryRetrieveLevel
      //(0008,0052)
      = const PTag._(
          'QueryRetrieveLevel', 0x00080052, 'Query/Retrieve Level', kCSIndex, VM.k1, false);
  static const PTag kQueryRetrieveView
      //(0008,0053)
      = const PTag._(
          'QueryRetrieveView', 0x00080053, 'Query/Retrieve View', kCSIndex, VM.k1, false);
  static const PTag kRetrieveAETitle
      //(0008,0054)
      = const PTag._(
          'RetrieveAETitle', 0x00080054, 'Retrieve AE Title', kAEIndex, VM.k1_n, false);
  static const PTag kInstanceAvailability
      //(0008,0056)
      = const PTag._('InstanceAvailability', 0x00080056, 'Instance Availability', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kModalitiesInStudy
      //(0008,0061)
      = const PTag._(
          'ModalitiesInStudy', 0x00080061, 'Modalities in Study', kCSIndex, VM.k1_n, false);
  static const PTag kSOPClassesInStudy
      //(0008,0062)
      = const PTag._('SOPClassesInStudy', 0x00080062, 'SOP Classes in Study', kUIIndex,
          VM.k1_n, false);
  static const PTag kConversionType
      //(0008,0064)
      =
      const PTag._('ConversionType', 0x00080064, 'Conversion Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kManufacturer
      //(0008,0070)
      = const PTag._('Manufacturer', 0x00080070, 'Manufacturer', kLOIndex, VM.k1, false);
  static const PTag kInstitutionName
      //(0008,0080)
      = const PTag._(
          'InstitutionName', 0x00080080, 'Institution Name', kLOIndex, VM.k1, false);
  static const PTag kInstitutionAddress
      //(0008,0081)
      = const PTag._(
          'InstitutionAddress', 0x00080081, 'Institution Address', kSTIndex, VM.k1, false);
  ...
  static const PTag kReferringPhysicianIdentificationSequence
      ...
      = const PTag._('ReferringPhysicianIdentificationSequence', 0x00080096,
          'Referring Physician Identification Sequence', kSQIndex, VM.k1, false);
  static const PTag kCodeValue
      //(0008,0100)
      = const PTag._('CodeValue', 0x00080100, 'Code Value', kSHIndex, VM.k1, false);
  static const PTag kExtendedCodeValue
      //(0008,0101)
      = const PTag._(
          'ExtendedCodeValue', 0x00080101, 'Extended Code Value', kLOIndex, VM.k1, false);
  ...
  static const PTag kCodingSchemeVersion
      //(0008,0103)
      = const PTag._('CodingSchemeVersion', 0x00080103, 'Coding Scheme Version', kSHIndex,
          VM.k1, false);
  static const PTag kCodeMeaning
      //(0008,0104)
      = const PTag._('CodeMeaning', 0x00080104, 'Code Meaning', kLOIndex, VM.k1, false);
  static const PTag kMappingResource
      //(0008,0105)
      = const PTag._(
          'MappingResource', 0x00080105, 'Mapping Resource', kCSIndex, VM.k1, false);
  static const PTag kContextGroupVersion
      //(0008,0106)
      = const PTag._('ContextGroupVersion', 0x00080106, 'Context Group Version', kDTIndex,
          VM.k1, false);
  ...
  static const PTag kExtendedCodeMeaning
      //(0008,0108)
      = const PTag._('ExtendedCodeMeaning', 0x00080108, 'Extended Code Meaning', kLTIndex,
          VM.k1, false);
  ...
  static const PTag kCodingSchemeUID
      //(0008,010C)
      = const PTag._(
          'CodingSchemeUID', 0x0008010C, 'Coding Scheme UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kContextIdentifier
      //(0008,010F)
      = const PTag._(
          'ContextIdentifier', 0x0008010F, 'Context Identifier', kCSIndex, VM.k1, false);
  ...
  static const PTag kCodingSchemeRegistry
      //(0008,0112)
      = const PTag._('CodingSchemeRegistry', 0x00080112, 'Coding Scheme Registry', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kCodingSchemeName
      //(0008,0115)
      = const PTag._(
          'CodingSchemeName', 0x00080115, 'Coding Scheme Name', kSTIndex, VM.k1, false);
  ...
  static const PTag kContextUID
      //(0008,0117)
      = const PTag._('ContextUID', 0x00080117, 'Context UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kNetworkID
      //(0008,1000)
      = const PTag._('NetworkID', 0x00081000, 'Network ID', kAEIndex, VM.k1, true);
  static const PTag kStationName
      //(0008,1010)
      = const PTag._('StationName', 0x00081010, 'Station Name', kSHIndex, VM.k1, false);
  static const PTag kStudyDescription
      //(0008,1030)
      = const PTag._(
          'StudyDescription', 0x00081030, 'Study Description', kLOIndex, VM.k1, false);
  ...
  static const PTag kSeriesDescription
      //(0008,103E)
      = const PTag._(
          'SeriesDescription', 0x0008103E, 'Series Description', kLOIndex, VM.k1, false);
  ...
  static const PTag kPhysiciansOfRecord
      //(0008,1048)
      = const PTag._('PhysiciansOfRecord', 0x00081048, 'Physician(s) of Record', kPNIndex,
          VM.k1_n, false);
  static const PTag kPhysiciansOfRecordIdentificationSequence
      ...
      = const PTag._('PhysiciansOfRecordIdentificationSequence', 0x00081049,
          'Physician(s) of Record Identification Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kPerformingPhysicianIdentificationSequence
      ...
      = const PTag._('PerformingPhysicianIdentificationSequence', 0x00081052,
          'Performing Physician Identification Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kPhysiciansReadingStudyIdentificationSequence
      ...
      = const PTag._('PhysiciansReadingStudyIdentificationSequence', 0x00081062,
          'Physician(s) Reading Study Identification Sequence', kSQIndex, VM.k1, false);
  static const PTag kOperatorsName
      //(0008,1070)
      = const PTag._(
          'OperatorsName', 0x00081070, 'Operators\' Name', kPNIndex, VM.k1_n, false);
  ...
  static const PTag kReferencedPerformedProcedureStepSequence
      ...
      = const PTag._('ReferencedPerformedProcedureStepSequence', 0x00081111,
          'Referenced Performed Procedure Step Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kReferencedRealWorldValueMappingInstanceSequence
      ...
      = const PTag._('ReferencedRealWorldValueMappingInstanceSequence', 0x0008114B,
          'Referenced Real World Value Mapping Instance Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSOPClassesSupported
      //(0008,115A)
      = const PTag._('SOPClassesSupported', 0x0008115A, 'SOP Classes Supported', kUIIndex,
          VM.k1_n, false);
  ...
  static const PTag kSimpleFrameList
      //(0008,1161)
      = const PTag._(
          'SimpleFrameList', 0x00081161, 'Simple Frame List', kULIndex, VM.k1_n, false);
  static const PTag kCalculatedFrameList
      //(0008,1162)
      = const PTag._('CalculatedFrameList', 0x00081162, 'Calculated Frame List', kULIndex,
          VM.k3_3n, false);
  static const PTag kTimeRange
      //(0008,1163)
      = const PTag._('TimeRange', 0x00081163, 'TimeRange', kFDIndex, VM.k2, false);
  ...
  static const PTag kRetrieveURL
      //(0008,1190)
      = const PTag._('RetrieveURL', 0x00081190, 'Retrieve URL', kURIndex, VM.k1, false);
  static const PTag kTransactionUID
      //(0008,1195)
      =
      const PTag._('TransactionUID', 0x00081195, 'Transaction UID', kUIIndex, VM.k1, false);
  static const PTag kWarningReason
      //(0008,1196)
      = const PTag._('WarningReason', 0x00081196, 'Warning Reason', kUSIndex, VM.k1, false);
  static const PTag kFailureReason
      //(0008,1197)
      = const PTag._('FailureReason', 0x00081197, 'Failure Reason', kUSIndex, VM.k1, false);
  static const PTag kFailedSOPSequence
      //(0008,1198)
      = const PTag._(
          'FailedSOPSequence', 0x00081198, 'Failed SOP Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kStudiesContainingOtherReferencedInstancesSequence
      ...
      = const PTag._('StudiesContainingOtherReferencedInstancesSequence', 0x00081200,
          'Studies Containing Other Referenced Instances Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSourceImageSequence
      //(0008,2112)
      = const PTag._('SourceImageSequence', 0x00082112, 'Source Image Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kStageName
      //(0008,2120)
      = const PTag._('StageName', 0x00082120, 'Stage Name', kSHIndex, VM.k1, false);
  static const PTag kStageNumber
      //(0008,2122)
      = const PTag._('StageNumber', 0x00082122, 'Stage Number', kISIndex, VM.k1, false);
  static const PTag kNumberOfStages
      //(0008,2124)
      = const PTag._(
          'NumberOfStages', 0x00082124, 'Number of Stages', kISIndex, VM.k1, false);
  static const PTag kViewName
      //(0008,2127)
      = const PTag._('ViewName', 0x00082127, 'View Name', kSHIndex, VM.k1, false);
  static const PTag kViewNumber
      //(0008,2128)
      = const PTag._('ViewNumber', 0x00082128, 'View Number', kISIndex, VM.k1, false);
  static const PTag kNumberOfEventTimers
      //(0008,2129)
      = const PTag._('NumberOfEventTimers', 0x00082129, 'Number of Event Timers', kISIndex,
          VM.k1, false);
  ...
  static const PTag kEventElapsedTimes
      //(0008,2130)
      = const PTag._('EventElapsedTimes', 0x00082130, 'Event Elapsed Time(s)', kDSIndex,
          VM.k1_n, false);
  static const PTag kEventTimerNames
      //(0008,2132)
      = const PTag._(
          'EventTimerNames', 0x00082132, 'Event Timer Name(s)', kLOIndex, VM.k1_n, false);
  static const PTag kEventTimerSequence
      //(0008,2133)
      = const PTag._(
          'EventTimerSequence', 0x00082133, 'Event Timer Sequence', kSQIndex, VM.k1, false);
  static const PTag kEventTimeOffset
      //(0008,2134)
      = const PTag._(
          'EventTimeOffset', 0x00082134, 'Event Time Offset', kFDIndex, VM.k1, false);
  static const PTag kEventCodeSequence
      //(0008,2135)
      = const PTag._(
          'EventCodeSequence', 0x00082135, 'Event Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kStartTrim
      //(0008,2142)
      = const PTag._('StartTrim', 0x00082142, 'Start Trim', kISIndex, VM.k1, false);
  ...
  static const PTag kTransducerPosition
      //(0008,2200)
      = const PTag._(
          'TransducerPosition', 0x00082200, 'Transducer Position', kCSIndex, VM.k1, true);
  ...
  static const PTag kAnatomicStructure
      //(0008,2208)
      = const PTag._(
          'AnatomicStructure', 0x00082208, 'Anatomic Structure', kCSIndex, VM.k1, true);
  ...
  static const PTag kAnatomicStructureSpaceOrRegionSequence
      ...
      = const PTag._('AnatomicStructureSpaceOrRegionSequence', 0x00082229,
          'Anatomic Structure: Space or Region Sequence', kSQIndex, VM.k1, false);
  static const PTag kPrimaryAnatomicStructureModifierSequence
      ...
      = const PTag._('PrimaryAnatomicStructureModifierSequence', 0x00082230,
          'Primary Anatomic Structure Modifier Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kAnatomicPortalOfEntranceCodeSequenceTrial
      ...
      = const PTag._('AnatomicPortalOfEntranceCodeSequenceTrial', 0x00082253,
          'Anatomic Portal Of Entrance Code Sequence (Trial)', kSQIndex, VM.k1, true);
  static const PTag kAnatomicApproachDirectionCodeSequenceTrial
      ...
      = const PTag._('AnatomicApproachDirectionCodeSequenceTrial', 0x00082255,
          'Anatomic Approach Direction Code Sequence (Trial)', kSQIndex, VM.k1, true);
  ...
  static const PTag kIrradiationEventUID
      //(0008,3010)
      = const PTag._('IrradiationEventUID', 0x00083010, 'Irradiation Event UID', kUIIndex,
          VM.k1_n, false);
  static const PTag kIdentifyingComments
      //(0008,4000)
      = const PTag._(
          'IdentifyingComments', 0x00084000, 'Identifying Comments', kLTIndex, VM.k1, true);
  static const PTag kFrameType
      //(0008,9007)
      = const PTag._('FrameType', 0x00089007, 'Frame Type', kCSIndex, VM.k4, false);
  ...
  static const PTag kCreatorVersionUID
      //(0008,9123)
      = const PTag._(
          'CreatorVersionUID', 0x00089123, 'Creator-Version UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kPixelPresentation
      //(0008,9205)
      = const PTag._(
          'PixelPresentation', 0x00089205, 'Pixel Presentation', kCSIndex, VM.k1, false);
  static const PTag kVolumetricProperties
      //(0008,9206)
      = const PTag._('VolumetricProperties', 0x00089206, 'Volumetric Properties', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kAcquisitionContrast
      //(0008,9209)
      = const PTag._('AcquisitionContrast', 0x00089209, 'Acquisition Contrast', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kFrameDisplaySequence
      //(0008,9458)
      = const PTag._('FrameDisplaySequence', 0x00089458, 'Frame Display Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kSkipFrameRangeFlag
      //(0008,9460)
      = const PTag._('SkipFrameRangeFlag', 0x00089460, 'Skip Frame Range Flag', kCSIndex,
          VM.k1, false);
  static const PTag kPatientName
      //(0010,0010)
      = const PTag._('PatientName', 0x00100010, 'Patient\'s Name', kPNIndex, VM.k1, false);
  static const PTag kPatientID
      //(0010,0020)
      = const PTag._('PatientID', 0x00100020, 'Patient ID', kLOIndex, VM.k1, false);
  static const PTag kIssuerOfPatientID
      //(0010,0021)
      = const PTag._(
          'IssuerOfPatientID', 0x00100021, 'Issuer of Patient ID', kLOIndex, VM.k1, false);
  static const PTag kTypeOfPatientID
      //(0010,0022)
      = const PTag._(
          'TypeOfPatientID', 0x00100022, 'Type of Patient ID', kCSIndex, VM.k1, false);
  ...
  static const PTag kPatientBirthDate
      //(0010,0030)
      = const PTag._(
          'PatientBirthDate', 0x00100030, 'Patient\'s Birth Date', kDAIndex, VM.k1, false);
  static const PTag kPatientBirthTime
      //(0010,0032)
      = const PTag._(
          'PatientBirthTime', 0x00100032, 'Patient\'s Birth Time', kTMIndex, VM.k1, false);
  static const PTag kPatientSex
      //(0010,0040)
      = const PTag._('PatientSex', 0x00100040, 'Patient\'s Sex', kCSIndex, VM.k1, false);
  ...
  static const PTag kPatientPrimaryLanguageModifierCodeSequence
      ...
      = const PTag._('PatientPrimaryLanguageModifierCodeSequence', 0x00100102,
          'Patient\'s Primary Language Modifier Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kStrainDescription
      //(0010,0212)
      = const PTag._(
          'StrainDescription', 0x00100212, 'Strain Description', kUCIndex, VM.k1, false);
  static const PTag kStrainNomenclature
      //(0010,0213)
      = const PTag._(
          'StrainNomenclature', 0x00100213, 'Strain​Nomenclature', kLOIndex, VM.k1, false);
  static const PTag kStrainStockNumber
      //(0010,0214)
      = const PTag._(
          'StrainStockNumber', 0x00100214, 'Strain​Stock​Number', kLOIndex, VM.k1, false);
  ...
  static const PTag kStrainStockSequence
      //(0010,0216)
      = const PTag._('StrainStockSequence', 0x00100216, 'Strain Stock Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kStrainSource
      //(0010,0217)
      = const PTag._('StrainSource', 0x00100217, 'Strain Source', kLOIndex, VM.k1, false);
  ...
  static const PTag kStrainCodeSequence
      //(0010,0219)
      = const PTag._(
          'StrainCodeSequence', 0x00100219, 'Strain Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kOtherPatientIDs
      //(0010,1000)
      = const PTag._(
          'OtherPatientIDs', 0x00101000, 'Other Patient IDs', kLOIndex, VM.k1_n, false);
  static const PTag kOtherPatientNames
      //(0010,1001)
      = const PTag._(
          'OtherPatientNames', 0x00101001, 'Other Patient Names', kPNIndex, VM.k1_n, false);
  ...
  static const PTag kPatientBirthName
      //(0010,1005)
      = const PTag._(
          'PatientBirthName', 0x00101005, 'Patient\'s Birth Name', kPNIndex, VM.k1, false);
  static const PTag kPatientAge
      //(0010,1010)
      = const PTag._('PatientAge', 0x00101010, 'Patient\'s Age', kASIndex, VM.k1, false);
  static const PTag kPatientSize
      //(0010,1020)
      = const PTag._('PatientSize', 0x00101020, 'Patient\'s Size', kDSIndex, VM.k1, false);
  ...
  static const PTag kPatientWeight
      //(0010,1030)
      = const PTag._(
          'PatientWeight', 0x00101030, 'Patient\'s Weight', kDSIndex, VM.k1, false);
  static const PTag kPatientAddress
      //(0010,1040)
      = const PTag._(
          'PatientAddress', 0x00101040, 'Patient\'s Address', kLOIndex, VM.k1, false);
  ...
  static const PTag kMilitaryRank
      //(0010,1080)
      = const PTag._('MilitaryRank', 0x00101080, 'Military Rank', kLOIndex, VM.k1, false);
  static const PTag kBranchOfService
      //(0010,1081)
      = const PTag._(
          'BranchOfService', 0x00101081, 'Branch of Service', kLOIndex, VM.k1, false);
  static const PTag kMedicalRecordLocator
      //(0010,1090)
      = const PTag._('MedicalRecordLocator', 0x00101090, 'Medical Record Locator', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kMedicalAlerts
      //(0010,2000)
      =
      const PTag._('MedicalAlerts', 0x00102000, 'Medical Alerts', kLOIndex, VM.k1_n, false);
  static const PTag kAllergies
      //(0010,2110)
      = const PTag._('Allergies', 0x00102110, 'Allergies', kLOIndex, VM.k1_n, false);
  static const PTag kCountryOfResidence
      //(0010,2150)
      = const PTag._(
          'CountryOfResidence', 0x00102150, 'Country of Residence', kLOIndex, VM.k1, false);
  static const PTag kRegionOfResidence
      //(0010,2152)
      = const PTag._(
          'RegionOfResidence', 0x00102152, 'Region of Residence', kLOIndex, VM.k1, false);
  ...
  static const PTag kEthnicGroup
      //(0010,2160)
      = const PTag._('EthnicGroup', 0x00102160, 'Ethnic Group', kSHIndex, VM.k1, false);
  static const PTag kOccupation
      //(0010,2180)
      = const PTag._('Occupation', 0x00102180, 'Occupation', kSHIndex, VM.k1, false);
  static const PTag kSmokingStatus
      //(0010,21A0)
      = const PTag._('SmokingStatus', 0x001021A0, 'Smoking Status', kCSIndex, VM.k1, false);
  ...
  static const PTag kPregnancyStatus
      //(0010,21C0)
      = const PTag._(
          'PregnancyStatus', 0x001021C0, 'Pregnancy Status', kUSIndex, VM.k1, false);
  static const PTag kLastMenstrualDate
      //(0010,21D0)
      = const PTag._(
          'LastMenstrualDate', 0x001021D0, 'Last Menstrual Date', kDAIndex, VM.k1, false);
  ...
  static const PTag kPatientSexNeutered
      //(0010,2203)
      = const PTag._('PatientSexNeutered', 0x00102203, 'Patient\'s Sex Neutered', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kResponsiblePerson
      //(0010,2297)
      = const PTag._(
          'ResponsiblePerson', 0x00102297, 'Responsible Person', kPNIndex, VM.k1, false);
  ...
  static const PTag kPatientComments
      //(0010,4000)
      = const PTag._(
          'PatientComments', 0x00104000, 'Patient Comments', kLTIndex, VM.k1, false);
  ...
  static const PTag kClinicalTrialSiteID
      //(0012,0030)
      = const PTag._('ClinicalTrialSiteID', 0x00120030, 'Clinical Trial Site ID', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kClinicalTrialProtocolEthicsCommitteeName
      ...
      = const PTag._('ClinicalTrialProtocolEthicsCommitteeName', 0x00120081,
          'Clinical Trial Protocol Ethics Committee Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kDistributionType
      //(0012,0084)
      = const PTag._(
          'DistributionType', 0x00120084, 'Distribution Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kCADFileFormat
      //(0014,0023)
      =
      const PTag._('CADFileFormat', 0x00140023, 'CAD File Format', kSTIndex, VM.k1, true);
  ...
  static const PTag kMaterialThickness
      //(0014,0030)
      = const PTag._(
          'MaterialThickness', 0x00140030, 'Material Thickness', kDSIndex, VM.k1_n, false);
  static const PTag kMaterialPipeDiameter
      //(0014,0032)
      = const PTag._('MaterialPipeDiameter', 0x00140032, 'Material Pipe Diameter', kDSIndex,
          VM.k1_n, false);
  ...
  static const PTag kMaterialGrade
      //(0014,0042)
      =
      const PTag._('MaterialGrade', 0x00140042, 'Material Grade', kSTIndex, VM.k1, false);
  ...
  static const PTag kMaterialNotes
      //(0014,0046)
      = const PTag._('MaterialNotes', 0x00140046, 'Material Notes', kLTIndex, VM.k1, false);
  static const PTag kComponentShape
      //(0014,0050)
      =
      const PTag._('ComponentShape', 0x00140050, 'Component Shape', kCSIndex, VM.k1, false);
  static const PTag kCurvatureType
      //(0014,0052)
      = const PTag._('CurvatureType', 0x00140052, 'Curvature Type', kCSIndex, VM.k1, false);
  static const PTag kOuterDiameter
      //(0014,0054)
      = const PTag._('OuterDiameter', 0x00140054, 'Outer Diameter', kDSIndex, VM.k1, false);
  static const PTag kInnerDiameter
      //(0014,0056)
      = const PTag._('InnerDiameter', 0x00140056, 'Inner Diameter', kDSIndex, VM.k1, false);
  ...
  static const PTag kExpiryDate
      //(0014,1020)
      = const PTag._('ExpiryDate', 0x00141020, 'Expiry Date', kDAIndex, VM.k1, false);
  ...
  static const PTag kEvaluatorSequence
      //(0014,2002)
      = const PTag._(
          'EvaluatorSequence', 0x00142002, 'Evaluator Sequence', kSQIndex, VM.k1, false);
  static const PTag kEvaluatorNumber
      //(0014,2004)
      = const PTag._(
          'EvaluatorNumber', 0x00142004, 'Evaluator Number', kISIndex, VM.k1, false);
  static const PTag kEvaluatorName
      //(0014,2006)
      = const PTag._('EvaluatorName', 0x00142006, 'Evaluator Name', kPNIndex, VM.k1, false);
  static const PTag kEvaluationAttempt
      //(0014,2008)
      = const PTag._(
          'EvaluationAttempt', 0x00142008, 'Evaluation Attempt', kISIndex, VM.k1, false);
  static const PTag kIndicationSequence
      //(0014,2012)
      = const PTag._(
          'IndicationSequence', 0x00142012, 'Indication Sequence', kSQIndex, VM.k1, false);
  static const PTag kIndicationNumber
      //(0014,2014)
      = const PTag._(
          'IndicationNumber', 0x00142014, 'Indication Number', kISIndex, VM.k1, false);
  static const PTag kIndicationLabel
      //(0014,2016)
      = const PTag._(
          'IndicationLabel', 0x00142016, 'Indication Label', kSHIndex, VM.k1, false);
  ...
  static const PTag kIndicationType
      //(0014,201A)
      = const PTag._(
          'IndicationType', 0x0014201A, 'Indication Type', kCSIndex, VM.k1_n, false);
  ...
  static const PTag kPropertyLabel
      //(0014,2032)
      = const PTag._('PropertyLabel', 0x00142032, 'Property Label', kSHIndex, VM.k1, false);
  ...
  static const PTag kTransformDescription
      //(0014,2222)
      = const PTag._('TransformDescription', 0x00142222, 'Transform Description', kSTIndex,
          VM.k1, false);
  ...
  static const PTag kTransformedAxisUnits
      //(0014,2228)
      = const PTag._('TransformedAxisUnits', 0x00142228, 'Transformed Axis Units', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kCoordinateSystemTransformTranslationMatrix
      ...
      = const PTag._('CoordinateSystemTransformTranslationMatrix', 0x0014222C,
          'Coordinate System Transform Translation Matrix', kDSIndex, VM.k1_n, false);
  ...
  static const PTag kSensorName
      //(0014,3022)
      = const PTag._('SensorName', 0x00143022, 'Sensor Name', kSTIndex, VM.k1, false);
  ...
  static const PTag kSensorTemperature
      //(0014,3028)
      = const PTag._(
          'SensorTemperature', 0x00143028, 'Sensor Temperature', kDSIndex, VM.k1, false);
  static const PTag kDarkCurrentSequence
      //(0014,3040)
      = const PTag._('DarkCurrentSequence', 0x00143040, 'Dark Current Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kDarkCurrentCounts
      //(0014,3050)
      = const PTag._(
          'DarkCurrentCounts', 0x00143050, 'Dark Current Counts', kOBOWIndex, VM.k1, false);
  ...
  static const PTag kAirCounts
      //(0014,3070)
      = const PTag._('AirCounts', 0x00143070, 'Air Counts', kOBOWIndex, VM.k1, false);
  ...
  static const PTag kBadPixelImage
      //(0014,3080)
      =
      const PTag._('BadPixelImage', 0x00143080, 'Bad Pixel Image', kOBIndex, VM.k1, false);
  static const PTag kCalibrationNotes
      //(0014,3099)
      = const PTag._(
          'CalibrationNotes', 0x00143099, 'Calibration Notes', kLTIndex, VM.k1, false);
  ...
  static const PTag kPulserType
      //(0014,4004)
      = const PTag._('PulserType', 0x00144004, 'Pulser Type', kCSIndex, VM.k1, false);
  static const PTag kPulserNotes
      //(0014,4006)
      = const PTag._('PulserNotes', 0x00144006, 'Pulser Notes', kLTIndex, VM.k1, false);
  ...
  static const PTag kAmplifierType
      //(0014,400A)
      = const PTag._('AmplifierType', 0x0014400A, 'Amplifier Type', kCSIndex, VM.k1, false);
  static const PTag kReceiverNotes
      //(0014,400C)
      = const PTag._('ReceiverNotes', 0x0014400C, 'Receiver Notes', kLTIndex, VM.k1, false);
  ...
  static const PTag kPreAmplifierNotes
      //(0014,400F)
      = const PTag._(
          'PreAmplifierNotes', 0x0014400F, 'Pre-Amplifier Notes', kLTIndex, VM.k1, false);
  ...
  static const PTag kNumberOfElements
      //(0014,4012)
      = const PTag._(
          'NumberOfElements', 0x00144012, 'Number of Elements', kUSIndex, VM.k1, false);
  static const PTag kElementShape
      //(0014,4013)
      = const PTag._('ElementShape', 0x00144013, 'Element Shape', kCSIndex, VM.k1, false);
  static const PTag kElementDimensionA
      //(0014,4014)
      = const PTag._(
          'ElementDimensionA', 0x00144014, 'Element Dimension A', kDSIndex, VM.k1, false);
  static const PTag kElementDimensionB
      //(0014,4015)
      = const PTag._(
          'ElementDimensionB', 0x00144015, 'Element Dimension B', kDSIndex, VM.k1, false);
  static const PTag kElementPitchA
      //(0014,4016)
      =
      const PTag._('ElementPitchA', 0x00144016, 'Element Pitch A', kDSIndex, VM.k1, false);
  ...
  static const PTag kNominalFrequency
      //(0014,401A)
      = const PTag._(
          'NominalFrequency', 0x0014401A, 'Nominal Frequency', kDSIndex, VM.k1, false);
  ...
  static const PTag kMeasuredBandwidth
      //(0014,401C)
      = const PTag._(
          'MeasuredBandwidth', 0x0014401C, 'Measured Bandwidth', kDSIndex, VM.k1, false);
  static const PTag kElementPitchB
      //(0014,401D)
      =
      const PTag._('ElementPitchB', 0x0014401D, 'Element Pitch B', kDSIndex, VM.k1, false);
  ...
  static const PTag kPulseWidth
      //(0014,4022)
      = const PTag._('PulseWidth', 0x00144022, 'Pulse Width', kDSIndex, VM.k1, false);
  static const PTag kExcitationFrequency
      //(0014,4024)
      = const PTag._('ExcitationFrequency', 0x00144024, 'Excitation Frequency', kDSIndex,
          VM.k1, false);
  static const PTag kModulationType
      //(0014,4026)
      =
      const PTag._('ModulationType', 0x00144026, 'Modulation Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kRectifierSmoothing
      //(0014,4034)
      = const PTag._(
          'RectifierSmoothing', 0x00144034, 'Rectifier Smoothing', kDSIndex, VM.k1, false);
  static const PTag kDACSequence
      //(0014,4035)
      = const PTag._('DACSequence', 0x00144035, 'DAC Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kDACGainPoints
      //(0014,4038)
      = const PTag._(
          'DACGainPoints', 0x00144038, 'DAC Gain Points', kDSIndex, VM.k1_n, false);
  static const PTag kDACTimePoints
      //(0014,403A)
      = const PTag._(
          'DACTimePoints', 0x0014403A, 'DAC Time Points', kDSIndex, VM.k1_n, false);
  static const PTag kDACAmplitude
      //(0014,403C)
      = const PTag._('DACAmplitude', 0x0014403C, 'DAC Amplitude', kDSIndex, VM.k1_n, false);
  ...
  static const PTag kIncidentAngle
      //(0014,4052)
      = const PTag._('IncidentAngle', 0x00144052, 'Incident Angle', kDSIndex, VM.k1, false);
  static const PTag kCouplingTechnique
      //(0014,4054)
      = const PTag._(
          'CouplingTechnique', 0x00144054, 'Coupling Technique', kSTIndex, VM.k1, false);
  static const PTag kCouplingMedium
      //(0014,4056)
      =
      const PTag._('CouplingMedium', 0x00144056, 'Coupling Medium', kSTIndex, VM.k1, false);
  static const PTag kCouplingVelocity
      //(0014,4057)
      = const PTag._(
          'CouplingVelocity', 0x00144057, 'Coupling Velocity', kDSIndex, VM.k1, false);
  ...
  static const PTag kSoundPathLength
      //(0014,405A)
      = const PTag._(
          'SoundPathLength', 0x0014405A, 'Sound Path Length', kDSIndex, VM.k1, false);
  static const PTag kDelayLawIdentifier
      //(0014,405C)
      = const PTag._(
          'DelayLawIdentifier', 0x0014405C, 'Delay Law Identifier', kSTIndex, VM.k1, false);
  static const PTag kGateSettingsSequence
      //(0014,4060)
      = const PTag._('GateSettingsSequence', 0x00144060, 'Gate Settings Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kGateThreshold
      //(0014,4062)
      = const PTag._('GateThreshold', 0x00144062, 'Gate Threshold', kDSIndex, VM.k1, false);
  static const PTag kVelocityOfSound
      //(0014,4064)
      = const PTag._(
          'VelocityOfSound', 0x00144064, 'Velocity of Sound', kDSIndex, VM.k1, false);
  ...
  static const PTag kCalibrationProcedure
      //(0014,4072)
      = const PTag._('CalibrationProcedure', 0x00144072, 'Calibration Procedure', kSTIndex,
          VM.k1, false);
  static const PTag kProcedureVersion
      //(0014,4074)
      = const PTag._(
          'ProcedureVersion', 0x00144074, 'Procedure Version', kSHIndex, VM.k1, false);
  ...
  static const PTag kCalibrationTime
      //(0014,407C)
      = const PTag._(
          'CalibrationTime', 0x0014407C, 'Calibration Time', kTMIndex, VM.k1_n, false);
  static const PTag kCalibrationDate
      //(0014,407E)
      = const PTag._(
          'CalibrationDate', 0x0014407E, 'Calibration Date', kDAIndex, VM.k1_n, false);
  ...
  static const PTag kDriveType
      //(0014,4081)
      = const PTag._('DriveType', 0x00144081, 'Drive Type', kCSIndex, VM.k1, false);
  static const PTag kProbeDriveNotes
      //(0014,4082)
      = const PTag._(
          'ProbeDriveNotes', 0x00144082, 'Probe Drive Notes', kLTIndex, VM.k1, false);
  static const PTag kDriveProbeSequence
      //(0014,4083)
      = const PTag._(
          'DriveProbeSequence', 0x00144083, 'Drive Probe Sequence', kSQIndex, VM.k1, false);
  static const PTag kProbeInductance
      //(0014,4084)
      = const PTag._(
          'ProbeInductance', 0x00144084, 'Probe Inductance', kDSIndex, VM.k1, false);
  static const PTag kProbeResistance
      //(0014,4085)
      = const PTag._(
          'ProbeResistance', 0x00144085, 'Probe Resistance', kDSIndex, VM.k1, false);
  static const PTag kReceiveProbeSequence
      //(0014,4086)
      = const PTag._('ReceiveProbeSequence', 0x00144086, 'Receive Probe Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kBridgeResistors
      //(0014,4088)
      = const PTag._(
          'BridgeResistors', 0x00144088, 'Bridge Resistors', kDSIndex, VM.k1, false);
  ...
  static const PTag kUserSelectedGainY
      //(0014,408B)
      = const PTag._(
          'UserSelectedGainY', 0x0014408B, 'User Selected Gain Y', kDSIndex, VM.k1, false);
  static const PTag kUserSelectedPhase
      //(0014,408C)
      = const PTag._(
          'UserSelectedPhase', 0x0014408C, 'User Selected Phase', kDSIndex, VM.k1, false);
  static const PTag kUserSelectedOffsetX
      //(0014,408D)
      = const PTag._('UserSelectedOffsetX', 0x0014408D, 'User Selected Offset X', kDSIndex,
          VM.k1, false);
  static const PTag kUserSelectedOffsetY
      //(0014,408E)
      = const PTag._('UserSelectedOffsetY', 0x0014408E, 'User Selected Offset Y', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kChannelThreshold
      //(0014,4092)
      = const PTag._(
          'ChannelThreshold', 0x00144092, 'Channel Threshold', kDSIndex, VM.k1, false);
  ...
  static const PTag kScanProcedure
      //(0014,409B)
      = const PTag._('ScanProcedure', 0x0014409B, 'Scan Procedure', kSTIndex, VM.k1, false);
  static const PTag kTranslationRateX
      //(0014,409C)
      = const PTag._(
          'TranslationRateX', 0x0014409C, 'Translation Rate X', kDSIndex, VM.k1, false);
  static const PTag kTranslationRateY
      //(0014,409D)
      = const PTag._(
          'TranslationRateY', 0x0014409D, 'Translation Rate Y', kDSIndex, VM.k1, false);
  static const PTag kChannelOverlap
      //(0014,409F)
      =
      const PTag._('ChannelOverlap', 0x0014409F, 'Channel Overlap', kDSIndex, VM.k1, false);
  ...
  static const PTag kLINACEnergy
      //(0014,5002)
      = const PTag._('LINACEnergy', 0x00145002, 'LINAC Energy', kISIndex, VM.k1, false);
  static const PTag kLINACOutput
      //(0014,5004)
      = const PTag._('LINACOutput', 0x00145004, 'LINAC Output', kISIndex, VM.k1, false);
  static const PTag kContrastBolusAgent
      //(0018,0010)
      = const PTag._(
          'ContrastBolusAgent', 0x00180010, 'Contrast/Bolus Agent', kLOIndex, VM.k1, false);
  ...
  static const PTag kContrastBolusAdministrationRouteSequence
      ...
      = const PTag._('ContrastBolusAdministrationRouteSequence', 0x00180014,
          'Contrast/Bolus Administration Route Sequence', kSQIndex, VM.k1, false);
  static const PTag kBodyPartExamined
      //(0018,0015)
      = const PTag._(
          'BodyPartExamined', 0x00180015, 'Body Part Examined', kCSIndex, VM.k1, false);
  static const PTag kScanningSequence
      //(0018,0020)
      = const PTag._(
          'ScanningSequence', 0x00180020, 'Scanning Sequence', kCSIndex, VM.k1_n, false);
  static const PTag kSequenceVariant
      //(0018,0021)
      = const PTag._(
          'SequenceVariant', 0x00180021, 'Sequence Variant', kCSIndex, VM.k1_n, false);
  static const PTag kScanOptions
      //(0018,0022)
      = const PTag._('ScanOptions', 0x00180022, 'Scan Options', kCSIndex, VM.k1_n, false);
  static const PTag kMRAcquisitionType
      //(0018,0023)
      = const PTag._(
          'MRAcquisitionType', 0x00180023, 'MR Acquisition Type', kCSIndex, VM.k1, false);
  static const PTag kSequenceName
      //(0018,0024)
      = const PTag._('SequenceName', 0x00180024, 'Sequence Name', kSHIndex, VM.k1, false);
  static const PTag kAngioFlag
      //(0018,0025)
      = const PTag._('AngioFlag', 0x00180025, 'Angio Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kInterventionDrugDose
      //(0018,0028)
      = const PTag._('InterventionDrugDose', 0x00180028, 'Intervention Drug Dose', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kRadionuclide
      //(0018,0030)
      = const PTag._('Radionuclide', 0x00180030, 'Radionuclide', kLOIndex, VM.k1_n, true);
  static const PTag kRadiopharmaceutical
      //(0018,0031)
      = const PTag._(
          'Radiopharmaceutical', 0x00180031, 'Radiopharmaceutical', kLOIndex, VM.k1, false);
  ...
  static const PTag kEnergyWindowTotalWidth
      ...
      = const PTag._('EnergyWindowTotalWidth', 0x00180033, 'Energy Window Total Width',
          kDSIndex, VM.k1_n, true);
  static const PTag kInterventionDrugName
      //(0018,0034)
      = const PTag._('InterventionDrugName', 0x00180034, 'Intervention Drug Name', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kInterventionSequence
      //(0018,0036)
      = const PTag._('InterventionSequence', 0x00180036, 'Intervention Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kTherapyType
      //(0018,0037)
      = const PTag._('TherapyType', 0x00180037, 'Therapy Type', kCSIndex, VM.k1, true);
  static const PTag kInterventionStatus
      //(0018,0038)
      = const PTag._(
          'InterventionStatus', 0x00180038, 'Intervention Status', kCSIndex, VM.k1, false);
  static const PTag kTherapyDescription
      //(0018,0039)
      = const PTag._(
          'TherapyDescription', 0x00180039, 'Therapy Description', kCSIndex, VM.k1, true);
  ...
  static const PTag kInitialCineRunState
      //(0018,0042)
      = const PTag._('InitialCineRunState', 0x00180042, 'Initial Cine Run State', kCSIndex,
          VM.k1, false);
  static const PTag kSliceThickness
      //(0018,0050)
      =
      const PTag._('SliceThickness', 0x00180050, 'Slice Thickness', kDSIndex, VM.k1, false);
  ...
  static const PTag kCountsAccumulated
      //(0018,0070)
      = const PTag._(
          'CountsAccumulated', 0x00180070, 'Counts Accumulated', kISIndex, VM.k1, false);
  ...
  static const PTag kEffectiveDuration
      //(0018,0072)
      = const PTag._(
          'EffectiveDuration', 0x00180072, 'Effective Duration', kDSIndex, VM.k1, false);
  ...
  static const PTag kRepetitionTime
      //(0018,0080)
      =
      const PTag._('RepetitionTime', 0x00180080, 'Repetition Time', kDSIndex, VM.k1, false);
  ...
  static const PTag kInversionTime
      //(0018,0082)
      = const PTag._('InversionTime', 0x00180082, 'Inversion Time', kDSIndex, VM.k1, false);
  static const PTag kNumberOfAverages
      //(0018,0083)
      = const PTag._(
          'NumberOfAverages', 0x00180083, 'Number of Averages', kDSIndex, VM.k1, false);
  static const PTag kImagingFrequency
      //(0018,0084)
      = const PTag._(
          'ImagingFrequency', 0x00180084, 'Imaging Frequency', kDSIndex, VM.k1, false);
  static const PTag kImagedNucleus
      //(0018,0085)
      = const PTag._('ImagedNucleus', 0x00180085, 'Imaged Nucleus', kSHIndex, VM.k1, false);
  static const PTag kEchoNumbers
      //(0018,0086)
      = const PTag._('EchoNumbers', 0x00180086, 'Echo Number(s)', kISIndex, VM.k1_n, false);
  ...
  static const PTag kSpacingBetweenSlices
      //(0018,0088)
      = const PTag._('SpacingBetweenSlices', 0x00180088, 'Spacing Between Slices', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kEchoTrainLength
      //(0018,0091)
      = const PTag._(
          'EchoTrainLength', 0x00180091, 'Echo Train Length', kISIndex, VM.k1, false);
  static const PTag kPercentSampling
      //(0018,0093)
      = const PTag._(
          'PercentSampling', 0x00180093, 'Percent Sampling', kDSIndex, VM.k1, false);
  ...
  static const PTag kPixelBandwidth
      //(0018,0095)
      =
      const PTag._('PixelBandwidth', 0x00180095, 'Pixel Bandwidth', kDSIndex, VM.k1, false);
  static const PTag kDeviceSerialNumber
      //(0018,1000)
      = const PTag._(
          'DeviceSerialNumber', 0x00181000, 'Device Serial Number', kLOIndex, VM.k1, false);
  static const PTag kDeviceUID
      //(0018,1002)
      = const PTag._('DeviceUID', 0x00181002, 'Device UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kGeneratorID
      //(0018,1005)
      = const PTag._('GeneratorID', 0x00181005, 'Generator ID', kLOIndex, VM.k1, false);
  static const PTag kGridID
      //(0018,1006)
      = const PTag._('GridID', 0x00181006, 'Grid ID', kLOIndex, VM.k1, false);
  static const PTag kCassetteID
      //(0018,1007)
      = const PTag._('CassetteID', 0x00181007, 'Cassette ID', kLOIndex, VM.k1, false);
  ...
  static const PTag kSecondaryCaptureDeviceManufacturerModelName
      ...
      = const PTag._('SecondaryCaptureDeviceManufacturerModelName', 0x00181018,
          'Secondary Capture Device Manufacturer\'s Model Name', kLOIndex, VM.k1, false);
  static const PTag kSecondaryCaptureDeviceSoftwareVersions
      //(0018,1019)
      = const PTag._('SecondaryCaptureDeviceSoftwareVersions', 0x00181019,
          'Secondary Capture Device Software Versions', kLOIndex, VM.k1_n, false);
  ...
  static const PTag kSoftwareVersions
      //(0018,1020)
      = const PTag._(
          'SoftwareVersions', 0x00181020, 'Software Version(s)', kLOIndex, VM.k1_n, false);
  ...
  static const PTag kProtocolName
      //(0018,1030)
      = const PTag._('ProtocolName', 0x00181030, 'Protocol Name', kLOIndex, VM.k1, false);
  static const PTag kContrastBolusRoute
      //(0018,1040)
      = const PTag._(
          'ContrastBolusRoute', 0x00181040, 'Contrast/Bolus Route', kLOIndex, VM.k1, false);
  static const PTag kContrastBolusVolume
      //(0018,1041)
      = const PTag._('ContrastBolusVolume', 0x00181041, 'Contrast/Bolus Volume', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kSyringeCounts
      //(0018,1045)
      = const PTag._('SyringeCounts', 0x00181045, 'Syringe Counts', kISIndex, VM.k1, false);
  static const PTag kContrastFlowRate
      //(0018,1046)
      = const PTag._(
          'ContrastFlowRate', 0x00181046, 'Contrast Flow Rate', kDSIndex, VM.k1_n, false);
  static const PTag kContrastFlowDuration
      //(0018,1047)
      = const PTag._('ContrastFlowDuration', 0x00181047, 'Contrast Flow Duration', kDSIndex,
          VM.k1_n, false);
  ...
  static const PTag kSpatialResolution
      //(0018,1050)
      = const PTag._(
          'SpatialResolution', 0x00181050, 'Spatial Resolution', kDSIndex, VM.k1, false);
  static const PTag kTriggerTime
      //(0018,1060)
      = const PTag._('TriggerTime', 0x00181060, 'Trigger Time', kDSIndex, VM.k1, false);
  static const PTag kTriggerSourceOrType
      //(0018,1061)
      = const PTag._('TriggerSourceOrType', 0x00181061, 'Trigger Source or Type', kLOIndex,
          VM.k1, false);
  static const PTag kNominalInterval
      //(0018,1062)
      = const PTag._(
          'NominalInterval', 0x00181062, 'Nominal Interval', kISIndex, VM.k1, false);
  static const PTag kFrameTime
      //(0018,1063)
      = const PTag._('FrameTime', 0x00181063, 'Frame Time', kDSIndex, VM.k1, false);
  static const PTag kCardiacFramingType
      //(0018,1064)
      = const PTag._(
          'CardiacFramingType', 0x00181064, 'Cardiac Framing Type', kLOIndex, VM.k1, false);
  static const PTag kFrameTimeVector
      //(0018,1065)
      = const PTag._(
          'FrameTimeVector', 0x00181065, 'Frame Time Vector', kDSIndex, VM.k1_n, false);
  static const PTag kFrameDelay
      //(0018,1066)
      = const PTag._('FrameDelay', 0x00181066, 'Frame Delay', kDSIndex, VM.k1, false);
  static const PTag kImageTriggerDelay
      //(0018,1067)
      = const PTag._(
          'ImageTriggerDelay', 0x00181067, 'Image Trigger Delay', kDSIndex, VM.k1, false);
  ...
  static const PTag kTriggerTimeOffset
      //(0018,1069)
      = const PTag._(
          'TriggerTimeOffset', 0x00181069, 'Trigger Time Offset', kDSIndex, VM.k1, false);
  ...
  static const PTag kRadionuclideHalfLife
      //(0018,1075)
      = const PTag._('RadionuclideHalfLife', 0x00181075, 'Radionuclide Half Life', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kBeatRejectionFlag
      //(0018,1080)
      = const PTag._(
          'BeatRejectionFlag', 0x00181080, 'Beat Rejection Flag', kCSIndex, VM.k1, false);
  static const PTag kLowRRValue
      //(0018,1081)
      = const PTag._('LowRRValue', 0x00181081, 'Low R-R Value', kISIndex, VM.k1, false);
  static const PTag kHighRRValue
      //(0018,1082)
      = const PTag._('HighRRValue', 0x00181082, 'High R-R Value', kISIndex, VM.k1, false);
  static const PTag kIntervalsAcquired
      //(0018,1083)
      = const PTag._(
          'IntervalsAcquired', 0x00181083, 'Intervals Acquired', kISIndex, VM.k1, false);
  static const PTag kIntervalsRejected
      //(0018,1084)
      = const PTag._(
          'IntervalsRejected', 0x00181084, 'Intervals Rejected', kISIndex, VM.k1, false);
  static const PTag kPVCRejection
      //(0018,1085)
      = const PTag._('PVCRejection', 0x00181085, 'PVC Rejection', kLOIndex, VM.k1, false);
  static const PTag kSkipBeats
      //(0018,1086)
      = const PTag._('SkipBeats', 0x00181086, 'Skip Beats', kISIndex, VM.k1, false);
  static const PTag kHeartRate
      //(0018,1088)
      = const PTag._('HeartRate', 0x00181088, 'Heart Rate', kISIndex, VM.k1, false);
  ...
  static const PTag kTriggerWindow
      //(0018,1094)
      = const PTag._('TriggerWindow', 0x00181094, 'Trigger Window', kISIndex, VM.k1, false);
  ...
  static const PTag kEstimatedRadiographicMagnificationFactor
      ...
      = const PTag._('EstimatedRadiographicMagnificationFactor', 0x00181114,
          'Estimated Radiographic Magnification Factor', kDSIndex, VM.k1, false);
  static const PTag kGantryDetectorTilt
      //(0018,1120)
      = const PTag._(
          'GantryDetectorTilt', 0x00181120, 'Gantry/Detector Tilt', kDSIndex, VM.k1, false);
  static const PTag kGantryDetectorSlew
      //(0018,1121)
      = const PTag._(
          'GantryDetectorSlew', 0x00181121, 'Gantry/Detector Slew', kDSIndex, VM.k1, false);
  static const PTag kTableHeight
      //(0018,1130)
      = const PTag._('TableHeight', 0x00181130, 'Table Height', kDSIndex, VM.k1, false);
  static const PTag kTableTraverse
      //(0018,1131)
      = const PTag._('TableTraverse', 0x00181131, 'Table Traverse', kDSIndex, VM.k1, false);
  static const PTag kTableMotion
      //(0018,1134)
      = const PTag._('TableMotion', 0x00181134, 'Table Motion', kCSIndex, VM.k1, false);
  ...
  static const PTag kTableAngle
      //(0018,1138)
      = const PTag._('TableAngle', 0x00181138, 'Table Angle', kDSIndex, VM.k1, false);
  static const PTag kTableType
      //(0018,113A)
      = const PTag._('TableType', 0x0018113A, 'Table Type', kCSIndex, VM.k1, false);
  static const PTag kRotationDirection
      //(0018,1140)
      = const PTag._(
          'RotationDirection', 0x00181140, 'Rotation Direction', kCSIndex, VM.k1, false);
  static const PTag kAngularPosition
      //(0018,1141)
      = const PTag._(
          'AngularPosition', 0x00181141, 'Angular Position', kDSIndex, VM.k1, true);
  static const PTag kRadialPosition
      //(0018,1142)
      = const PTag._(
          'RadialPosition', 0x00181142, 'Radial Position', kDSIndex, VM.k1_n, false);
  static const PTag kScanArc
      //(0018,1143)
      = const PTag._('ScanArc', 0x00181143, 'Scan Arc', kDSIndex, VM.k1, false);
  static const PTag kAngularStep
      //(0018,1144)
      = const PTag._('AngularStep', 0x00181144, 'Angular Step', kDSIndex, VM.k1, false);
  ...
  static const PTag kRotationOffset
      //(0018,1146)
      = const PTag._(
          'RotationOffset', 0x00181146, 'Rotation Offset', kDSIndex, VM.k1_n, true);
  static const PTag kFieldOfViewShape
      //(0018,1147)
      = const PTag._(
          'FieldOfViewShape', 0x00181147, 'Field of View Shape', kCSIndex, VM.k1, false);
  static const PTag kFieldOfViewDimensions
      //(0018,1149)
      = const PTag._('FieldOfViewDimensions', 0x00181149, 'Field of View Dimension(s)',
          kISIndex, VM.k1_2, false);
  static const PTag kExposureTime
      //(0018,1150)
      = const PTag._('ExposureTime', 0x00181150, 'Exposure Time', kISIndex, VM.k1, false);
  static const PTag kXRayTubeCurrent
      //(0018,1151)
      = const PTag._(
          'XRayTubeCurrent', 0x00181151, 'X-Ray Tube Current', kISIndex, VM.k1, false);
  ...
  static const PTag kExposureInuAs
      //(0018,1153)
      =
      const PTag._('ExposureInuAs', 0x00181153, 'Exposure in µAs', kISIndex, VM.k1, false);
  static const PTag kAveragePulseWidth
      //(0018,1154)
      = const PTag._(
          'AveragePulseWidth', 0x00181154, 'Average Pulse Width', kDSIndex, VM.k1, false);
  static const PTag kRadiationSetting
      //(0018,1155)
      = const PTag._(
          'RadiationSetting', 0x00181155, 'Radiation Setting', kCSIndex, VM.k1, false);
  static const PTag kRectificationType
      //(0018,1156)
      = const PTag._(
          'RectificationType', 0x00181156, 'Rectification Type', kCSIndex, VM.k1, false);
  static const PTag kRadiationMode
      //(0018,115A)
      = const PTag._('RadiationMode', 0x0018115A, 'Radiation Mode', kCSIndex, VM.k1, false);
  ...
  static const PTag kFilterType
      //(0018,1160)
      = const PTag._('FilterType', 0x00181160, 'Filter Type', kSHIndex, VM.k1, false);
  static const PTag kTypeOfFilters
      //(0018,1161)
      = const PTag._(
          'TypeOfFilters', 0x00181161, 'Type of Filters', kLOIndex, VM.k1_n, false);
  static const PTag kIntensifierSize
      //(0018,1162)
      = const PTag._(
          'IntensifierSize', 0x00181162, 'Intensifier Size', kDSIndex, VM.k1, false);
  static const PTag kImagerPixelSpacing
      //(0018,1164)
      = const PTag._(
          'ImagerPixelSpacing', 0x00181164, 'Imager Pixel Spacing', kDSIndex, VM.k2, false);
  ...
  static const PTag kGeneratorPower
      //(0018,1170)
      =
      const PTag._('GeneratorPower', 0x00181170, 'Generator Power', kISIndex, VM.k1, false);
  static const PTag kCollimatorGridName
      //(0018,1180)
      = const PTag._(
          'CollimatorGridName', 0x00181180, 'Collimator/grid Name', kSHIndex, VM.k1, false);
  static const PTag kCollimatorType
      //(0018,1181)
      =
      const PTag._('CollimatorType', 0x00181181, 'Collimator Type', kCSIndex, VM.k1, false);
  static const PTag kFocalDistance
      //(0018,1182)
      =
      const PTag._('FocalDistance', 0x00181182, 'Focal Distance', kISIndex, VM.k1_2, false);
  static const PTag kXFocusCenter
      //(0018,1183)
      =
      const PTag._('XFocusCenter', 0x00181183, 'X Focus Center', kDSIndex, VM.k1_2, false);
  static const PTag kYFocusCenter
      //(0018,1184)
      =
      const PTag._('YFocusCenter', 0x00181184, 'Y Focus Center', kDSIndex, VM.k1_2, false);
  static const PTag kFocalSpots
      //(0018,1190)
      = const PTag._('FocalSpots', 0x00181190, 'Focal Spot(s)', kDSIndex, VM.k1_n, false);
  static const PTag kAnodeTargetMaterial
      //(0018,1191)
      = const PTag._('AnodeTargetMaterial', 0x00181191, 'Anode Target Material', kCSIndex,
          VM.k1, false);
  static const PTag kBodyPartThickness
      //(0018,11A0)
      = const PTag._(
          'BodyPartThickness', 0x001811A0, 'Body Part Thickness', kDSIndex, VM.k1, false);
  static const PTag kCompressionForce
      //(0018,11A2)
      = const PTag._(
          'CompressionForce', 0x001811A2, 'Compression Force', kDSIndex, VM.k1, false);
  static const PTag kPaddleDescription
      //(0018,11A4)
      = const PTag._(
          'PaddleDescription', 0x001811A4, 'Paddle Description', kLOIndex, VM.k1, false);
  ...
  static const PTag kConvolutionKernel
      //(0018,1210)
      = const PTag._(
          'ConvolutionKernel', 0x00181210, 'Convolution Kernel', kSHIndex, VM.k1_n, false);
  ...
  static const PTag kActualFrameDuration
      //(0018,1242)
      = const PTag._('ActualFrameDuration', 0x00181242, 'Actual Frame Duration', kISIndex,
          VM.k1, false);
  static const PTag kCountRate
      //(0018,1243)
      = const PTag._('CountRate', 0x00181243, 'Count Rate', kISIndex, VM.k1, false);
  ...
  static const PTag kReceiveCoilName
      //(0018,1250)
      = const PTag._(
          'ReceiveCoilName', 0x00181250, 'Receive Coil Name', kSHIndex, VM.k1, false);
  static const PTag kTransmitCoilName
      //(0018,1251)
      = const PTag._(
          'TransmitCoilName', 0x00181251, 'Transmit Coil Name', kSHIndex, VM.k1, false);
  static const PTag kPlateType
      //(0018,1260)
      = const PTag._('PlateType', 0x00181260, 'Plate Type', kSHIndex, VM.k1, false);
  static const PTag kPhosphorType
      //(0018,1261)
      = const PTag._('PhosphorType', 0x00181261, 'Phosphor Type', kLOIndex, VM.k1, false);
  static const PTag kScanVelocity
      //(0018,1300)
      = const PTag._('ScanVelocity', 0x00181300, 'Scan Velocity', kDSIndex, VM.k1, false);
  static const PTag kWholeBodyTechnique
      //(0018,1301)
      = const PTag._('WholeBodyTechnique', 0x00181301, 'Whole Body Technique', kCSIndex,
          VM.k1_n, false);
  static const PTag kScanLength
      //(0018,1302)
      = const PTag._('ScanLength', 0x00181302, 'Scan Length', kISIndex, VM.k1, false);
  static const PTag kAcquisitionMatrix
      //(0018,1310)
      = const PTag._(
          'AcquisitionMatrix', 0x00181310, 'Acquisition Matrix', kUSIndex, VM.k4, false);
  ...
  static const PTag kFlipAngle
      //(0018,1314)
      = const PTag._('FlipAngle', 0x00181314, 'Flip Angle', kDSIndex, VM.k1, false);
  ...
  static const PTag kCassetteOrientation
      //(0018,1402)
      = const PTag._('CassetteOrientation', 0x00181402, 'Cassette Orientation', kCSIndex,
          VM.k1, false);
  static const PTag kCassetteSize
      //(0018,1403)
      = const PTag._('CassetteSize', 0x00181403, 'Cassette Size', kCSIndex, VM.k1, false);
  static const PTag kExposuresOnPlate
      //(0018,1404)
      = const PTag._(
          'ExposuresOnPlate', 0x00181404, 'Exposures on Plate', kUSIndex, VM.k1, false);
  ...
  static const PTag kExposureIndex
      //(0018,1411)
      = const PTag._('ExposureIndex', 0x00181411, 'Exposure Index', kDSIndex, VM.k1, false);
  static const PTag kTargetExposureIndex
      //(0018,1412)
      = const PTag._('TargetExposureIndex', 0x00181412, 'Target Exposure Index', kDSIndex,
          VM.k1, false);
  static const PTag kDeviationIndex
      //(0018,1413)
      =
      const PTag._('DeviationIndex', 0x00181413, 'Deviation Index', kDSIndex, VM.k1, false);
  static const PTag kColumnAngulation
      //(0018,1450)
      = const PTag._(
          'ColumnAngulation', 0x00181450, 'Column Angulation', kDSIndex, VM.k1, false);
  static const PTag kTomoLayerHeight
      //(0018,1460)
      = const PTag._(
          'TomoLayerHeight', 0x00181460, 'Tomo Layer Height', kDSIndex, VM.k1, false);
  static const PTag kTomoAngle
      //(0018,1470)
      = const PTag._('TomoAngle', 0x00181470, 'Tomo Angle', kDSIndex, VM.k1, false);
  ...
  static const PTag kTomoClass
      //(0018,1491)
      = const PTag._('TomoClass', 0x00181491, 'Tomo Class', kCSIndex, VM.k1, false);
  ...
  static const PTag kPositionerMotion
      //(0018,1500)
      = const PTag._(
          'PositionerMotion', 0x00181500, 'Positioner Motion', kCSIndex, VM.k1, false);
  static const PTag kPositionerType
      //(0018,1508)
      =
      const PTag._('PositionerType', 0x00181508, 'Positioner Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kDetectorPrimaryAngle
      //(0018,1530)
      = const PTag._('DetectorPrimaryAngle', 0x00181530, 'Detector Primary Angle', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kShutterShape
      //(0018,1600)
      = const PTag._('ShutterShape', 0x00181600, 'Shutter Shape', kCSIndex, VM.k1_3, false);
  ...
  static const PTag kShutterOverlayGroup
      //(0018,1623)
      = const PTag._('ShutterOverlayGroup', 0x00181623, 'Shutter Overlay Group', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kCollimatorShape
      //(0018,1700)
      = const PTag._(
          'CollimatorShape', 0x00181700, 'Collimator Shape', kCSIndex, VM.k1_3, false);
  ...
  static const PTag kTimeSource
      //(0018,1801)
      = const PTag._('TimeSource', 0x00181801, 'Time Source', kSHIndex, VM.k1, false);
  ...
  static const PTag kNTPSourceAddress
      //(0018,1803)
      = const PTag._(
          'NTPSourceAddress', 0x00181803, 'NTP Source Address', kLOIndex, VM.k1, false);
  static const PTag kPageNumberVector
      //(0018,2001)
      = const PTag._(
          'PageNumberVector', 0x00182001, 'Page Number Vector', kISIndex, VM.k1_n, false);
  static const PTag kFrameLabelVector
      //(0018,2002)
      = const PTag._(
          'FrameLabelVector', 0x00182002, 'Frame Label Vector', kSHIndex, VM.k1_n, false);
  ...
  static const PTag kSliceLocationVector
      //(0018,2005)
      = const PTag._('SliceLocationVector', 0x00182005, 'Slice Location Vector', kDSIndex,
          VM.k1_n, false);
  ...
  static const PTag kBiopsyTargetSequence
      //(0018,2041)
      = const PTag._('BiopsyTargetSequence', 0x00182041, 'Biopsy Target Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kTargetUID
      //(0018,2042)
      = const PTag._('TargetUID', 0x00182042, 'Target UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kTargetLabel
      //(0018,2045)
      = const PTag._('TargetLabel', 0x00182045, 'Target Label', kSHIndex, VM.k1, false);
  static const PTag kDisplayedZValue
      //(0018,2046)
      = const PTag._(
          'DisplayedZValue', 0x00182046, 'Displayed Z Value', kFLIndex, VM.k1, false);
  static const PTag kIVUSAcquisition
      //(0018,3100)
      = const PTag._(
          'IVUSAcquisition', 0x00183100, 'IVUS Acquisition', kCSIndex, VM.k1, false);
  static const PTag kIVUSPullbackRate
      //(0018,3101)
      = const PTag._(
          'IVUSPullbackRate', 0x00183101, 'IVUS Pullback Rate', kDSIndex, VM.k1, false);
  static const PTag kIVUSGatedRate
      //(0018,3102)
      =
      const PTag._('IVUSGatedRate', 0x00183102, 'IVUS Gated Rate', kDSIndex, VM.k1, false);
  ...
  static const PTag kLesionNumber
      //(0018,3105)
      = const PTag._('LesionNumber', 0x00183105, 'Lesion Number', kISIndex, VM.k1_n, false);
  static const PTag kAcquisitionComments
      //(0018,4000)
      = const PTag._(
          'AcquisitionComments', 0x00184000, 'Acquisition Comments', kLTIndex, VM.k1, true);
  static const PTag kOutputPower
      //(0018,5000)
      = const PTag._('OutputPower', 0x00185000, 'Output Power', kSHIndex, VM.k1_n, false);
  static const PTag kTransducerData
      //(0018,5010)
      = const PTag._(
          'TransducerData', 0x00185010, 'Transducer Data', kLOIndex, VM.k1_n, false);
  static const PTag kFocusDepth
      //(0018,5012)
      = const PTag._('FocusDepth', 0x00185012, 'Focus Depth', kDSIndex, VM.k1, false);
  static const PTag kProcessingFunction
      //(0018,5020)
      = const PTag._(
          'ProcessingFunction', 0x00185020, 'Processing Function', kLOIndex, VM.k1, false);
  ...
  static const PTag kMechanicalIndex
      //(0018,5022)
      = const PTag._(
          'MechanicalIndex', 0x00185022, 'Mechanical Index', kDSIndex, VM.k1, false);
  static const PTag kBoneThermalIndex
      //(0018,5024)
      = const PTag._(
          'BoneThermalIndex', 0x00185024, 'Bone Thermal Index', kDSIndex, VM.k1, false);
  static const PTag kCranialThermalIndex
      //(0018,5026)
      = const PTag._('CranialThermalIndex', 0x00185026, 'Cranial Thermal Index', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kDynamicRange
      //(0018,5030)
      = const PTag._('DynamicRange', 0x00185030, 'Dynamic Range', kDSIndex, VM.k1, true);
  static const PTag kTotalGain
      //(0018,5040)
      = const PTag._('TotalGain', 0x00185040, 'Total Gain', kDSIndex, VM.k1, true);
  static const PTag kDepthOfScanField
      //(0018,5050)
      = const PTag._(
          'DepthOfScanField', 0x00185050, 'Depth of Scan Field', kISIndex, VM.k1, false);
  static const PTag kPatientPosition
      //(0018,5100)
      = const PTag._(
          'PatientPosition', 0x00185100, 'Patient Position', kCSIndex, VM.k1, false);
  static const PTag kViewPosition
      //(0018,5101)
      = const PTag._('ViewPosition', 0x00185101, 'View Position', kCSIndex, VM.k1, false);
  ...
  static const PTag kSensitivity
      //(0018,6000)
      = const PTag._('Sensitivity', 0x00186000, 'Sensitivity', kDSIndex, VM.k1, false);
  ...
  static const PTag kRegionSpatialFormat
      //(0018,6012)
      = const PTag._('RegionSpatialFormat', 0x00186012, 'Region Spatial Format', kUSIndex,
          VM.k1, false);
  static const PTag kRegionDataType
      //(0018,6014)
      = const PTag._(
          'RegionDataType', 0x00186014, 'Region Data Type', kUSIndex, VM.k1, false);
  static const PTag kRegionFlags
      //(0018,6016)
      = const PTag._('RegionFlags', 0x00186016, 'Region Flags', kULIndex, VM.k1, false);
  static const PTag kRegionLocationMinX0
      //(0018,6018)
      = const PTag._('RegionLocationMinX0', 0x00186018, 'Region Location Min X0', kULIndex,
          VM.k1, false);
  static const PTag kRegionLocationMinY0
      //(0018,601A)
      = const PTag._('RegionLocationMinY0', 0x0018601A, 'Region Location Min Y0', kULIndex,
          VM.k1, false);
  static const PTag kRegionLocationMaxX1
      //(0018,601C)
      = const PTag._('RegionLocationMaxX1', 0x0018601C, 'Region Location Max X1', kULIndex,
          VM.k1, false);
  static const PTag kRegionLocationMaxY1
      //(0018,601E)
      = const PTag._('RegionLocationMaxY1', 0x0018601E, 'Region Location Max Y1', kULIndex,
          VM.k1, false);
  static const PTag kReferencePixelX0
      //(0018,6020)
      = const PTag._(
          'ReferencePixelX0', 0x00186020, 'Reference Pixel X0', kSLIndex, VM.k1, false);
  static const PTag kReferencePixelY0
      //(0018,6022)
      = const PTag._(
          'ReferencePixelY0', 0x00186022, 'Reference Pixel Y0', kSLIndex, VM.k1, false);
  ...
  static const PTag kPhysicalDeltaX
      //(0018,602C)
      = const PTag._(
          'PhysicalDeltaX', 0x0018602C, 'Physical Delta X', kFDIndex, VM.k1, false);
  static const PTag kPhysicalDeltaY
      //(0018,602E)
      = const PTag._(
          'PhysicalDeltaY', 0x0018602E, 'Physical Delta Y', kFDIndex, VM.k1, false);
  static const PTag kTransducerFrequency
      //(0018,6030)
      = const PTag._('TransducerFrequency', 0x00186030, 'Transducer Frequency', kULIndex,
          VM.k1, false);
  static const PTag kTransducerType
      //(0018,6031)
      =
      const PTag._('TransducerType', 0x00186031, 'Transducer Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kSteeringAngle
      //(0018,6036)
      = const PTag._('SteeringAngle', 0x00186036, 'Steering Angle', kFDIndex, VM.k1, false);
  ...
  static const PTag kTMLinePositionX0
      //(0018,603D)
      = const PTag._(
          'TMLinePositionX0', 0x0018603D, 'TM-Line Position X0', kSLIndex, VM.k1, false);
  ...
  static const PTag kTMLinePositionY0
      //(0018,603F)
      = const PTag._(
          'TMLinePositionY0', 0x0018603F, 'TM-Line Position Y0', kSLIndex, VM.k1, false);
  ...
  static const PTag kTMLinePositionX1
      //(0018,6041)
      = const PTag._(
          'TMLinePositionX1', 0x00186041, 'TM-Line Position X1', kSLIndex, VM.k1, false);
  ...
  static const PTag kTMLinePositionY1
      //(0018,6043)
      = const PTag._(
          'TMLinePositionY1', 0x00186043, 'TM-Line Position Y1', kSLIndex, VM.k1, false);
  ...
  static const PTag kPixelComponentMask
      //(0018,6046)
      = const PTag._(
          'PixelComponentMask', 0x00186046, 'Pixel Component Mask', kULIndex, VM.k1, false);
  ...
  static const PTag kTableOfXBreakPoints
      //(0018,6052)
      = const PTag._('TableOfXBreakPoints', 0x00186052, 'Table of X Break Points', kULIndex,
          VM.k1_n, false);
  static const PTag kTableOfYBreakPoints
      //(0018,6054)
      = const PTag._('TableOfYBreakPoints', 0x00186054, 'Table of Y Break Points', kFDIndex,
          VM.k1_n, false);
  ...
  static const PTag kTableOfPixelValues
      //(0018,6058)
      = const PTag._('TableOfPixelValues', 0x00186058, 'Table of Pixel Values', kULIndex,
          VM.k1_n, false);
  ...
  static const PTag kRWaveTimeVector
      //(0018,6060)
      = const PTag._(
          'RWaveTimeVector', 0x00186060, 'R Wave Time Vector', kFLIndex, VM.k1_n, false);
  ...
  static const PTag kDetectorTemperature
      //(0018,7001)
      = const PTag._('DetectorTemperature', 0x00187001, 'Detector Temperature', kDSIndex,
          VM.k1, false);
  static const PTag kDetectorType
      //(0018,7004)
      = const PTag._('DetectorType', 0x00187004, 'Detector Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kDetectorDescription
      //(0018,7006)
      = const PTag._('DetectorDescription', 0x00187006, 'Detector Description', kLTIndex,
          VM.k1, false);
  static const PTag kDetectorMode
      //(0018,7008)
      = const PTag._('DetectorMode', 0x00187008, 'Detector Mode', kLTIndex, VM.k1, false);
  static const PTag kDetectorID
      //(0018,700A)
      = const PTag._('DetectorID', 0x0018700A, 'Detector ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kExposuresOnDetectorSinceLastCalibration
      ...
      = const PTag._('ExposuresOnDetectorSinceLastCalibration', 0x00187010,
          'Exposures on Detector Since Last Calibration', kISIndex, VM.k1, false);
  ...
  static const PTag kDetectorActiveTime
      //(0018,7014)
      = const PTag._(
          'DetectorActiveTime', 0x00187014, 'Detector Active Time', kDSIndex, VM.k1, false);
  ...
  static const PTag kDetectorBinning
      //(0018,701A)
      = const PTag._(
          'DetectorBinning', 0x0018701A, 'Detector Binning', kDSIndex, VM.k2, false);
  ...
  static const PTag kDetectorActiveShape
      //(0018,7024)
      = const PTag._('DetectorActiveShape', 0x00187024, 'Detector Active Shape', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kDetectorActiveOrigin
      //(0018,7028)
      = const PTag._('DetectorActiveOrigin', 0x00187028, 'Detector Active Origin', kDSIndex,
          VM.k2, false);
  ...
  static const PTag kFieldOfViewOrigin
      //(0018,7030)
      = const PTag._(
          'FieldOfViewOrigin', 0x00187030, 'Field of View Origin', kDSIndex, VM.k2, false);
  static const PTag kFieldOfViewRotation
      //(0018,7032)
      = const PTag._('FieldOfViewRotation', 0x00187032, 'Field of View Rotation', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kPixelDataAreaRotationAngleRelativeToFOV
      ...
      = const PTag._('PixelDataAreaRotationAngleRelativeToFOV', 0x00187038,
          'Pixel Data Area Rotation Angle Relative To FOV', kFLIndex, VM.k1, false);
  ...
  static const PTag kGridSpacingMaterial
      //(0018,7041)
      = const PTag._('GridSpacingMaterial', 0x00187041, 'Grid Spacing Material', kLTIndex,
          VM.k1, false);
  static const PTag kGridThickness
      //(0018,7042)
      = const PTag._('GridThickness', 0x00187042, 'Grid Thickness', kDSIndex, VM.k1, false);
  static const PTag kGridPitch
      //(0018,7044)
      = const PTag._('GridPitch', 0x00187044, 'Grid Pitch', kDSIndex, VM.k1, false);
  static const PTag kGridAspectRatio
      //(0018,7046)
      = const PTag._(
          'GridAspectRatio', 0x00187046, 'Grid Aspect Ratio', kISIndex, VM.k2, false);
  static const PTag kGridPeriod
      //(0018,7048)
      = const PTag._('GridPeriod', 0x00187048, 'Grid Period', kDSIndex, VM.k1, false);
  static const PTag kGridFocalDistance
      //(0018,704C)
      = const PTag._(
          'GridFocalDistance', 0x0018704C, 'Grid Focal Distance', kDSIndex, VM.k1, false);
  static const PTag kFilterMaterial
      //(0018,7050)
      = const PTag._(
          'FilterMaterial', 0x00187050, 'Filter Material', kCSIndex, VM.k1_n, false);
  ...
  static const PTag kExposureControlMode
      //(0018,7060)
      = const PTag._('ExposureControlMode', 0x00187060, 'Exposure Control Mode', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kExposureStatus
      //(0018,7064)
      =
      const PTag._('ExposureStatus', 0x00187064, 'Exposure Status', kCSIndex, VM.k1, false);
  static const PTag kPhototimerSetting
      //(0018,7065)
      = const PTag._(
          'PhototimerSetting', 0x00187065, 'Phototimer Setting', kDSIndex, VM.k1, false);
  static const PTag kExposureTimeInuS
      //(0018,8150)
      = const PTag._(
          'ExposureTimeInuS', 0x00188150, 'Exposure Time in µS', kDSIndex, VM.k1, false);
  ...
  static const PTag kContentQualification
      //(0018,9004)
      = const PTag._('ContentQualification', 0x00189004, 'Content Qualification', kCSIndex,
          VM.k1, false);
  static const PTag kPulseSequenceName
      //(0018,9005)
      = const PTag._(
          'PulseSequenceName', 0x00189005, 'Pulse Sequence Name', kSHIndex, VM.k1, false);
  ...
  static const PTag kEchoPulseSequence
      //(0018,9008)
      = const PTag._(
          'EchoPulseSequence', 0x00189008, 'Echo Pulse Sequence', kCSIndex, VM.k1, false);
  static const PTag kInversionRecovery
      //(0018,9009)
      = const PTag._(
          'InversionRecovery', 0x00189009, 'Inversion Recovery', kCSIndex, VM.k1, false);
  static const PTag kFlowCompensation
      //(0018,9010)
      = const PTag._(
          'FlowCompensation', 0x00189010, 'Flow Compensation', kCSIndex, VM.k1, false);
  static const PTag kMultipleSpinEcho
      //(0018,9011)
      = const PTag._(
          'MultipleSpinEcho', 0x00189011, 'Multiple Spin Echo', kCSIndex, VM.k1, false);
  ...
  static const PTag kPhaseContrast
      //(0018,9014)
      = const PTag._('PhaseContrast', 0x00189014, 'Phase Contrast', kCSIndex, VM.k1, false);
  ...
  static const PTag kTagAngleFirstAxis
      //(0018,9019)
      = const PTag._(
          'TagAngleFirstAxis', 0x00189019, 'Tag Angle First Axis', kFDIndex, VM.k1, false);
  ...
  static const PTag kT2Preparation
      //(0018,9021)
      = const PTag._('T2Preparation', 0x00189021, 'T2 Preparation', kCSIndex, VM.k1, false);
  static const PTag kBloodSignalNulling
      //(0018,9022)
      = const PTag._(
          'BloodSignalNulling', 0x00189022, 'Blood Signal Nulling', kCSIndex, VM.k1, false);
  static const PTag kSaturationRecovery
      //(0018,9024)
      = const PTag._(
          'SaturationRecovery', 0x00189024, 'Saturation Recovery', kCSIndex, VM.k1, false);
  ...
  static const PTag kSpatialPresaturation
      //(0018,9027)
      = const PTag._('SpatialPresaturation', 0x00189027, 'Spatial Pre-saturation', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kOversamplingPhase
      //(0018,9029)
      = const PTag._(
          'OversamplingPhase', 0x00189029, 'Oversampling Phase', kCSIndex, VM.k1, false);
  ...
  static const PTag kTagThickness
      //(0018,9035)
      = const PTag._('TagThickness', 0x00189035, 'Tag Thickness', kFDIndex, VM.k1, false);
  ...
  static const PTag kReceiveCoilType
      //(0018,9043)
      = const PTag._(
          'ReceiveCoilType', 0x00189043, 'Receive Coil Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kTransmitCoilType
      //(0018,9051)
      = const PTag._(
          'TransmitCoilType', 0x00189051, 'Transmit Coil Type', kCSIndex, VM.k1, false);
  static const PTag kSpectralWidth
      //(0018,9052)
      =
      const PTag._('SpectralWidth', 0x00189052, 'Spectral Width', kFDIndex, VM.k1_2, false);
  ...
  static const PTag kDecoupling
      //(0018,9059)
      = const PTag._('Decoupling', 0x00189059, 'De-coupling', kCSIndex, VM.k1, false);
  static const PTag kDecoupledNucleus
      //(0018,9060)
      = const PTag._(
          'DecoupledNucleus', 0x00189060, 'De-coupled Nucleus', kCSIndex, VM.k1_2, false);
  static const PTag kDecouplingFrequency
      //(0018,9061)
      = const PTag._('DecouplingFrequency', 0x00189061, 'De-coupling Frequency', kFDIndex,
          VM.k1_2, false);
  static const PTag kDecouplingMethod
      //(0018,9062)
      = const PTag._(
          'DecouplingMethod', 0x00189062, 'De-coupling Method', kCSIndex, VM.k1, false);
  ...
  static const PTag kKSpaceFiltering
      //(0018,9064)
      = const PTag._(
          'KSpaceFiltering', 0x00189064, 'k-space Filtering', kCSIndex, VM.k1, false);
  static const PTag kTimeDomainFiltering
      //(0018,9065)
      = const PTag._('TimeDomainFiltering', 0x00189065, 'Time Domain Filtering', kCSIndex,
          VM.k1_2, false);
  static const PTag kNumberOfZeroFills
      //(0018,9066)
      = const PTag._('NumberOfZeroFills', 0x00189066, 'Number of Zero Fills', kUSIndex,
          VM.k1_2, false);
  static const PTag kBaselineCorrection
      //(0018,9067)
      = const PTag._(
          'BaselineCorrection', 0x00189067, 'Baseline Correction', kCSIndex, VM.k1, false);
  ...
  static const PTag kAcquisitionDuration
      //(0018,9073)
      = const PTag._('AcquisitionDuration', 0x00189073, 'Acquisition Duration', kFDIndex,
          VM.k1, false);
  ...
  static const PTag kParallelAcquisition
      //(0018,9077)
      = const PTag._('ParallelAcquisition', 0x00189077, 'Parallel Acquisition', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kInversionTimes
      //(0018,9079)
      = const PTag._(
          'InversionTimes', 0x00189079, 'Inversion Times', kFDIndex, VM.k1_n, false);
  ...
  static const PTag kPartialFourier
      //(0018,9081)
      =
      const PTag._('PartialFourier', 0x00189081, 'Partial Fourier', kCSIndex, VM.k1, false);
  static const PTag kEffectiveEchoTime
      //(0018,9082)
      = const PTag._(
          'EffectiveEchoTime', 0x00189082, 'Effective Echo Time', kFDIndex, VM.k1, false);
  ...
  static const PTag kCardiacSignalSource
      //(0018,9085)
      = const PTag._('CardiacSignalSource', 0x00189085, 'Cardiac Signal Source', kCSIndex,
          VM.k1, false);
  static const PTag kDiffusionBValue
      //(0018,9087)
      = const PTag._(
          'DiffusionBValue', 0x00189087, 'Diffusion b-value', kFDIndex, VM.k1, false);
  ...
  static const PTag kCoverageOfKSpace
      //(0018,9094)
      = const PTag._(
          'CoverageOfKSpace', 0x00189094, 'Coverage of k-Space', kCSIndex, VM.k1, false);
  ...
  static const PTag kParallelReductionFactorInPlaneRetired
      ...
      = const PTag._('ParallelReductionFactorInPlaneRetired', 0x00189096,
          'Parallel Reduction Factor In-plane (Retired)', kFDIndex, VM.k1, true);
  static const PTag kTransmitterFrequency
      //(0018,9098)
      = const PTag._('TransmitterFrequency', 0x00189098, 'Transmitter Frequency', kFDIndex,
          VM.k1_2, false);
  static const PTag kResonantNucleus
      //(0018,9100)
      = const PTag._(
          'ResonantNucleus', 0x00189100, 'Resonant Nucleus', kCSIndex, VM.k1_2, false);
  static const PTag kFrequencyCorrection
      //(0018,9101)
      = const PTag._('FrequencyCorrection', 0x00189101, 'Frequency Correction', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kSlabThickness
      //(0018,9104)
      = const PTag._('SlabThickness', 0x00189104, 'Slab Thickness', kFDIndex, VM.k1, false);
  static const PTag kSlabOrientation
      //(0018,9105)
      = const PTag._(
          'SlabOrientation', 0x00189105, 'Slab Orientation', kFDIndex, VM.k3, false);
  static const PTag kMidSlabPosition
      //(0018,9106)
      = const PTag._(
          'MidSlabPosition', 0x00189106, 'Mid Slab Position', kFDIndex, VM.k3, false);
  ...
  static const PTag kMREchoSequence
      //(0018,9114)
      = const PTag._(
          'MREchoSequence', 0x00189114, 'MR Echo Sequence', kSQIndex, VM.k1, false);
  static const PTag kMRModifierSequence
      //(0018,9115)
      = const PTag._(
          'MRModifierSequence', 0x00189115, 'MR Modifier Sequence', kSQIndex, VM.k1, false);
  static const PTag kMRDiffusionSequence
      //(0018,9117)
      = const PTag._('MRDiffusionSequence', 0x00189117, 'MR Diffusion Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kMRAveragesSequence
      //(0018,9119)
      = const PTag._(
          'MRAveragesSequence', 0x00189119, 'MR Averages Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSpectroscopyAcquisitionOutOfPlanePhaseSteps
      ...
      = const PTag._('SpectroscopyAcquisitionOutOfPlanePhaseSteps', 0x00189159,
          'Spectroscopy Acquisition Out-of-plane Phase Steps', kULIndex, VM.k1, false);
  static const PTag kBulkMotionStatus
      //(0018,9166)
      = const PTag._(
          'BulkMotionStatus', 0x00189166, 'Bulk Motion Status', kCSIndex, VM.k1, true);
  ...
  static const PTag kOperatingModeType
      //(0018,9177)
      = const PTag._(
          'OperatingModeType', 0x00189177, 'Operating Mode Type', kCSIndex, VM.k1, false);
  static const PTag kOperatingMode
      //(0018,9178)
      = const PTag._('OperatingMode', 0x00189178, 'Operating Mode', kCSIndex, VM.k1, false);
  ...
  static const PTag kGradientOutputType
      //(0018,9180)
      = const PTag._(
          'GradientOutputType', 0x00189180, 'Gradient Output Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kGradientOutput
      //(0018,9182)
      =
      const PTag._('GradientOutput', 0x00189182, 'Gradient Output', kFDIndex, VM.k1, false);
  ...
  static const PTag kTaggingDelay
      //(0018,9184)
      = const PTag._('TaggingDelay', 0x00189184, 'Tagging Delay', kFDIndex, VM.k1, false);
  static const PTag kRespiratoryMotionCompensationTechniqueDescription
      ...
      = const PTag._('RespiratoryMotionCompensationTechniqueDescription', 0x00189185,
          'Respiratory Motion Compensation Technique Description', kSTIndex, VM.k1, false);
  ...
  static const PTag kChemicalShiftMinimumIntegrationLimitInHz
      ...
      = const PTag._('ChemicalShiftMinimumIntegrationLimitInHz', 0x00189195,
          'Chemical Shift Minimum Integration Limit in Hz', kFDIndex, VM.k1, true);
  static const PTag kChemicalShiftMaximumIntegrationLimitInHz
      ...
      = const PTag._('ChemicalShiftMaximumIntegrationLimitInHz', 0x00189196,
          'Chemical Shift Maximum Integration Limit in Hz', kFDIndex, VM.k1, true);
  ...
  static const PTag kTagAngleSecondAxis
      //(0018,9219)
      = const PTag._('TagAngleSecondAxis', 0x00189219, 'Tag Angle Second Axis', kSSIndex,
          VM.k1, false);
  ...
  static const PTag kMRAcquisitionPhaseEncodingStepsInPlane
      ...
      = const PTag._('MRAcquisitionPhaseEncodingStepsInPlane', 0x00189231,
          'MR Acquisition Phase Encoding Steps in-plane', kUSIndex, VM.k1, false);
  static const PTag kMRAcquisitionPhaseEncodingStepsOutOfPlane
      ...
      = const PTag._('MRAcquisitionPhaseEncodingStepsOutOfPlane', 0x00189232,
          'MR Acquisition Phase Encoding Steps out-of-plane', kUSIndex, VM.k1, false);
  ...
  static const PTag kCardiacCyclePosition
      //(0018,9236)
      = const PTag._('CardiacCyclePosition', 0x00189236, 'Cardiac Cycle Position', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kRFEchoTrainLength
      //(0018,9240)
      = const PTag._(
          'RFEchoTrainLength', 0x00189240, 'RF Echo Train Length', kUSIndex, VM.k1, false);
  ...
  static const PTag kASLSlabNumber
      //(0018,9253)
      =
      const PTag._('ASLSlabNumber', 0x00189253, 'ASL Slab Number', kUSIndex, VM.k1, false);
  static const PTag kASLSlabThickness
      //(0018,9254)
      = const PTag._(
          'ASLSlabThickness', 0x00189254, 'ASL Slab Thickness', kFDIndex, VM.k1, false);
  static const PTag kASLSlabOrientation
      //(0018,9255)
      = const PTag._(
          'ASLSlabOrientation', 0x00189255, 'ASL Slab Orientation', kFDIndex, VM.k3, false);
  static const PTag kASLMidSlabPosition
      //(0018,9256)
      = const PTag._('ASLMidSlabPosition', 0x00189256, 'ASL Mid Slab Position', kFDIndex,
          VM.k3, false);
  static const PTag kASLContext
      //(0018,9257)
      = const PTag._('ASLContext', 0x00189257, 'ASL Context', kCSIndex, VM.k1, false);
  ...
  static const PTag kASLCrusherFlag
      //(0018,9259)
      = const PTag._(
          'ASLCrusherFlag', 0x00189259, 'ASL Crusher Flag', kCSIndex, VM.k1, false);
  static const PTag kASLCrusherFlowLimit
      //(0018,925A)
      = const PTag._('ASLCrusherFlowLimit', 0x0018925A, 'ASL Crusher Flow Limit', kFDIndex,
          VM.k1, false);
  ...
  static const PTag kASLBolusCutoffFlag
      //(0018,925C)
      = const PTag._('ASLBolusCutoffFlag', 0x0018925C, 'ASL Bolus Cut-off Flag', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kASLSlabSequence
      //(0018,9260)
      = const PTag._(
          'ASLSlabSequence', 0x00189260, 'ASL Slab Sequence', kSQIndex, VM.k1, false);
  static const PTag kChemicalShiftMinimumIntegrationLimitInppm
      ...
      = const PTag._('ChemicalShiftMinimumIntegrationLimitInppm', 0x00189295,
          'Chemical Shift Minimum Integration Limit in ppm', kFDIndex, VM.k1, false);
  static const PTag kChemicalShiftMaximumIntegrationLimitInppm
      ...
      = const PTag._('ChemicalShiftMaximumIntegrationLimitInppm', 0x00189296,
          'Chemical Shift Maximum Integration Limit in ppm', kFDIndex, VM.k1, false);
  ...
  static const PTag kAcquisitionType
      //(0018,9302)
      = const PTag._(
          'AcquisitionType', 0x00189302, 'Acquisition Type', kCSIndex, VM.k1, false);
  static const PTag kTubeAngle
      //(0018,9303)
      = const PTag._('TubeAngle', 0x00189303, 'Tube Angle', kFDIndex, VM.k1, false);
  ...
  static const PTag kRevolutionTime
      //(0018,9305)
      =
      const PTag._('RevolutionTime', 0x00189305, 'Revolution Time', kFDIndex, VM.k1, false);
  ...
  static const PTag kTableSpeed
      //(0018,9309)
      = const PTag._('TableSpeed', 0x00189309, 'Table Speed', kFDIndex, VM.k1, false);
  ...
  static const PTag kSpiralPitchFactor
      //(0018,9311)
      = const PTag._(
          'SpiralPitchFactor', 0x00189311, 'Spiral Pitch Factor', kFDIndex, VM.k1, false);
  static const PTag kCTGeometrySequence
      //(0018,9312)
      = const PTag._(
          'CTGeometrySequence', 0x00189312, 'CT Geometry Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kReconstructionAngle
      //(0018,9319)
      = const PTag._('ReconstructionAngle', 0x00189319, 'Reconstruction Angle', kFDIndex,
          VM.k1, false);
  static const PTag kImageFilter
      //(0018,9320)
      = const PTag._('ImageFilter', 0x00189320, 'Image Filter', kSHIndex, VM.k1, false);
  static const PTag kCTExposureSequence
      //(0018,9321)
      = const PTag._(
          'CTExposureSequence', 0x00189321, 'CT Exposure Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kEstimatedDoseSaving
      //(0018,9324)
      = const PTag._('EstimatedDoseSaving', 0x00189324, 'Estimated Dose Saving', kFDIndex,
          VM.k1, false);
  ...
  static const PTag kCTPositionSequence
      //(0018,9326)
      = const PTag._(
          'CTPositionSequence', 0x00189326, 'CT Position Sequence', kSQIndex, VM.k1, false);
  static const PTag kTablePosition
      //(0018,9327)
      = const PTag._('TablePosition', 0x00189327, 'Table Position', kFDIndex, VM.k1, false);
  static const PTag kExposureTimeInms
      //(0018,9328)
      = const PTag._(
          'ExposureTimeInms', 0x00189328, 'Exposure Time in ms', kFDIndex, VM.k1, false);
  ...
  static const PTag kExposureInmAs
      //(0018,9332)
      =
      const PTag._('ExposureInmAs', 0x00189332, 'Exposure in mAs', kFDIndex, VM.k1, false);
  static const PTag kConstantVolumeFlag
      //(0018,9333)
      = const PTag._(
          'ConstantVolumeFlag', 0x00189333, 'Constant Volume Flag', kCSIndex, VM.k1, false);
  static const PTag kFluoroscopyFlag
      //(0018,9334)
      = const PTag._(
          'FluoroscopyFlag', 0x00189334, 'Fluoroscopy Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kPlanesInAcquisition
      //(0018,9410)
      = const PTag._('PlanesInAcquisition', 0x00189410, 'Planes in Acquisition', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kXRayReceptorType
      //(0018,9420)
      = const PTag._(
          'XRayReceptorType', 0x00189420, 'X-Ray Receptor Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kDistanceReceptorPlaneToDetectorHousing
      ...
      = const PTag._('DistanceReceptorPlaneToDetectorHousing', 0x00189426,
          'Distance Receptor Plane to Detector Housing', kFLIndex, VM.k1, false);
  ...
  static const PTag kPhysicalDetectorSize
      //(0018,9429)
      = const PTag._('PhysicalDetectorSize', 0x00189429, 'Physical Detector Size', kFLIndex,
          VM.k2, false);
  ...
  static const PTag kFieldOfViewSequence
      //(0018,9432)
      = const PTag._('FieldOfViewSequence', 0x00189432, 'Field of View Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kExposureControlSensingRegionLeftVerticalEdge
      ...
      = const PTag._('ExposureControlSensingRegionLeftVerticalEdge', 0x00189436,
          'Exposure Control Sensing Region Left Vertical Edge', kSSIndex, VM.k1, false);
  static const PTag kExposureControlSensingRegionRightVerticalEdge
      ...
      = const PTag._('ExposureControlSensingRegionRightVerticalEdge', 0x00189437,
          'Exposure Control Sensing Region Right Vertical Edge', kSSIndex, VM.k1, false);
  static const PTag kExposureControlSensingRegionUpperHorizontalEdge
      ...
      = const PTag._('ExposureControlSensingRegionUpperHorizontalEdge', 0x00189438,
          'Exposure Control Sensing Region Upper Horizontal Edge', kSSIndex, VM.k1, false);
  static const PTag kExposureControlSensingRegionLowerHorizontalEdge
      ...
      = const PTag._('ExposureControlSensingRegionLowerHorizontalEdge', 0x00189439,
          'Exposure Control Sensing Region Lower Horizontal Edge', kSSIndex, VM.k1, false);
  static const PTag kCenterOfCircularExposureControlSensingRegion
      ...
      = const PTag._('CenterOfCircularExposureControlSensingRegion', 0x00189440,
          'Center of Circular Exposure Control Sensing Region', kSSIndex, VM.k2, false);
  static const PTag kRadiusOfCircularExposureControlSensingRegion
      ...
      = const PTag._('RadiusOfCircularExposureControlSensingRegion', 0x00189441,
          'Radius of Circular Exposure Control Sensing Region', kUSIndex, VM.k1, false);
  ...
  static const PTag kNoName0
      //(0018,9445)
      = const PTag._('NoName0', 0x00189445, 'See Note 3', kUNIndex, VM.kNoVM, true);
  ...
  static const PTag kBeamAngle
      //(0018,9449)
      = const PTag._('BeamAngle', 0x00189449, 'Beam Angle', kFLIndex, VM.k1, false);
  ...
  static const PTag kCalibrationSequence
      //(0018,9455)
      = const PTag._('CalibrationSequence', 0x00189455, 'Calibration Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kPlaneIdentification
      //(0018,9457)
      = const PTag._('PlaneIdentification', 0x00189457, 'Plane Identification', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kPositionerIsocenterDetectorRotationAngle
      ...
      = const PTag._('PositionerIsocenterDetectorRotationAngle', 0x00189465,
          'Positioner Isocenter Detector Rotation Angle', kFLIndex, VM.k1, false);
  ...
  static const PTag kTableHeadTiltAngle
      //(0018,9470)
      = const PTag._('TableHeadTiltAngle', 0x00189470, 'Table Head Tilt Angle', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kApplicationName
      //(0018,9524)
      = const PTag._(
          'ApplicationName', 0x00189524, 'Application Name', kLOIndex, VM.k1, false);
  static const PTag kApplicationVersion
      //(0018,9525)
      = const PTag._(
          'ApplicationVersion', 0x00189525, 'Application Version', kLOIndex, VM.k1, false);
  ...
  static const PTag kAlgorithmType
      //(0018,9527)
      = const PTag._('AlgorithmType', 0x00189527, 'Algorithm Type', kCSIndex, VM.k1, false);
  static const PTag kAlgorithmDescription
      //(0018,9528)
      = const PTag._('AlgorithmDescription', 0x00189528, 'Algorithm Description', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kDiffusionBValueXX
      //(0018,9602)
      = const PTag._(
          'DiffusionBValueXX', 0x00189602, 'Diffusion b-value XX', kFDIndex, VM.k1, false);
  static const PTag kDiffusionBValueXY
      //(0018,9603)
      = const PTag._(
          'DiffusionBValueXY', 0x00189603, 'Diffusion b-value XY', kFDIndex, VM.k1, false);
  static const PTag kDiffusionBValueXZ
      //(0018,9604)
      = const PTag._(
          'DiffusionBValueXZ', 0x00189604, 'Diffusion b-value XZ', kFDIndex, VM.k1, false);
  static const PTag kDiffusionBValueYY
      //(0018,9605)
      = const PTag._(
          'DiffusionBValueYY', 0x00189605, 'Diffusion b-value YY', kFDIndex, VM.k1, false);
  static const PTag kDiffusionBValueYZ
      //(0018,9606)
      = const PTag._(
          'DiffusionBValueYZ', 0x00189606, 'Diffusion b-value YZ', kFDIndex, VM.k1, false);
  static const PTag kDiffusionBValueZZ
      //(0018,9607)
      = const PTag._(
          'DiffusionBValueZZ', 0x00189607, 'Diffusion b-value ZZ', kFDIndex, VM.k1, false);
  ...
  static const PTag kStartRelativeDensityDifferenceThreshold
      ...
      = const PTag._('StartRelativeDensityDifferenceThreshold', 0x00189716,
          'Start Relative Density Difference Threshold', kFDIndex, VM.k1, false);
  ...
  static const PTag kTerminationCardiacTriggerCountThreshold
      ...
      = const PTag._('TerminationCardiacTriggerCountThreshold', 0x00189723,
          'Termination Cardiac Trigger Count Threshold', kFDIndex, VM.k1, false);
  static const PTag kTerminationRespiratoryTriggerCountThreshold
      ...
      = const PTag._('TerminationRespiratoryTriggerCountThreshold', 0x00189724,
          'Termination Respiratory Trigger Count Threshold', kFDIndex, VM.k1, false);
  static const PTag kDetectorGeometry
      //(0018,9725)
      = const PTag._(
          'DetectorGeometry', 0x00189725, 'Detector Geometry', kCSIndex, VM.k1, false);
  ...
  static const PTag kPETPositionSequence
      //(0018,9735)
      = const PTag._('PETPositionSequence', 0x00189735, 'PET Position Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kNumberOfIterations
      //(0018,9739)
      = const PTag._(
          'NumberOfIterations', 0x00189739, 'Number of Iterations', kUSIndex, VM.k1, false);
  static const PTag kNumberOfSubsets
      //(0018,9740)
      = const PTag._(
          'NumberOfSubsets', 0x00189740, 'Number of Subsets', kUSIndex, VM.k1, false);
  ...
  static const PTag kReconstructionType
      //(0018,9756)
      = const PTag._(
          'ReconstructionType', 0x00189756, 'Reconstruction Type', kCSIndex, VM.k1, false);
  static const PTag kDecayCorrected
      //(0018,9758)
      =
      const PTag._('DecayCorrected', 0x00189758, 'Decay Corrected', kCSIndex, VM.k1, false);
  static const PTag kAttenuationCorrected
      //(0018,9759)
      = const PTag._('AttenuationCorrected', 0x00189759, 'Attenuation Corrected', kCSIndex,
          VM.k1, false);
  static const PTag kScatterCorrected
      //(0018,9760)
      = const PTag._(
          'ScatterCorrected', 0x00189760, 'Scatter Corrected', kCSIndex, VM.k1, false);
  static const PTag kDeadTimeCorrected
      //(0018,9761)
      = const PTag._(
          'DeadTimeCorrected', 0x00189761, 'Dead Time Corrected', kCSIndex, VM.k1, false);
  ...
  static const PTag kRandomsCorrected
      //(0018,9765)
      = const PTag._(
          'RandomsCorrected', 0x00189765, 'Randoms Corrected', kCSIndex, VM.k1, false);
  ...
  static const PTag kAttenuationCorrectionTemporalRelationship
      ...
      = const PTag._('AttenuationCorrectionTemporalRelationship', 0x00189770,
          'Attenuation Correction Temporal Relationship', kCSIndex, VM.k1, false);
  ...
  static const PTag kDepthsOfFocus
      //(0018,9801)
      = const PTag._(
          'DepthsOfFocus', 0x00189801, 'Depth(s) of Focus', kFDIndex, VM.k1_n, false);
  ...
  static const PTag kExclusionDuration
      //(0018,9805)
      = const PTag._(
          'ExclusionDuration', 0x00189805, 'Exclusion Duration', kFDIndex, VM.k1, false);
  ...
  static const PTag kAliasedDataType
      //(0018,980B)
      = const PTag._(
          'AliasedDataType', 0x0018980B, 'Aliased Data Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kContributionDateTime
      //(0018,A002)
      = const PTag._('ContributionDateTime', 0x0018A002, 'Contribution DateTime', kDTIndex,
          VM.k1, false);
  ...
  static const PTag kStudyInstanceUID
      //(0020,000D)
      = const PTag._(
          'StudyInstanceUID', 0x0020000D, 'Study Instance UID', kUIIndex, VM.k1, false);
  static const PTag kSeriesInstanceUID
      //(0020,000E)
      = const PTag._(
          'SeriesInstanceUID', 0x0020000E, 'Series Instance UID', kUIIndex, VM.k1, false);
  static const PTag kStudyID
      //(0020,0010)
      = const PTag._('StudyID', 0x00200010, 'Study ID', kSHIndex, VM.k1, false);
  static const PTag kSeriesNumber
      //(0020,0011)
      = const PTag._('SeriesNumber', 0x00200011, 'Series Number', kISIndex, VM.k1, false);
  static const PTag kAcquisitionNumber
      //(0020,0012)
      = const PTag._(
          'AcquisitionNumber', 0x00200012, 'Acquisition Number', kISIndex, VM.k1, false);
  static const PTag kInstanceNumber
      //(0020,0013)
      =
      const PTag._('InstanceNumber', 0x00200013, 'Instance Number', kISIndex, VM.k1, false);
  static const PTag kIsotopeNumber
      //(0020,0014)
      = const PTag._('IsotopeNumber', 0x00200014, 'Isotope Number', kISIndex, VM.k1, true);
  static const PTag kPhaseNumber
      //(0020,0015)
      = const PTag._('PhaseNumber', 0x00200015, 'Phase Number', kISIndex, VM.k1, true);
  static const PTag kIntervalNumber
      //(0020,0016)
      =
      const PTag._('IntervalNumber', 0x00200016, 'Interval Number', kISIndex, VM.k1, true);
  static const PTag kTimeSlotNumber
      //(0020,0017)
      =
      const PTag._('TimeSlotNumber', 0x00200017, 'Time Slot Number', kISIndex, VM.k1, true);
  static const PTag kAngleNumber
      //(0020,0018)
      = const PTag._('AngleNumber', 0x00200018, 'Angle Number', kISIndex, VM.k1, true);
  static const PTag kItemNumber
      //(0020,0019)
      = const PTag._('ItemNumber', 0x00200019, 'Item Number', kISIndex, VM.k1, false);
  static const PTag kPatientOrientation
      //(0020,0020)
      = const PTag._(
          'PatientOrientation', 0x00200020, 'Patient Orientation', kCSIndex, VM.k2, false);
  static const PTag kOverlayNumber
      //(0020,0022)
      = const PTag._('OverlayNumber', 0x00200022, 'Overlay Number', kISIndex, VM.k1, true);
  static const PTag kCurveNumber
      //(0020,0024)
      = const PTag._('CurveNumber', 0x00200024, 'Curve Number', kISIndex, VM.k1, true);
  static const PTag kLUTNumber
      //(0020,0026)
      = const PTag._('LUTNumber', 0x00200026, 'LUT Number', kISIndex, VM.k1, true);
  static const PTag kImagePosition
      //(0020,0030)
      = const PTag._('ImagePosition', 0x00200030, 'Image Position', kDSIndex, VM.k3, true);
  ...
  static const PTag kImageOrientation
      //(0020,0035)
      = const PTag._(
          'ImageOrientation', 0x00200035, 'Image Orientation', kDSIndex, VM.k6, true);
  ...
  static const PTag kFrameOfReferenceUID
      //(0020,0052)
      = const PTag._('FrameOfReferenceUID', 0x00200052, 'Frame of Reference UID', kUIIndex,
          VM.k1, false);
  static const PTag kLaterality
      //(0020,0060)
      = const PTag._('Laterality', 0x00200060, 'Laterality', kCSIndex, VM.k1, false);
  static const PTag kImageLaterality
      //(0020,0062)
      = const PTag._(
          'ImageLaterality', 0x00200062, 'Image Laterality', kCSIndex, VM.k1, false);
  static const PTag kImageGeometryType
      //(0020,0070)
      = const PTag._(
          'ImageGeometryType', 0x00200070, 'Image Geometry Type', kLOIndex, VM.k1, true);
  static const PTag kMaskingImage
      //(0020,0080)
      = const PTag._('MaskingImage', 0x00200080, 'Masking Image', kCSIndex, VM.k1_n, true);
  static const PTag kReportNumber
      //(0020,00AA)
      = const PTag._('ReportNumber', 0x002000AA, 'Report Number', kISIndex, VM.k1, true);
  ...
  static const PTag kTemporalResolution
      //(0020,0110)
      = const PTag._(
          'TemporalResolution', 0x00200110, 'Temporal Resolution', kDSIndex, VM.k1, false);
  ...
  static const PTag kSeriesInStudy
      //(0020,1000)
      = const PTag._('SeriesInStudy', 0x00201000, 'Series in Study', kISIndex, VM.k1, true);
  static const PTag kAcquisitionsInSeries
      //(0020,1001)
      = const PTag._('AcquisitionsInSeries', 0x00201001, 'Acquisitions in Series', kISIndex,
          VM.k1, true);
  static const PTag kImagesInAcquisition
      //(0020,1002)
      = const PTag._('ImagesInAcquisition', 0x00201002, 'Images in Acquisition', kISIndex,
          VM.k1, false);
  static const PTag kImagesInSeries
      //(0020,1003)
      =
      const PTag._('ImagesInSeries', 0x00201003, 'Images in Series', kISIndex, VM.k1, true);
  static const PTag kAcquisitionsInStudy
      //(0020,1004)
      = const PTag._('AcquisitionsInStudy', 0x00201004, 'Acquisitions in Study', kISIndex,
          VM.k1, true);
  static const PTag kImagesInStudy
      //(0020,1005)
      = const PTag._('ImagesInStudy', 0x00201005, 'Images in Study', kISIndex, VM.k1, true);
  static const PTag kReference
      //(0020,1020)
      = const PTag._('Reference', 0x00201020, 'Reference', kLOIndex, VM.k1_n, true);
  ...
  static const PTag kSliceLocation
      //(0020,1041)
      = const PTag._('SliceLocation', 0x00201041, 'Slice Location', kDSIndex, VM.k1, false);
  static const PTag kOtherStudyNumbers
      //(0020,1070)
      = const PTag._(
          'OtherStudyNumbers', 0x00201070, 'Other Study Numbers', kISIndex, VM.k1_n, true);
  ...
  static const PTag kSourceImageIDs
      //(0020,3100)
      = const PTag._(
          'SourceImageIDs', 0x00203100, 'Source Image IDs', kCSIndex, VM.k1_n, true);
  static const PTag kModifyingDeviceID
      //(0020,3401)
      = const PTag._(
          'ModifyingDeviceID', 0x00203401, 'Modifying Device ID', kCSIndex, VM.k1, true);
  static const PTag kModifiedImageID
      //(0020,3402)
      = const PTag._(
          'ModifiedImageID', 0x00203402, 'Modified Image ID', kCSIndex, VM.k1, true);
  static const PTag kModifiedImageDate
      //(0020,3403)
      = const PTag._(
          'ModifiedImageDate', 0x00203403, 'Modified Image Date', kDAIndex, VM.k1, true);
  ...
  static const PTag kModifiedImageTime
      //(0020,3405)
      = const PTag._(
          'ModifiedImageTime', 0x00203405, 'Modified Image Time', kTMIndex, VM.k1, true);
  ...
  static const PTag kImageComments
      //(0020,4000)
      = const PTag._('ImageComments', 0x00204000, 'Image Comments', kLTIndex, VM.k1, false);
  ...
  static const PTag kOriginalImageIdentificationNomenclature
      ...
      = const PTag._('OriginalImageIdentificationNomenclature', 0x00205002,
          'Original Image Identification Nomenclature', kLOIndex, VM.k1_n, true);
  ...
  static const PTag kFrameAnatomySequence
      //(0020,9071)
      = const PTag._('FrameAnatomySequence', 0x00209071, 'Frame Anatomy Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kFrameLaterality
      //(0020,9072)
      = const PTag._(
          'FrameLaterality', 0x00209072, 'Frame Laterality', kCSIndex, VM.k1, false);
  static const PTag kFrameContentSequence
      //(0020,9111)
      = const PTag._('FrameContentSequence', 0x00209111, 'Frame Content Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kNominalCardiacTriggerTimePriorToRPeak
      ...
      = const PTag._('NominalCardiacTriggerTimePriorToRPeak', 0x00209154,
          'Nominal Cardiac Trigger Time Prior To R-Peak', kFLIndex, VM.k1, false);
  static const PTag kActualCardiacTriggerTimePriorToRPeak
      //(0020,9155)
      = const PTag._('ActualCardiacTriggerTimePriorToRPeak', 0x00209155,
          'Actual Cardiac Trigger Time Prior To R-Peak', kFLIndex, VM.k1, false);
  ...
  static const PTag kDimensionIndexValues
      //(0020,9157)
      = const PTag._('DimensionIndexValues', 0x00209157, 'Dimension Index Values', kULIndex,
          VM.k1_n, false);
  static const PTag kFrameComments
      //(0020,9158)
      = const PTag._('FrameComments', 0x00209158, 'Frame Comments', kLTIndex, VM.k1, false);
  static const PTag kConcatenationUID
      //(0020,9161)
      = const PTag._(
          'ConcatenationUID', 0x00209161, 'Concatenation UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kUnassignedSharedConvertedAttributesSequence
      ...
      = const PTag._('UnassignedSharedConvertedAttributesSequence', 0x00209170,
          'Unassigned Shared Converted Attributes Sequence', kSQIndex, VM.k1, false);
  static const PTag kUnassignedPerFrameConvertedAttributesSequence
      ...
      = const PTag._('UnassignedPerFrameConvertedAttributesSequence', 0x00209171,
          'Unassigned Per-Frame Converted Attributes Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kImagePositionVolume
      //(0020,9301)
      = const PTag._('ImagePositionVolume', 0x00209301, 'Image Position (Volume)', kFDIndex,
          VM.k3, false);
  ...
  static const PTag kApexPosition
      //(0020,9308)
      = const PTag._('ApexPosition', 0x00209308, 'Apex Position', kFDIndex, VM.k3, false);
  ...
  static const PTag kFrameLabel
      //(0020,9453)
      = const PTag._('FrameLabel', 0x00209453, 'Frame Label', kLOIndex, VM.k1, false);
  static const PTag kAcquisitionIndex
      //(0020,9518)
      = const PTag._(
          'AcquisitionIndex', 0x00209518, 'Acquisition Index', kUSIndex, VM.k1_n, false);
  static const PTag kContributingSOPInstancesReferenceSequence
      ...
      = const PTag._('ContributingSOPInstancesReferenceSequence', 0x00209529,
          'Contributing SOP Instances Reference Sequence', kSQIndex, VM.k1, false);
  static const PTag kReconstructionIndex
      //(0020,9536)
      = const PTag._('ReconstructionIndex', 0x00209536, 'Reconstruction Index', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kSphericalLensPower
      //(0022,0007)
      = const PTag._(
          'SphericalLensPower', 0x00220007, 'Spherical Lens Power', kFLIndex, VM.k1, false);
  static const PTag kCylinderLensPower
      //(0022,0008)
      = const PTag._(
          'CylinderLensPower', 0x00220008, 'Cylinder Lens Power', kFLIndex, VM.k1, false);
  static const PTag kCylinderAxis
      //(0022,0009)
      = const PTag._('CylinderAxis', 0x00220009, 'Cylinder Axis', kFLIndex, VM.k1, false);
  ...
  static const PTag kIntraOcularPressure
      //(0022,000B)
      = const PTag._('IntraOcularPressure', 0x0022000B, 'Intra Ocular Pressure', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kPupilDilated
      //(0022,000D)
      = const PTag._('PupilDilated', 0x0022000D, 'Pupil Dilated', kCSIndex, VM.k1, false);
  static const PTag kDegreeOfDilation
      //(0022,000E)
      = const PTag._(
          'DegreeOfDilation', 0x0022000E, 'Degree of Dilation', kFLIndex, VM.k1, false);
  static const PTag kStereoBaselineAngle
      //(0022,0010)
      = const PTag._('StereoBaselineAngle', 0x00220010, 'Stereo Baseline Angle', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kStereoRotation
      //(0022,0014)
      =
      const PTag._('StereoRotation', 0x00220014, 'Stereo Rotation', kFLIndex, VM.k1, false);
  ...
  static const PTag kLensesCodeSequence
      //(0022,0019)
      = const PTag._(
          'LensesCodeSequence', 0x00220019, 'Lenses Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kCameraAngleOfView
      //(0022,001E)
      = const PTag._(
          'CameraAngleOfView', 0x0022001E, 'Camera Angle of View', kFLIndex, VM.k1, false);
  static const PTag kStereoPairsSequence
      //(0022,0020)
      = const PTag._('StereoPairsSequence', 0x00220020, 'Stereo Pairs Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kLeftImageSequence
      //(0022,0021)
      = const PTag._(
          'LeftImageSequence', 0x00220021, 'Left Image Sequence', kSQIndex, VM.k1, false);
  static const PTag kRightImageSequence
      //(0022,0022)
      = const PTag._(
          'RightImageSequence', 0x00220022, 'Right Image Sequence', kSQIndex, VM.k1, false);
  static const PTag kAxialLengthOfTheEye
      //(0022,0030)
      = const PTag._('AxialLengthOfTheEye', 0x00220030, 'Axial Length of the Eye', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kReferenceCoordinates
      //(0022,0032)
      = const PTag._('ReferenceCoordinates', 0x00220032, 'Reference Coordinates', kFLIndex,
          VM.k2_2n, false);
  ...
  static const PTag kMydriaticAgentConcentrationUnitsSequence
      ...
      = const PTag._('MydriaticAgentConcentrationUnitsSequence', 0x00220042,
          'Mydriatic Agent Concentration Units Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIlluminationPower
      //(0022,0056)
      = const PTag._(
          'IlluminationPower', 0x00220056, 'Illumination Power', kFLIndex, VM.k1, false);
  ...
  static const PTag kOphthalmicAxialMeasurementsRightEyeSequence
      ...
      = const PTag._('OphthalmicAxialMeasurementsRightEyeSequence', 0x00221007,
          'Ophthalmic Axial Measurements Right Eye Sequence', kSQIndex, VM.k1, false);
  static const PTag kOphthalmicAxialMeasurementsLeftEyeSequence
      ...
      = const PTag._('OphthalmicAxialMeasurementsLeftEyeSequence', 0x00221008,
          'Ophthalmic Axial Measurements Left Eye Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIOLFormulaDetail
      //(0022,1029)
      = const PTag._(
          'IOLFormulaDetail', 0x00221029, 'IOL Formula Detail', kLOIndex, VM.k1, false);
  static const PTag kKeratometerIndex
      //(0022,1033)
      = const PTag._(
          'KeratometerIndex', 0x00221033, 'Keratometer Index', kFLIndex, VM.k1, false);
  static const PTag kSourceOfOphthalmicAxialLengthCodeSequence
      ...
      = const PTag._('SourceOfOphthalmicAxialLengthCodeSequence', 0x00221035,
          'Source of Ophthalmic Axial Length Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kTargetRefraction
      //(0022,1037)
      = const PTag._(
          'TargetRefraction', 0x00221037, 'Target Refraction', kFLIndex, VM.k1, false);
  ...
  static const PTag kOphthalmicAxialLengthMeasurementsSequence
      ...
      = const PTag._('OphthalmicAxialLengthMeasurementsSequence', 0x00221050,
          'Ophthalmic Axial Length Measurements Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIOLPowerSequence
      //(0022,1090)
      = const PTag._(
          'IOLPowerSequence', 0x00221090, 'IOL Power Sequence', kSQIndex, VM.k1, false);
  static const PTag kLensConstantSequence
      //(0022,1092)
      = const PTag._('LensConstantSequence', 0x00221092, 'Lens Constant Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kIOLManufacturer
      //(0022,1093)
      = const PTag._(
          'IOLManufacturer', 0x00221093, 'IOL Manufacturer', kLOIndex, VM.k1, false);
  ...
  static const PTag kImplantName
      //(0022,1095)
      = const PTag._('ImplantName', 0x00221095, 'Implant Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kImplantPartNumber
      //(0022,1097)
      = const PTag._(
          'ImplantPartNumber', 0x00221097, 'Implant Part Number', kLOIndex, VM.k1, false);
  static const PTag kReferencedOphthalmicAxialMeasurementsSequence
      ...
      = const PTag._('ReferencedOphthalmicAxialMeasurementsSequence', 0x00221100,
          'Referenced Ophthalmic Axial Measurements Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kAnteriorChamberDepthDefinitionCodeSequence
      ...
      = const PTag._('AnteriorChamberDepthDefinitionCodeSequence', 0x00221125,
          'Anterior Chamber Depth Definition Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kLensThickness
      //(0022,1130)
      = const PTag._('LensThickness', 0x00221130, 'Lens Thickness', kFLIndex, VM.k1, false);
  static const PTag kAnteriorChamberDepth
      //(0022,1131)
      = const PTag._('AnteriorChamberDepth', 0x00221131, 'Anterior Chamber Depth', kFLIndex,
          VM.k1, false);
  static const PTag kSourceOfLensThicknessDataCodeSequence
      //(0022,1132)
      = const PTag._('SourceOfLensThicknessDataCodeSequence', 0x00221132,
          'Source of Lens Thickness Data Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kSourceOfAnteriorChamberDepthDataCodeSequence
      ...
      = const PTag._('SourceOfAnteriorChamberDepthDataCodeSequence', 0x00221133,
          'Source of Anterior Chamber Depth Data Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSourceOfRefractiveMeasurementsCodeSequence
      ...
      = const PTag._('SourceOfRefractiveMeasurementsCodeSequence', 0x00221135,
          'Source of Refractive Measurements Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kOphthalmicAxialLengthMeasurementModified
      ...
      = const PTag._('OphthalmicAxialLengthMeasurementModified', 0x00221140,
          'Ophthalmic Axial Length Measurement Modified', kCSIndex, VM.k1, false);
  static const PTag kOphthalmicAxialLengthDataSourceCodeSequence
      ...
      = const PTag._('OphthalmicAxialLengthDataSourceCodeSequence', 0x00221150,
          'Ophthalmic Axial Length Data Source Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSignalToNoiseRatio
      //(0022,1155)
      = const PTag._('SignalToNoiseRatio', 0x00221155, 'Signal to Noise Ratio', kFLIndex,
          VM.k1, false);
  static const PTag kOphthalmicAxialLengthDataSourceDescription
      ...
      = const PTag._('OphthalmicAxialLengthDataSourceDescription', 0x00221159,
          'Ophthalmic Axial Length Data Source Description', kLOIndex, VM.k1, false);
  ...
  static const PTag kOpticalOphthalmicAxialLengthMeasurementsSequence
      ...
      = const PTag._('OpticalOphthalmicAxialLengthMeasurementsSequence', 0x00221225,
          'Optical Ophthalmic Axial Length Measurements Sequence', kSQIndex, VM.k1, false);
  static const PTag kUltrasoundSelectedOphthalmicAxialLengthSequence
      ...
      = const PTag._('UltrasoundSelectedOphthalmicAxialLengthSequence', 0x00221230,
          'Ultrasound Selected Ophthalmic Axial Length Sequence', kSQIndex, VM.k1, false);
  static const PTag kOphthalmicAxialLengthSelectionMethodCodeSequence
      ...
      = const PTag._('OphthalmicAxialLengthSelectionMethodCodeSequence', 0x00221250,
          'Ophthalmic Axial Length Selection Method Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kOpticalSelectedOphthalmicAxialLengthSequence
      ...
      = const PTag._('OpticalSelectedOphthalmicAxialLengthSequence', 0x00221255,
          'Optical Selected Ophthalmic Axial Length Sequence', kSQIndex, VM.k1, false);
  static const PTag kSelectedSegmentalOphthalmicAxialLengthSequence
      ...
      = const PTag._('SelectedSegmentalOphthalmicAxialLengthSequence', 0x00221257,
          'Selected Segmental Ophthalmic Axial Length Sequence', kSQIndex, VM.k1, false);
  static const PTag kSelectedTotalOphthalmicAxialLengthSequence
      ...
      = const PTag._('SelectedTotalOphthalmicAxialLengthSequence', 0x00221260,
          'Selected Total Ophthalmic Axial Length Sequence', kSQIndex, VM.k1, false);
  static const PTag kOphthalmicAxialLengthQualityMetricSequence
      ...
      = const PTag._('OphthalmicAxialLengthQualityMetricSequence', 0x00221262,
          'Ophthalmic Axial Length Quality Metric Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kOphthalmicAxialLengthQualityMetricTypeDescription
      ...
      = const PTag._('OphthalmicAxialLengthQualityMetricTypeDescription', 0x00221273,
          'Ophthalmic Axial Length Quality Metric Type Description', kLOIndex, VM.k1, true);
  static const PTag kIntraocularLensCalculationsRightEyeSequence
      ...
      = const PTag._('IntraocularLensCalculationsRightEyeSequence', 0x00221300,
          'Intraocular Lens Calculations Right Eye Sequence', kSQIndex, VM.k1, false);
  static const PTag kIntraocularLensCalculationsLeftEyeSequence
      ...
      = const PTag._('IntraocularLensCalculationsLeftEyeSequence', 0x00221310,
          'Intraocular Lens Calculations Left Eye Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kOphthalmicThicknessMapTypeCodeSequence
      ...
      = const PTag._('OphthalmicThicknessMapTypeCodeSequence', 0x00221436,
          'Ophthalmic Thickness Map Type Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kOphthalmicThicknessMappingNormalsSequence
      ...
      = const PTag._('OphthalmicThicknessMappingNormalsSequence', 0x00221443,
          'Ophthalmic Thickness Mapping Normals Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kPixelValueMappingToCodedConceptSequence
      ...
      = const PTag._('PixelValueMappingToCodedConceptSequence', 0x00221450,
          'Pixel Value Mapping to Coded Concept Sequence', kSQIndex, VM.k1, false);
  static const PTag kMappedPixelValue
      //(0022,1452)
      = const PTag._(
          'MappedPixelValue', 0x00221452, 'Mapped Pixel Value', kUSSSIndex, VM.k1, false);
  ...
  static const PTag kOphthalmicThicknessMapQualityThresholdSequence
      ...
      = const PTag._('OphthalmicThicknessMapQualityThresholdSequence', 0x00221458,
          'Ophthalmic Thickness Map Quality Threshold Sequence', kSQIndex, VM.k1, false);
  static const PTag kOphthalmicThicknessMapThresholdQualityRating
      ...
      = const PTag._('OphthalmicThicknessMapThresholdQualityRating', 0x00221460,
          'Ophthalmic Thickness Map Threshold Quality Rating', kFLIndex, VM.k1, false);
  ...
  static const PTag kRegisteredLocalizerBottomRightHandCorner
      ...
      = const PTag._('RegisteredLocalizerBottomRightHandCorner', 0x00221468,
          'Registered Localizer Bottom Right Hand Corner', kFLIndex, VM.k2, false);
  static const PTag kOphthalmicThicknessMapQualityRatingSequence
      ...
      = const PTag._('OphthalmicThicknessMapQualityRatingSequence', 0x00221470,
          'Ophthalmic Thickness Map Quality Rating Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kVisualFieldShape
      //(0024,0012)
      = const PTag._(
          'VisualFieldShape', 0x00240012, 'Visual Field Shape', kCSIndex, VM.k1, false);
  ...
  static const PTag kBackgroundLuminance
      //(0024,0020)
      = const PTag._('BackgroundLuminance', 0x00240020, 'Background Luminance', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kBackgroundIlluminationColorCodeSequence
      ...
      = const PTag._('BackgroundIlluminationColorCodeSequence', 0x00240024,
          'Background Illumination Color Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kStimulusArea
      //(0024,0025)
      = const PTag._('StimulusArea', 0x00240025, 'Stimulus Area', kFLIndex, VM.k1, false);
  ...
  static const PTag kFixationSequence
      //(0024,0032)
      = const PTag._(
          'FixationSequence', 0x00240032, 'Fixation Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kCommentsOnPatientPerformanceOfVisualField
      ...
      = const PTag._('CommentsOnPatientPerformanceOfVisualField', 0x00240044,
          'Comments on Patient\'s Performance of Visual Field', kLTIndex, VM.k1, false);
  ...
  static const PTag kCatchTrialsDataFlag
      //(0024,0055)
      = const PTag._('CatchTrialsDataFlag', 0x00240055, 'Catch Trials Data Flag', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kAgeCorrectedSensitivityDeviationAlgorithmSequence
      ...
      = const PTag._('AgeCorrectedSensitivityDeviationAlgorithmSequence', 0x00240065,
          'Age Corrected Sensitivity Deviation Algorithm Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kShortTermFluctuation
      //(0024,0075)
      = const PTag._('ShortTermFluctuation', 0x00240075, 'Short Term Fluctuation', kFLIndex,
          VM.k1, false);
  static const PTag kShortTermFluctuationProbabilityCalculated
      ...
      = const PTag._('ShortTermFluctuationProbabilityCalculated', 0x00240076,
          'Short Term Fluctuation Probability Calculated', kCSIndex, VM.k1, false);
  ...
  static const PTag kCorrectedLocalizedDeviationFromNormalCalculated
      ...
      = const PTag._('CorrectedLocalizedDeviationFromNormalCalculated', 0x00240078,
          'Corrected Localized Deviation From Normal Calculated', kCSIndex, VM.k1, false);
  ...
  static const PTag kCorrectedLocalizedDeviationFromNormalProbability
      ...
      = const PTag._('CorrectedLocalizedDeviationFromNormalProbability', 0x00240081,
          'Corrected Localized Deviation From Normal Probability', kFLIndex, VM.k1, false);
  ...
  static const PTag kFovealSensitivity
      //(0024,0087)
      = const PTag._(
          'FovealSensitivity', 0x00240087, 'Foveal Sensitivity', kFLIndex, VM.k1, false);
  ...
  static const PTag kStimulusResults
      //(0024,0093)
      = const PTag._(
          'StimulusResults', 0x00240093, 'Stimulus Results', kCSIndex, VM.k1, false);
  static const PTag kSensitivityValue
      //(0024,0094)
      = const PTag._(
          'SensitivityValue', 0x00240094, 'Sensitivity Value', kFLIndex, VM.k1, false);
  static const PTag kRetestStimulusSeen
      //(0024,0095)
      = const PTag._(
          'RetestStimulusSeen', 0x00240095, 'Retest Stimulus Seen', kCSIndex, VM.k1, false);
  ...
  static const PTag kQuantifiedDefect
      //(0024,0098)
      = const PTag._(
          'QuantifiedDefect', 0x00240098, 'Quantified Defect', kFLIndex, VM.k1, false);
  static const PTag kAgeCorrectedSensitivityDeviationProbabilityValue
      ...
      = const PTag._('AgeCorrectedSensitivityDeviationProbabilityValue', 0x00240100,
          'Age Corrected Sensitivity Deviation Probability Value', kFLIndex, VM.k1, false);
  ...
  static const PTag kBlindSpotLocalized
      //(0024,0106)
      = const PTag._(
          'BlindSpotLocalized', 0x00240106, 'Blind Spot Localized', kCSIndex, VM.k1, false);
  ...
  static const PTag kRefractiveParametersUsedOnPatientSequence
      ...
      = const PTag._('RefractiveParametersUsedOnPatientSequence', 0x00240112,
          'Refractive Parameters Used on Patient Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kAlgorithmSource
      //(0024,0202)
      = const PTag._(
          'AlgorithmSource', 0x00240202, 'Algorithm Source', kLOIndex, VM.k1, false);
  static const PTag kDataSetName
      //(0024,0306)
      = const PTag._('DataSetName', 0x00240306, 'Data Set Name', kLOIndex, VM.k1, false);
  static const PTag kDataSetVersion
      //(0024,0307)
      = const PTag._(
          'DataSetVersion', 0x00240307, 'Data Set Version', kLOIndex, VM.k1, false);
  static const PTag kDataSetSource
      //(0024,0308)
      =
      const PTag._('DataSetSource', 0x00240308, 'Data Set Source', kLOIndex, VM.k1, false);
  static const PTag kDataSetDescription
      //(0024,0309)
      = const PTag._(
          'DataSetDescription', 0x00240309, 'Data Set Description', kLOIndex, VM.k1, false);
  static const PTag kVisualFieldTestReliabilityGlobalIndexSequence
      ...
      = const PTag._('VisualFieldTestReliabilityGlobalIndexSequence', 0x00240317,
          'Visual Field Test Reliability Global Index Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIndexNormalsFlag
      //(0024,0338)
      = const PTag._(
          'IndexNormalsFlag', 0x00240338, 'Index Normals Flag', kCSIndex, VM.k1, false);
  static const PTag kIndexProbability
      //(0024,0341)
      = const PTag._(
          'IndexProbability', 0x00240341, 'Index Probability', kFLIndex, VM.k1, false);
  ...
  static const PTag kSamplesPerPixel
      //(0028,0002)
      = const PTag._(
          'SamplesPerPixel', 0x00280002, 'Samples per Pixel', kUSIndex, VM.k1, false);
  static const PTag kSamplesPerPixelUsed
      //(0028,0003)
      = const PTag._('SamplesPerPixelUsed', 0x00280003, 'Samples per Pixel Used', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kImageDimensions
      //(0028,0005)
      = const PTag._(
          'ImageDimensions', 0x00280005, 'Image Dimensions', kUSIndex, VM.k1, true);
  static const PTag kPlanarConfiguration
      //(0028,0006)
      = const PTag._('PlanarConfiguration', 0x00280006, 'Planar Configuration', kUSIndex,
          VM.k1, false);
  static const PTag kNumberOfFrames
      //(0028,0008)
      = const PTag._(
          'NumberOfFrames', 0x00280008, 'Number of Frames', kISIndex, VM.k1, false);
  ...
  static const PTag kNoName1
      //(0028,0020)
      = const PTag._('NoName1', 0x00280020, 'See Note 3', kUNIndex, VM.kNoVM, true);
  static const PTag kPixelSpacing
      //(0028,0030)
      = const PTag._('PixelSpacing', 0x00280030, 'Pixel Spacing', kDSIndex, VM.k2, false);
  static const PTag kZoomFactor
      //(0028,0031)
      = const PTag._('ZoomFactor', 0x00280031, 'Zoom Factor', kDSIndex, VM.k2, false);
  static const PTag kZoomCenter
      //(0028,0032)
      = const PTag._('ZoomCenter', 0x00280032, 'Zoom Center', kDSIndex, VM.k2, false);
  static const PTag kPixelAspectRatio
      //(0028,0034)
      = const PTag._(
          'PixelAspectRatio', 0x00280034, 'Pixel Aspect Ratio', kISIndex, VM.k2, false);
  static const PTag kImageFormat
      //(0028,0040)
      = const PTag._('ImageFormat', 0x00280040, 'Image Format', kCSIndex, VM.k1, true);
  static const PTag kManipulatedImage
      //(0028,0050)
      = const PTag._(
          'ManipulatedImage', 0x00280050, 'Manipulated Image', kLOIndex, VM.k1_n, true);
  static const PTag kCorrectedImage
      //(0028,0051)
      = const PTag._(
          'CorrectedImage', 0x00280051, 'Corrected Image', kCSIndex, VM.k1_n, false);
  ...
  static const PTag kCompressionCode
      //(0028,0060)
      = const PTag._(
          'CompressionCode', 0x00280060, 'Compression Code', kCSIndex, VM.k1, true);
  ...
  static const PTag kCompressionLabel
      //(0028,0062)
      = const PTag._(
          'CompressionLabel', 0x00280062, 'Compression Label', kLOIndex, VM.k1, true);
  ...
  static const PTag kCompressionSequence
      //(0028,0065)
      = const PTag._('CompressionSequence', 0x00280065, 'Compression Sequence', kCSIndex,
          VM.k1_n, true);
  ...
  static const PTag kRepeatInterval
      //(0028,0068)
      =
      const PTag._('RepeatInterval', 0x00280068, 'Repeat Interval', kUSIndex, VM.k1, true);
  static const PTag kBitsGrouped
      //(0028,0069)
      = const PTag._('BitsGrouped', 0x00280069, 'Bits Grouped', kUSIndex, VM.k1, true);
  static const PTag kPerimeterTable
      //(0028,0070)
      = const PTag._(
          'PerimeterTable', 0x00280070, 'Perimeter Table', kUSIndex, VM.k1_n, true);
  static const PTag kPerimeterValue
      //(0028,0071)
      = const PTag._(
          'PerimeterValue', 0x00280071, 'Perimeter Value', kUSSSIndex, VM.k1, true);
  static const PTag kPredictorRows
      //(0028,0080)
      = const PTag._('PredictorRows', 0x00280080, 'Predictor Rows', kUSIndex, VM.k1, true);
  static const PTag kPredictorColumns
      //(0028,0081)
      = const PTag._(
          'PredictorColumns', 0x00280081, 'Predictor Columns', kUSIndex, VM.k1, true);
  static const PTag kPredictorConstants
      //(0028,0082)
      = const PTag._(
          'PredictorConstants', 0x00280082, 'Predictor Constants', kUSIndex, VM.k1_n, true);
  static const PTag kBlockedPixels
      //(0028,0090)
      = const PTag._('BlockedPixels', 0x00280090, 'Blocked Pixels', kCSIndex, VM.k1, true);
  static const PTag kBlockRows
      //(0028,0091)
      = const PTag._('BlockRows', 0x00280091, 'Block Rows', kUSIndex, VM.k1, true);
  static const PTag kBlockColumns
      //(0028,0092)
      = const PTag._('BlockColumns', 0x00280092, 'Block Columns', kUSIndex, VM.k1, true);
  static const PTag kRowOverlap
      //(0028,0093)
      = const PTag._('RowOverlap', 0x00280093, 'Row Overlap', kUSIndex, VM.k1, true);
  static const PTag kColumnOverlap
      //(0028,0094)
      = const PTag._('ColumnOverlap', 0x00280094, 'Column Overlap', kUSIndex, VM.k1, true);
  static const PTag kBitsAllocated
      //(0028,0100)
      = const PTag._('BitsAllocated', 0x00280100, 'Bits Allocated', kUSIndex, VM.k1, false);
  static const PTag kBitsStored
      //(0028,0101)
      = const PTag._('BitsStored', 0x00280101, 'Bits Stored', kUSIndex, VM.k1, false);
  ...
  static const PTag kPixelRepresentation
      //(0028,0103)
      = const PTag._('PixelRepresentation', 0x00280103, 'Pixel Representation', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kPixelPaddingValue
      //(0028,0120)
      = const PTag._(
          'PixelPaddingValue', 0x00280120, 'Pixel Padding Value', kUSSSIndex, VM.k1, false);
  ...
  static const PTag kImageLocation
      //(0028,0200)
      = const PTag._('ImageLocation', 0x00280200, 'Image Location', kUSIndex, VM.k1, true);
  static const PTag kQualityControlImage
      //(0028,0300)
      = const PTag._('QualityControlImage', 0x00280300, 'Quality Control Image', kCSIndex,
          VM.k1, false);
  static const PTag kBurnedInAnnotation
      //(0028,0301)
      = const PTag._(
          'BurnedInAnnotation', 0x00280301, 'Burned In Annotation', kCSIndex, VM.k1, false);
  ...
  static const PTag kTransformLabel
      //(0028,0400)
      =
      const PTag._('TransformLabel', 0x00280400, 'Transform Label', kLOIndex, VM.k1, true);
  ...
  static const PTag kDataBlockDescription
      //(0028,0701)
      = const PTag._('DataBlockDescription', 0x00280701, 'Data Block Description', kCSIndex,
          VM.k1_n, true);
  static const PTag kDataBlock
      //(0028,0702)
      = const PTag._('DataBlock', 0x00280702, 'Data Block', kATIndex, VM.k1_n, true);
  ...
  static const PTag kZonalMapLocation
      //(0028,0721)
      = const PTag._(
          'ZonalMapLocation', 0x00280721, 'Zonal Map Location', kATIndex, VM.k1_n, true);
  static const PTag kZonalMapFormat
      //(0028,0722)
      =
      const PTag._('ZonalMapFormat', 0x00280722, 'Zonal Map Format', kUSIndex, VM.k1, true);
  static const PTag kAdaptiveMapFormat
      //(0028,0730)
      = const PTag._(
          'AdaptiveMapFormat', 0x00280730, 'Adaptive Map Format', kUSIndex, VM.k1, true);
  static const PTag kCodeNumberFormat
      //(0028,0740)
      = const PTag._(
          'CodeNumberFormat', 0x00280740, 'Code Number Format', kUSIndex, VM.k1, true);
  static const PTag kCodeLabel
      //(0028,0800)
      = const PTag._('CodeLabel', 0x00280800, 'Code Label', kCSIndex, VM.k1_n, true);
  static const PTag kNumberOfTables
      //(0028,0802)
      =
      const PTag._('NumberOfTables', 0x00280802, 'Number of Tables', kUSIndex, VM.k1, true);
  static const PTag kCodeTableLocation
      //(0028,0803)
      = const PTag._(
          'CodeTableLocation', 0x00280803, 'Code Table Location', kATIndex, VM.k1_n, true);
  static const PTag kBitsForCodeWord
      //(0028,0804)
      = const PTag._(
          'BitsForCodeWord', 0x00280804, 'Bits For Code Word', kUSIndex, VM.k1, true);
  static const PTag kImageDataLocation
      //(0028,0808)
      = const PTag._(
          'ImageDataLocation', 0x00280808, 'Image Data Location', kATIndex, VM.k1_n, true);
  ...
  static const PTag kWindowCenter
      //(0028,1050)
      = const PTag._('WindowCenter', 0x00281050, 'Window Center', kDSIndex, VM.k1_n, false);
  static const PTag kWindowWidth
      //(0028,1051)
      = const PTag._('WindowWidth', 0x00281051, 'Window Width', kDSIndex, VM.k1_n, false);
  static const PTag kRescaleIntercept
      //(0028,1052)
      = const PTag._(
          'RescaleIntercept', 0x00281052, 'Rescale Intercept', kDSIndex, VM.k1, false);
  static const PTag kRescaleSlope
      //(0028,1053)
      = const PTag._('RescaleSlope', 0x00281053, 'Rescale Slope', kDSIndex, VM.k1, false);
  static const PTag kRescaleType
      //(0028,1054)
      = const PTag._('RescaleType', 0x00281054, 'Rescale Type', kLOIndex, VM.k1, false);
  ...
  static const PTag kVOILUTFunction
      //(0028,1056)
      = const PTag._(
          'VOILUTFunction', 0x00281056, 'VOI LUT Function', kCSIndex, VM.k1, false);
  static const PTag kGrayScale
      //(0028,1080)
      = const PTag._('GrayScale', 0x00281080, 'Gray Scale', kCSIndex, VM.k1, true);
  ...
  static const PTag kLargeRedPaletteColorLookupTableDescriptor
      ...
      = const PTag._('LargeRedPaletteColorLookupTableDescriptor', 0x00281111,
          'Large Red Palette Color Lookup Table Descriptor', kUSSSIndex, VM.k4, true);
  static const PTag kLargeGreenPaletteColorLookupTableDescriptor
      ...
      = const PTag._('LargeGreenPaletteColorLookupTableDescriptor', 0x00281112,
          'Large Green Palette Color Lookup Table Descriptor', kUSSSIndex, VM.k4, true);
  static const PTag kLargeBluePaletteColorLookupTableDescriptor
      ...
      = const PTag._('LargeBluePaletteColorLookupTableDescriptor', 0x00281113,
          'Large Blue Palette Color Lookup Table Descriptor', kUSSSIndex, VM.k4, true);
  ...
  static const PTag kSegmentedRedPaletteColorLookupTableData
      ...
      = const PTag._('SegmentedRedPaletteColorLookupTableData', 0x00281221,
          'Segmented Red Palette Color Lookup Table Data', kOWIndex, VM.k1, false);
  static const PTag kSegmentedGreenPaletteColorLookupTableData
      ...
      = const PTag._('SegmentedGreenPaletteColorLookupTableData', 0x00281222,
          'Segmented Green Palette Color Lookup Table Data', kOWIndex, VM.k1, false);
  static const PTag kSegmentedBluePaletteColorLookupTableData
      ...
      = const PTag._('SegmentedBluePaletteColorLookupTableData', 0x00281223,
          'Segmented Blue Palette Color Lookup Table Data', kOWIndex, VM.k1, false);
  static const PTag kBreastImplantPresent
      //(0028,1300)
      = const PTag._('BreastImplantPresent', 0x00281300, 'Breast Implant Present', kCSIndex,
          VM.k1, false);
  static const PTag kPartialView
      //(0028,1350)
      = const PTag._('PartialView', 0x00281350, 'Partial View', kCSIndex, VM.k1, false);
  ...
  static const PTag kDataPathAssignment
      //(0028,1402)
      = const PTag._(
          'DataPathAssignment', 0x00281402, 'Data Path Assignment', kCSIndex, VM.k1, false);
  ...
  static const PTag kEnhancedPaletteColorLookupTableSequence
      ...
      = const PTag._('EnhancedPaletteColorLookupTableSequence', 0x0028140B,
          'Enhanced Palette Color Lookup Table Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kDataPathID
      //(0028,140E)
      = const PTag._('DataPathID', 0x0028140E, 'Data Path ID', kCSIndex, VM.k1, false);
  ...
  static const PTag kICCProfile
      //(0028,2000)
      = const PTag._('ICCProfile', 0x00282000, 'ICC Profile', kOBIndex, VM.k1, false);
  static const PTag kColorSpace
      //(0028,2000)
      = const PTag._('ColorSpace', 0x00282002, 'Color Space', kCSIndex, VM.k1, false);
  ...
  static const PTag kModalityLUTSequence
      //(0028,3000)
      = const PTag._('ModalityLUTSequence', 0x00283000, 'Modality LUT Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kLUTDescriptor
      //(0028,3002)
      =
      const PTag._('LUTDescriptor', 0x00283002, 'LUT Descriptor', kUSSSIndex, VM.k3, false);
  static const PTag kLUTExplanation
      //(0028,3003)
      =
      const PTag._('LUTExplanation', 0x00283003, 'LUT Explanation', kLOIndex, VM.k1, false);
  static const PTag kModalityLUTType
      //(0028,3004)
      = const PTag._(
          'ModalityLUTType', 0x00283004, 'Modality LUT Type', kLOIndex, VM.k1, false);
  static const PTag kLUTData
      //(0028,3006)
      = const PTag._('LUTData', 0x00283006, 'LUT Data', kUSOWIndex, VM.k1_n, false);
  static const PTag kVOILUTSequence
      //(0028,3010)
      = const PTag._(
          'VOILUTSequence', 0x00283010, 'VOI LUT Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kFrameOfInterestType
      //(0028,6023)
      = const PTag._('FrameOfInterestType', 0x00286023, 'Frame of Interest Type', kCSIndex,
          VM.k1_n, false);
  static const PTag kMaskPointers
      //(0028,6030)
      =
      const PTag._('MaskPointers', 0x00286030, 'Mask Pointer(s)', kUSIndex, VM.k1_n, true);
  static const PTag kRWavePointer
      //(0028,6040)
      =
      const PTag._('RWavePointer', 0x00286040, 'R Wave Pointer', kUSIndex, VM.k1_n, false);
  ...
  static const PTag kMaskOperation
      //(0028,6101)
      = const PTag._('MaskOperation', 0x00286101, 'Mask Operation', kCSIndex, VM.k1, false);
  static const PTag kApplicableFrameRange
      //(0028,6102)
      = const PTag._('ApplicableFrameRange', 0x00286102, 'Applicable Frame Range', kUSIndex,
          VM.k2_2n, false);
  static const PTag kMaskFrameNumbers
      //(0028,6110)
      = const PTag._(
          'MaskFrameNumbers', 0x00286110, 'Mask Frame Numbers', kUSIndex, VM.k1_n, false);
  ...
  static const PTag kMaskSubPixelShift
      //(0028,6114)
      = const PTag._(
          'MaskSubPixelShift', 0x00286114, 'Mask Sub-pixel Shift', kFLIndex, VM.k2, false);
  static const PTag kTIDOffset
      //(0028,6120)
      = const PTag._('TIDOffset', 0x00286120, 'TID Offset', kSSIndex, VM.k1, false);
  ...
  static const PTag kDataPointRows
      //(0028,9001)
      =
      const PTag._('DataPointRows', 0x00289001, 'Data Point Rows', kULIndex, VM.k1, false);
  static const PTag kDataPointColumns
      //(0028,9002)
      = const PTag._(
          'DataPointColumns', 0x00289002, 'Data Point Columns', kULIndex, VM.k1, false);
  static const PTag kSignalDomainColumns
      //(0028,9003)
      = const PTag._('SignalDomainColumns', 0x00289003, 'Signal Domain Columns', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kDataRepresentation
      //(0028,9108)
      = const PTag._(
          'DataRepresentation', 0x00289108, 'Data Representation', kCSIndex, VM.k1, false);
  ...
  static const PTag kFrameVOILUTSequence
      //(0028,9132)
      = const PTag._('FrameVOILUTSequence', 0x00289132, 'Frame VOI LUT Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kSignalDomainRows
      //(0028,9235)
      = const PTag._(
          'SignalDomainRows', 0x00289235, 'Signal Domain Rows', kCSIndex, VM.k1, false);
  ...
  static const PTag kSubtractionItemID
      //(0028,9416)
      = const PTag._(
          'SubtractionItemID', 0x00289416, 'Subtraction Item ID', kUSIndex, VM.k1, false);
  ...
  static const PTag kMaskSelectionMode
      //(0028,9454)
      = const PTag._(
          'MaskSelectionMode', 0x00289454, 'Mask Selection Mode', kCSIndex, VM.k1, false);
  static const PTag kLUTFunction
      //(0028,9474)
      = const PTag._('LUTFunction', 0x00289474, 'LUT Function', kCSIndex, VM.k1, false);
  ...
  static const PTag kPixelShiftSequence
      //(0028,9501)
      = const PTag._(
          'PixelShiftSequence', 0x00289501, 'Pixel Shift Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kVerticesOfTheRegion
      //(0028,9503)
      = const PTag._('VerticesOfTheRegion', 0x00289503, 'Vertices of the Region', kSSIndex,
          VM.k2_2n, false);
  ...
  static const PTag kLUTFrameRange
      //(0028,9507)
      = const PTag._(
          'LUTFrameRange', 0x00289507, 'LUT Frame Range', kUSIndex, VM.k2_2n, false);
  ...
  static const PTag kStudyStatusID
      //(0032,000A)
      = const PTag._('StudyStatusID', 0x0032000A, 'Study Status ID', kCSIndex, VM.k1, true);
  static const PTag kStudyPriorityID
      //(0032,000C)
      = const PTag._(
          'StudyPriorityID', 0x0032000C, 'Study Priority ID', kCSIndex, VM.k1, true);
  static const PTag kStudyIDIssuer
      //(0032,0012)
      = const PTag._('StudyIDIssuer', 0x00320012, 'Study ID Issuer', kLOIndex, VM.k1, true);
  static const PTag kStudyVerifiedDate
      //(0032,0032)
      = const PTag._(
          'StudyVerifiedDate', 0x00320032, 'Study Verified Date', kDAIndex, VM.k1, true);
  static const PTag kStudyVerifiedTime
      //(0032,0033)
      = const PTag._(
          'StudyVerifiedTime', 0x00320033, 'Study Verified Time', kTMIndex, VM.k1, true);
  static const PTag kStudyReadDate
      //(0032,0034)
      = const PTag._('StudyReadDate', 0x00320034, 'Study Read Date', kDAIndex, VM.k1, true);
  static const PTag kStudyReadTime
      //(0032,0035)
      = const PTag._('StudyReadTime', 0x00320035, 'Study Read Time', kTMIndex, VM.k1, true);
  ...
  static const PTag kReasonForStudy
      //(0032,1030)
      =
      const PTag._('ReasonForStudy', 0x00321030, 'Reason for Study', kLOIndex, VM.k1, true);
  static const PTag kRequestingPhysicianIdentificationSequence
      ...
      = const PTag._('RequestingPhysicianIdentificationSequence', 0x00321031,
          'Requesting Physician Identification Sequence', kSQIndex, VM.k1, false);
  static const PTag kRequestingPhysician
      //(0032,1032)
      = const PTag._('RequestingPhysician', 0x00321032, 'Requesting Physician', kPNIndex,
          VM.k1, false);
  static const PTag kRequestingService
      //(0032,1033)
      = const PTag._(
          'RequestingService', 0x00321033, 'Requesting Service', kLOIndex, VM.k1, false);
  ...
  static const PTag kStudyArrivalDate
      //(0032,1040)
      = const PTag._(
          'StudyArrivalDate', 0x00321040, 'Study Arrival Date', kDAIndex, VM.k1, true);
  static const PTag kStudyArrivalTime
      //(0032,1041)
      = const PTag._(
          'StudyArrivalTime', 0x00321041, 'Study Arrival Time', kTMIndex, VM.k1, true);
  static const PTag kStudyCompletionDate
      //(0032,1050)
      = const PTag._('StudyCompletionDate', 0x00321050, 'Study Completion Date', kDAIndex,
          VM.k1, true);
  static const PTag kStudyCompletionTime
      //(0032,1051)
      = const PTag._('StudyCompletionTime', 0x00321051, 'Study Completion Time', kTMIndex,
          VM.k1, true);
  ...
  static const PTag kStudyComments
      //(0032,4000)
      = const PTag._('StudyComments', 0x00324000, 'Study Comments', kLTIndex, VM.k1, true);
  ...
  static const PTag kVisitStatusID
      //(0038,0008)
      =
      const PTag._('VisitStatusID', 0x00380008, 'Visit Status ID', kCSIndex, VM.k1, false);
  static const PTag kAdmissionID
      //(0038,0010)
      = const PTag._('AdmissionID', 0x00380010, 'Admission ID', kLOIndex, VM.k1, false);
  static const PTag kIssuerOfAdmissionID
      //(0038,0011)
      = const PTag._('IssuerOfAdmissionID', 0x00380011, 'Issuer of Admission ID', kLOIndex,
          VM.k1, true);
  ...
  static const PTag kRouteOfAdmissions
      //(0038,0016)
      = const PTag._(
          'RouteOfAdmissions', 0x00380016, 'Route of Admissions', kLOIndex, VM.k1, false);
  ...
  static const PTag kAdmittingDate
      //(0038,0020)
      = const PTag._('AdmittingDate', 0x00380020, 'Admitting Date', kDAIndex, VM.k1, false);
  static const PTag kAdmittingTime
      //(0038,0021)
      = const PTag._('AdmittingTime', 0x00380021, 'Admitting Time', kTMIndex, VM.k1, false);
  static const PTag kDischargeDate
      //(0038,0030)
      = const PTag._('DischargeDate', 0x00380030, 'Discharge Date', kDAIndex, VM.k1, true);
  static const PTag kDischargeTime
      //(0038,0032)
      = const PTag._('DischargeTime', 0x00380032, 'Discharge Time', kTMIndex, VM.k1, true);
  ...
  static const PTag kSpecialNeeds
      //(0038,0050)
      = const PTag._('SpecialNeeds', 0x00380050, 'Special Needs', kLOIndex, VM.k1, false);
  static const PTag kServiceEpisodeID
      //(0038,0060)
      = const PTag._(
          'ServiceEpisodeID', 0x00380060, 'Service Episode ID', kLOIndex, VM.k1, false);
  ...
  static const PTag kPatientState
      //(0038,0500)
      = const PTag._('PatientState', 0x00380500, 'Patient State', kLOIndex, VM.k1, false);
  static const PTag kPatientClinicalTrialParticipationSequence
      ...
      = const PTag._('PatientClinicalTrialParticipationSequence', 0x00380502,
          'Patient Clinical Trial Participation Sequence', kSQIndex, VM.k1, false);
  static const PTag kVisitComments
      //(0038,4000)
      = const PTag._('VisitComments', 0x00384000, 'Visit Comments', kLTIndex, VM.k1, false);
  static const PTag kWaveformOriginality
      //(003A,0004)
      = const PTag._('WaveformOriginality', 0x003A0004, 'Waveform Originality', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kSamplingFrequency
      //(003A,001A)
      = const PTag._(
          'SamplingFrequency', 0x003A001A, 'Sampling Frequency', kDSIndex, VM.k1, false);
  static const PTag kMultiplexGroupLabel
      //(003A,0020)
      = const PTag._('MultiplexGroupLabel', 0x003A0020, 'Multiplex Group Label', kSHIndex,
          VM.k1, false);
  ...
  static const PTag kChannelLabel
      //(003A,0203)
      = const PTag._('ChannelLabel', 0x003A0203, 'Channel Label', kSHIndex, VM.k1, false);
  static const PTag kChannelStatus
      //(003A,0205)
      =
      const PTag._('ChannelStatus', 0x003A0205, 'Channel Status', kCSIndex, VM.k1_n, false);
  ...
  static const PTag kChannelSensitivity
      //(003A,0210)
      = const PTag._(
          'ChannelSensitivity', 0x003A0210, 'Channel Sensitivity', kDSIndex, VM.k1, false);
  ...
  static const PTag kChannelBaseline
      //(003A,0213)
      = const PTag._(
          'ChannelBaseline', 0x003A0213, 'Channel Baseline', kDSIndex, VM.k1, false);
  static const PTag kChannelTimeSkew
      //(003A,0214)
      = const PTag._(
          'ChannelTimeSkew', 0x003A0214, 'Channel Time Skew', kDSIndex, VM.k1, false);
  static const PTag kChannelSampleSkew
      //(003A,0215)
      = const PTag._(
          'ChannelSampleSkew', 0x003A0215, 'Channel Sample Skew', kDSIndex, VM.k1, false);
  static const PTag kChannelOffset
      //(003A,0218)
      = const PTag._('ChannelOffset', 0x003A0218, 'Channel Offset', kDSIndex, VM.k1, false);
  static const PTag kWaveformBitsStored
      //(003A,021A)
      = const PTag._(
          'WaveformBitsStored', 0x003A021A, 'Waveform Bits Stored', kUSIndex, VM.k1, false);
  static const PTag kFilterLowFrequency
      //(003A,0220)
      = const PTag._(
          'FilterLowFrequency', 0x003A0220, 'Filter Low Frequency', kDSIndex, VM.k1, false);
  static const PTag kFilterHighFrequency
      //(003A,0221)
      = const PTag._('FilterHighFrequency', 0x003A0221, 'Filter High Frequency', kDSIndex,
          VM.k1, false);
  static const PTag kNotchFilterFrequency
      //(003A,0222)
      = const PTag._('NotchFilterFrequency', 0x003A0222, 'Notch Filter Frequency', kDSIndex,
          VM.k1, false);
  static const PTag kNotchFilterBandwidth
      //(003A,0223)
      = const PTag._('NotchFilterBandwidth', 0x003A0223, 'Notch Filter Bandwidth', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kChannelPosition
      //(003A,0245)
      = const PTag._(
          'ChannelPosition', 0x003A0245, 'Channel Position', kFLIndex, VM.k1, false);
  static const PTag kDisplayShadingFlag
      //(003A,0246)
      = const PTag._(
          'DisplayShadingFlag', 0x003A0246, 'Display Shading Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kMultiplexedAudioChannelsDescriptionCodeSequence
      ...
      = const PTag._('MultiplexedAudioChannelsDescriptionCodeSequence', 0x003A0300,
          'Multiplexed Audio Channels Description Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kChannelMode
      //(003A,0302)
      = const PTag._('ChannelMode', 0x003A0302, 'Channel Mode', kCSIndex, VM.k1, false);
  ...
  static const PTag kStageCodeSequence
      //(0040,000A)
      = const PTag._(
          'StageCodeSequence', 0x0040000A, 'Stage Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kScheduledPerformingPhysicianIdentificationSequence
      ...
      = const PTag._('ScheduledPerformingPhysicianIdentificationSequence', 0x0040000B,
          'Scheduled Performing Physician Identification Sequence', kSQIndex, VM.k1, false);
  static const PTag kScheduledStationName
      //(0040,0010)
      = const PTag._('ScheduledStationName', 0x00400010, 'Scheduled Station Name', kSHIndex,
          VM.k1_n, false);
  ...
  static const PTag kPreMedication
      //(0040,0012)
      = const PTag._('PreMedication', 0x00400012, 'Pre-Medication', kLOIndex, VM.k1, false);
  ...
  static const PTag kUniversalEntityID
      //(0040,0032)
      = const PTag._(
          'UniversalEntityID', 0x00400032, 'Universal Entity ID', kUTIndex, VM.k1, false);
  ...
  static const PTag kIdentifierTypeCode
      //(0040,0035)
      = const PTag._(
          'IdentifierTypeCode', 0x00400035, 'Identifier Type Code', kCSIndex, VM.k1, false);
  ...
  static const PTag kAssigningAgencyOrDepartmentCodeSequence
      ...
      = const PTag._('AssigningAgencyOrDepartmentCodeSequence', 0x0040003A,
          'Assigning Agency or Department Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kReferencedNonImageCompositeSOPInstanceSequence
      ...
      = const PTag._('ReferencedNonImageCompositeSOPInstanceSequence', 0x00400220,
          'Referenced Non-Image Composite SOP Instance Sequence', kSQIndex, VM.k1, false);
  static const PTag kPerformedStationAETitle
      //(0040,0241)
      = const PTag._('PerformedStationAETitle', 0x00400241, 'Performed Station AE Title',
          kAEIndex, VM.k1, false);
  static const PTag kPerformedStationName
      //(0040,0242)
      = const PTag._('PerformedStationName', 0x00400242, 'Performed Station Name', kSHIndex,
          VM.k1, false);
  static const PTag kPerformedLocation
      //(0040,0243)
      = const PTag._(
          'PerformedLocation', 0x00400243, 'Performed Location', kSHIndex, VM.k1, false);
  ...
  static const PTag kQuantitySequence
      //(0040,0293)
      = const PTag._(
          'QuantitySequence', 0x00400293, 'Quantity Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kBillingItemSequence
      //(0040,0296)
      = const PTag._('BillingItemSequence', 0x00400296, 'Billing Item Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kEntranceDose
      //(0040,0302)
      = const PTag._('EntranceDose', 0x00400302, 'Entrance Dose', kUSIndex, VM.k1, false);
  static const PTag kExposedArea
      //(0040,0303)
      = const PTag._('ExposedArea', 0x00400303, 'Exposed Area', kUSIndex, VM.k1_2, false);
  ...
  static const PTag kExposureDoseSequence
      //(0040,030E)
      = const PTag._('ExposureDoseSequence', 0x0040030E, 'Exposure Dose Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kXRayOutput
      //(0040,0312)
      = const PTag._('XRayOutput', 0x00400312, 'X-Ray Output', kDSIndex, VM.k1, false);
  static const PTag kHalfValueLayer
      //(0040,0314)
      = const PTag._(
          'HalfValueLayer', 0x00400314, 'Half Value Layer', kDSIndex, VM.k1, false);
  static const PTag kOrganDose
      //(0040,0316)
      = const PTag._('OrganDose', 0x00400316, 'Organ Dose', kDSIndex, VM.k1, false);
  static const PTag kOrganExposed
      //(0040,0318)
      = const PTag._('OrganExposed', 0x00400318, 'Organ Exposed', kCSIndex, VM.k1, false);
  ...
  static const PTag kContainerIdentifier
      //(0040,0512)
      = const PTag._('ContainerIdentifier', 0x00400512, 'Container Identifier', kLOIndex,
          VM.k1, false);
  static const PTag kIssuerOfTheContainerIdentifierSequence
      //(0040,0513)
      = const PTag._('IssuerOfTheContainerIdentifierSequence', 0x00400513,
          'Issuer of the Container Identifier Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kContainerDescription
      //(0040,051A)
      = const PTag._('ContainerDescription', 0x0040051A, 'Container Description', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kSpecimenSequence
      //(0040,0550)
      = const PTag._(
          'SpecimenSequence', 0x00400550, 'Specimen Sequence', kSQIndex, VM.k1, true);
  static const PTag kSpecimenIdentifier
      //(0040,0551)
      = const PTag._(
          'SpecimenIdentifier', 0x00400551, 'Specimen Identifier', kLOIndex, VM.k1, false);
  ...
  static const PTag kSpecimenUID
      //(0040,0554)
      = const PTag._('SpecimenUID', 0x00400554, 'Specimen UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kSpecimenPreparationStepContentItemSequence
      ...
      = const PTag._('SpecimenPreparationStepContentItemSequence', 0x00400612,
          'Specimen Preparation Step Content Item Sequence', kSQIndex, VM.k1, false);
  static const PTag kSpecimenLocalizationContentItemSequence
      ...
      = const PTag._('SpecimenLocalizationContentItemSequence', 0x00400620,
          'Specimen Localization Content Item Sequence', kSQIndex, VM.k1, false);
  static const PTag kSlideIdentifier
      //(0040,06FA)
      = const PTag._(
          'SlideIdentifier', 0x004006FA, 'Slide Identifier', kLOIndex, VM.k1, true);
  ...
  static const PTag kPixelSpacingSequence
      //(0040,08D8)
      = const PTag._('PixelSpacingSequence', 0x004008D8, 'Pixel Spacing Sequence', kSQIndex,
          VM.k1, true);
  ...
  static const PTag kRequestedProcedureID
      //(0040,1001)
      = const PTag._('RequestedProcedureID', 0x00401001, 'Requested Procedure ID', kSHIndex,
          VM.k1, false);
  ...
  static const PTag kConfidentialityCode
      //(0040,1008)
      = const PTag._('ConfidentialityCode', 0x00401008, 'Confidentiality Code', kLOIndex,
          VM.k1, false);
  static const PTag kReportingPriority
      //(0040,1009)
      = const PTag._(
          'ReportingPriority', 0x00401009, 'Reporting Priority', kSHIndex, VM.k1, false);
  static const PTag kReasonForRequestedProcedureCodeSequence
      ...
      = const PTag._('ReasonForRequestedProcedureCodeSequence', 0x0040100A,
          'Reason for Requested Procedure Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIntendedRecipientsOfResultsIdentificationSequence
      ...
      = const PTag._('IntendedRecipientsOfResultsIdentificationSequence', 0x00401011,
          'Intended Recipients of Results Identification Sequence', kSQIndex, VM.k1, false);
  static const PTag kReasonForPerformedProcedureCodeSequence
      ...
      = const PTag._('ReasonForPerformedProcedureCodeSequence', 0x00401012,
          'Reason For Performed Procedure Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kPersonAddress
      //(0040,1102)
      = const PTag._(
          'PersonAddress', 0x00401102, 'Person\'s Address', kSTIndex, VM.k1, false);
  ...
  static const PTag kPlacerOrderNumberImagingServiceRequestRetired
      ...
      = const PTag._('PlacerOrderNumberImagingServiceRequestRetired', 0x00402006,
          'Placer Order Number / Imaging Service Request (Retired)', kSHIndex, VM.k1, true);
  static const PTag kFillerOrderNumberImagingServiceRequestRetired
      ...
      = const PTag._('FillerOrderNumberImagingServiceRequestRetired', 0x00402007,
          'Filler Order Number / Imaging Service Request (Retired)', kSHIndex, VM.k1, true);
  static const PTag kOrderEnteredBy
      //(0040,2008)
      = const PTag._(
          'OrderEnteredBy', 0x00402008, 'Order Entered By', kPNIndex, VM.k1, false);
  ...
  static const PTag kPlacerOrderNumberImagingServiceRequest
      ...
      = const PTag._('PlacerOrderNumberImagingServiceRequest', 0x00402016,
          'Placer Order Number / Imaging Service Request', kLOIndex, VM.k1, false);
  static const PTag kFillerOrderNumberImagingServiceRequest
      //(0040,2017)
      = const PTag._('FillerOrderNumberImagingServiceRequest', 0x00402017,
          'Filler Order Number / Imaging Service Request', kLOIndex, VM.k1, false);
  ...
  static const PTag kConfidentialityConstraintOnPatientDataDescription
      ...
      = const PTag._('ConfidentialityConstraintOnPatientDataDescription', 0x00403001,
          'Confidentiality Constraint on Patient Data Description', kLOIndex, VM.k1, false);
  static const PTag kGeneralPurposeScheduledProcedureStepStatus
      ...
      = const PTag._('GeneralPurposeScheduledProcedureStepStatus', 0x00404001,
          'General Purpose Scheduled Procedure Step Status', kCSIndex, VM.k1, true);
  static const PTag kGeneralPurposePerformedProcedureStepStatus
      ...
      = const PTag._('GeneralPurposePerformedProcedureStepStatus', 0x00404002,
          'General Purpose Performed Procedure Step Status', kCSIndex, VM.k1, true);
  static const PTag kGeneralPurposeScheduledProcedureStepPriority
      ...
      = const PTag._('GeneralPurposeScheduledProcedureStepPriority', 0x00404003,
          'General Purpose Scheduled Procedure Step Priority', kCSIndex, VM.k1, true);
  static const PTag kScheduledProcessingApplicationsCodeSequence
      ...
      = const PTag._('ScheduledProcessingApplicationsCodeSequence', 0x00404004,
          'Scheduled Processing Applications Code Sequence', kSQIndex, VM.k1, true);
  ...
  static const PTag kMultipleCopiesFlag
      //(0040,4006)
      = const PTag._(
          'MultipleCopiesFlag', 0x00404006, 'Multiple Copies Flag', kCSIndex, VM.k1, true);
  static const PTag kPerformedProcessingApplicationsCodeSequence
      ...
      = const PTag._('PerformedProcessingApplicationsCodeSequence', 0x00404007,
          'Performed Processing Applications Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kScheduledProcedureStepModificationDateTime
      ...
      = const PTag._('ScheduledProcedureStepModificationDateTime', 0x00404010,
          'Scheduled Procedure Step Modification DateTime', kDTIndex, VM.k1, false);
  ...
  static const PTag kScheduledStationGeographicLocationCodeSequence
      ...
      = const PTag._('ScheduledStationGeographicLocationCodeSequence', 0x00404027,
          'Scheduled Station Geographic Location Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kPerformedStationGeographicLocationCodeSequence
      ...
      = const PTag._('PerformedStationGeographicLocationCodeSequence', 0x00404030,
          'Performed Station Geographic Location Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kHumanPerformerName
      //(0040,4037)
      = const PTag._('HumanPerformerName', 0x00404037, 'Human Performer\'s Name', kPNIndex,
          VM.k1, false);
  static const PTag kRawDataHandling
      //(0040,4040)
      = const PTag._(
          'RawDataHandling', 0x00404040, 'Raw Data Handling', kCSIndex, VM.k1, false);
  static const PTag kInputReadinessState
      //(0040,4041)
      = const PTag._('InputReadinessState', 0x00404041, 'Input Readiness State', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kEntranceDoseInmGy
      //(0040,8302)
      = const PTag._(
          'EntranceDoseInmGy', 0x00408302, 'Entrance Dose in mGy', kDSIndex, VM.k1, false);
  static const PTag kReferencedImageRealWorldValueMappingSequence
      ...
      = const PTag._('ReferencedImageRealWorldValueMappingSequence', 0x00409094,
          'Referenced Image Real World Value Mapping Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kRealWorldValueSlope
      //(0040,9225)
      = const PTag._('RealWorldValueSlope', 0x00409225, 'Real World Value Slope', kFDIndex,
          VM.k1, false);
  static const PTag kFindingsFlagTrial
      //(0040,A007)
      = const PTag._(
          'FindingsFlagTrial', 0x0040A007, 'Findings Flag (Trial)', kCSIndex, VM.k1, true);
  static const PTag kRelationshipType
      //(0040,A010)
      = const PTag._(
          'RelationshipType', 0x0040A010, 'Relationship Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kFindingsSourceCategoryCodeSequenceTrial
      ...
      = const PTag._('FindingsSourceCategoryCodeSequenceTrial', 0x0040A026,
          'Findings Source Category Code Sequence (Trial)', kSQIndex, VM.k1, true);
  ...
  static const PTag kVerificationDateTime
      //(0040,A030)
      = const PTag._('VerificationDateTime', 0x0040A030, 'Verification DateTime', kDTIndex,
          VM.k1, false);
  static const PTag kObservationDateTime
      //(0040,A032)
      = const PTag._('ObservationDateTime', 0x0040A032, 'Observation DateTime', kDTIndex,
          VM.k1, false);
  static const PTag kValueType
      //(0040,A040)
      = const PTag._('ValueType', 0x0040A040, 'Value Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kContinuityOfContent
      //(0040,A050)
      = const PTag._('ContinuityOfContent', 0x0040A050, 'Continuity Of Content', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kDocumentAuthorTrial
      //(0040,A067)
      = const PTag._('DocumentAuthorTrial', 0x0040A067, 'Document Author (Trial)', kPNIndex,
          VM.k1, true);
  static const PTag kDocumentAuthorIdentifierCodeSequenceTrial
      ...
      = const PTag._('DocumentAuthorIdentifierCodeSequenceTrial', 0x0040A068,
          'Document Author Identifier Code Sequence (Trial)', kSQIndex, VM.k1, true);
  ...
  static const PTag kDocumentingObserverIdentifierCodeSequenceTrial
      ...
      = const PTag._('DocumentingObserverIdentifierCodeSequenceTrial', 0x0040A076,
          'Documenting Observer Identifier Code Sequence (Trial)', kSQIndex, VM.k1, true);
  ...
  static const PTag kParticipantSequence
      //(0040,A07A)
      = const PTag._('ParticipantSequence', 0x0040A07A, 'Participant Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kParticipationType
      //(0040,A080)
      = const PTag._(
          'ParticipationType', 0x0040A080, 'Participation Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kObserverType
      //(0040,A084)
      = const PTag._('ObserverType', 0x0040A084, 'Observer Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kVerifyingObserverIdentificationCodeSequence
      ...
      = const PTag._('VerifyingObserverIdentificationCodeSequence', 0x0040A088,
          'Verifying Observer Identification Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kDateOfDocumentOrVerbalTransactionTrial
      ...
      = const PTag._('DateOfDocumentOrVerbalTransactionTrial', 0x0040A110,
          'Date of Document or Verbal Transaction (Trial)', kDAIndex, VM.k1, true);
  static const PTag kTimeOfDocumentCreationOrVerbalTransactionTrial
      ...
      = const PTag._('TimeOfDocumentCreationOrVerbalTransactionTrial', 0x0040A112,
          'Time of Document Creation or Verbal Transaction (Trial)', kTMIndex, VM.k1, true);
  ...
  static const PTag kPersonName
      //(0040,A123)
      = const PTag._('PersonName', 0x0040A123, 'Person Name', kPNIndex, VM.k1, false);
  ...
  static const PTag kTemporalRangeType
      //(0040,A130)
      = const PTag._(
          'TemporalRangeType', 0x0040A130, 'Temporal Range Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kReferencedDateTime
      //(0040,A13A)
      = const PTag._('ReferencedDateTime', 0x0040A13A, 'Referenced DateTime', kDTIndex,
          VM.k1_n, false);
  static const PTag kTextValue
      //(0040,A160)
      = const PTag._('TextValue', 0x0040A160, 'Text Value', kUTIndex, VM.k1, false);
  static const PTag kFloatingPointValue
      //(0040,A161)
      = const PTag._('FloatingPointValue', 0x0040A161, 'Floating Point Value', kFDIndex,
          VM.k1_n, false);
  ...
  static const PTag kConceptCodeSequence
      //(0040,A168)
      = const PTag._('ConceptCodeSequence', 0x0040A168, 'Concept Code Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kObservationUID
      //(0040,A171)
      =
      const PTag._('ObservationUID', 0x0040A171, 'Observation UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kModifierCodeSequence
      //(0040,A195)
      = const PTag._('ModifierCodeSequence', 0x0040A195, 'Modifier Code Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kNumericValue
      //(0040,A30A)
      = const PTag._('NumericValue', 0x0040A30A, 'Numeric Value', kDSIndex, VM.k1_n, false);
  ...
  static const PTag kVerbalSourceTrial
      //(0040,A352)
      = const PTag._(
          'VerbalSourceTrial', 0x0040A352, 'Verbal Source (Trial)', kPNIndex, VM.k1, true);
  static const PTag kAddressTrial
      //(0040,A353)
      = const PTag._('AddressTrial', 0x0040A353, 'Address (Trial)', kSTIndex, VM.k1, true);
  ...
  static const PTag kVerbalSourceIdentifierCodeSequenceTrial
      ...
      = const PTag._('VerbalSourceIdentifierCodeSequenceTrial', 0x0040A358,
          'Verbal Source Identifier Code Sequence (Trial)', kSQIndex, VM.k1, true);
  ...
  static const PTag kCurrentRequestedProcedureEvidenceSequence
      ...
      = const PTag._('CurrentRequestedProcedureEvidenceSequence', 0x0040A375,
          'Current Requested Procedure Evidence Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kObservationSubjectTypeCodeSequenceTrial
      ...
      = const PTag._('ObservationSubjectTypeCodeSequenceTrial', 0x0040A404,
          'Observation Subject Type Code Sequence (Trial)', kSQIndex, VM.k1, true);
  static const PTag kCompletionFlag
      //(0040,A491)
      =
      const PTag._('CompletionFlag', 0x0040A491, 'Completion Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kVerificationFlag
      //(0040,A493)
      = const PTag._(
          'VerificationFlag', 0x0040A493, 'Verification Flag', kCSIndex, VM.k1, false);
  static const PTag kArchiveRequested
      //(0040,A494)
      = const PTag._(
          'ArchiveRequested', 0x0040A494, 'Archive Requested', kCSIndex, VM.k1, false);
  static const PTag kPreliminaryFlag
      //(0040,A496)
      = const PTag._(
          'PreliminaryFlag', 0x0040A496, 'Preliminary Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kContentSequence
      //(0040,A730)
      = const PTag._(
          'ContentSequence', 0x0040A730, 'Content Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kTemplateIdentifier
      //(0040,DB00)
      = const PTag._(
          'TemplateIdentifier', 0x0040DB00, 'Template Identifier', kCSIndex, VM.k1, false);
  static const PTag kTemplateVersion
      //(0040,DB06)
      = const PTag._(
          'TemplateVersion', 0x0040DB06, 'Template Version', kDTIndex, VM.k1, true);
  static const PTag kTemplateLocalVersion
      //(0040,DB07)
      = const PTag._('TemplateLocalVersion', 0x0040DB07, 'Template Local Version', kDTIndex,
          VM.k1, true);
  ...
  static const PTag kRetrieveURI
      //(0040,E010)
      = const PTag._('RetrieveURI', 0x0040E010, 'Retrieve URI', kURIndex, VM.k1, false);
  static const PTag kRetrieveLocationUID
      //(0040,E011)
      = const PTag._('RetrieveLocationUID', 0x0040E011, 'Retrieve Location UID', kUIIndex,
          VM.k1, false);
  static const PTag kTypeOfInstances
      //(0040,E020)
      = const PTag._(
          'TypeOfInstances', 0x0040E020, 'Type of Instances', kCSIndex, VM.k1, false);
  ...
  static const PTag kXDSRetrievalSequence
      //(0040,E024)
      = const PTag._('XDSRetrievalSequence', 0x0040E024, 'XDS Retrieval Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kRepositoryUniqueID
      //(0040,E030)
      = const PTag._(
          'RepositoryUniqueID', 0x0040E030, 'Repository Unique ID', kUIIndex, VM.k1, false);
  static const PTag kHomeCommunityID
      //(0040,E031)
      = const PTag._(
          'HomeCommunityID', 0x0040E031, 'Home Community ID', kUIIndex, VM.k1, false);
  static const PTag kDocumentTitle
      //(0042,0010)
      = const PTag._('DocumentTitle', 0x00420010, 'Document Title', kSTIndex, VM.k1, false);
  static const PTag kEncapsulatedDocument
      //(0042,0011)
      = const PTag._('EncapsulatedDocument', 0x00420011, 'Encapsulated Document', kOBIndex,
          VM.k1, false);
  ...
  static const PTag kListOfMIMETypes
      //(0042,0014)
      = const PTag._(
          'ListOfMIMETypes', 0x00420014, 'List of MIME Types', kLOIndex, VM.k1_n, false);
  ...
  static const PTag kProductName
      //(0044,0008)
      = const PTag._('ProductName', 0x00440008, 'Product Name', kLOIndex, VM.k1_n, false);
  static const PTag kProductDescription
      //(0044,0009)
      = const PTag._(
          'ProductDescription', 0x00440009, 'Product Description', kLTIndex, VM.k1, false);
  static const PTag kProductLotIdentifier
      //(0044,000A)
      = const PTag._('ProductLotIdentifier', 0x0044000A, 'Product Lot Identifier', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kSubstanceAdministrationParameterSequence
      ...
      = const PTag._('SubstanceAdministrationParameterSequence', 0x00440019,
          'Substance Administration Parameter Sequence', kSQIndex, VM.k1, false);
  static const PTag kLensDescription
      //(0046,0012)
      = const PTag._(
          'LensDescription', 0x00460012, 'Lens Description', kLOIndex, VM.k1, false);
  static const PTag kRightLensSequence
      //(0046,0014)
      = const PTag._(
          'RightLensSequence', 0x00460014, 'Right Lens Sequence', kSQIndex, VM.k1, false);
  static const PTag kLeftLensSequence
      //(0046,0015)
      = const PTag._(
          'LeftLensSequence', 0x00460015, 'Left Lens Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kCylinderSequence
      //(0046,0018)
      = const PTag._(
          'CylinderSequence', 0x00460018, 'Cylinder Sequence', kSQIndex, VM.k1, false);
  static const PTag kPrismSequence
      //(0046,0028)
      = const PTag._('PrismSequence', 0x00460028, 'Prism Sequence', kSQIndex, VM.k1, false);
  static const PTag kHorizontalPrismPower
      //(0046,0030)
      = const PTag._('HorizontalPrismPower', 0x00460030, 'Horizontal Prism Power', kFDIndex,
          VM.k1, false);
  static const PTag kHorizontalPrismBase
      //(0046,0032)
      = const PTag._('HorizontalPrismBase', 0x00460032, 'Horizontal Prism Base', kCSIndex,
          VM.k1, false);
  static const PTag kVerticalPrismPower
      //(0046,0034)
      = const PTag._(
          'VerticalPrismPower', 0x00460034, 'Vertical Prism Power', kFDIndex, VM.k1, false);
  static const PTag kVerticalPrismBase
      //(0046,0036)
      = const PTag._(
          'VerticalPrismBase', 0x00460036, 'Vertical Prism Base', kCSIndex, VM.k1, false);
  static const PTag kLensSegmentType
      //(0046,0038)
      = const PTag._(
          'LensSegmentType', 0x00460038, 'Lens Segment Type', kCSIndex, VM.k1, false);
  static const PTag kOpticalTransmittance
      //(0046,0040)
      = const PTag._('OpticalTransmittance', 0x00460040, 'Optical Transmittance', kFDIndex,
          VM.k1, false);
  static const PTag kChannelWidth
      //(0046,0042)
      = const PTag._('ChannelWidth', 0x00460042, 'Channel Width', kFDIndex, VM.k1, false);
  static const PTag kPupilSize
      //(0046,0044)
      = const PTag._('PupilSize', 0x00460044, 'Pupil Size', kFDIndex, VM.k1, false);
  static const PTag kCornealSize
      //(0046,0046)
      = const PTag._('CornealSize', 0x00460046, 'Corneal Size', kFDIndex, VM.k1, false);
  ...
  static const PTag kRadiusOfCurvature
      //(0046,0075)
      = const PTag._(
          'RadiusOfCurvature', 0x00460075, 'Radius of Curvature', kFDIndex, VM.k1, false);
  static const PTag kKeratometricPower
      //(0046,0076)
      = const PTag._(
          'KeratometricPower', 0x00460076, 'Keratometric Power', kFDIndex, VM.k1, false);
  static const PTag kKeratometricAxis
      //(0046,0077)
      = const PTag._(
          'KeratometricAxis', 0x00460077, 'Keratometric Axis', kFDIndex, VM.k1, false);
  ...
  static const PTag kBackgroundColor
      //(0046,0092)
      = const PTag._(
          'BackgroundColor', 0x00460092, 'Background Color', kCSIndex, VM.k1, false);
  ...
  static const PTag kOptotypePresentation
      //(0046,0095)
      = const PTag._('OptotypePresentation', 0x00460095, 'Optotype Presentation', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kAddNearSequence
      //(0046,0100)
      = const PTag._(
          'AddNearSequence', 0x00460100, 'Add Near Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kAddOtherSequence
      //(0046,0102)
      = const PTag._(
          'AddOtherSequence', 0x00460102, 'Add Other Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kViewingDistance
      //(0046,0106)
      = const PTag._(
          'ViewingDistance', 0x00460106, 'Viewing Distance', kFDIndex, VM.k1, false);
  ...
  static const PTag kViewingDistanceType
      //(0046,0125)
      = const PTag._('ViewingDistanceType', 0x00460125, 'Viewing Distance Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kDecimalVisualAcuity
      //(0046,0137)
      = const PTag._('DecimalVisualAcuity', 0x00460137, 'Decimal Visual Acuity', kFDIndex,
          VM.k1, false);
  ...
  static const PTag kReferencedRefractiveMeasurementsSequence
      ...
      = const PTag._('ReferencedRefractiveMeasurementsSequence', 0x00460145,
          'Referenced Refractive Measurements Sequence', kSQIndex, VM.k1, false);
  static const PTag kSpherePower
      //(0046,0146)
      = const PTag._('SpherePower', 0x00460146, 'Sphere Power', kFDIndex, VM.k1, false);
  static const PTag kCylinderPower
      //(0046,0147)
      = const PTag._('CylinderPower', 0x00460147, 'Cylinder Power', kFDIndex, VM.k1, false);
  ...
  static const PTag kCornealTopographyMappingNormalsSequence
      ...
      = const PTag._('CornealTopographyMappingNormalsSequence', 0x00460210,
          'Corneal Topography Mapping Normals Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kAverageCornealPower
      //(0046,0220)
      = const PTag._('AverageCornealPower', 0x00460220, 'Average Corneal Power', kFLIndex,
          VM.k1, false);
  static const PTag kCornealISValue
      //(0046,0224)
      = const PTag._(
          'CornealISValue', 0x00460224, 'Corneal I-S Value', kFLIndex, VM.k1, false);
  static const PTag kAnalyzedArea
      //(0046,0227)
      = const PTag._('AnalyzedArea', 0x00460227, 'Analyzed Area', kFLIndex, VM.k1, false);
  ...
  static const PTag kSourceImageCornealProcessedDataSequence
      ...
      = const PTag._('SourceImageCornealProcessedDataSequence', 0x00460244,
          'Source Image Corneal Processed Data Sequence', kSQIndex, VM.k1, false);
  static const PTag kCornealPointLocation
      //(0046,0247)
      = const PTag._('CornealPointLocation', 0x00460247, 'Corneal Point Location', kFLIndex,
          VM.k3, false);
  ...
  static const PTag kAxialPower
      //(0046,0249)
      = const PTag._('AxialPower', 0x00460249, 'Axial Power', kFLIndex, VM.k1, false);
  static const PTag kTangentialPower
      //(0046,0250)
      = const PTag._(
          'TangentialPower', 0x00460250, 'Tangential Power', kFLIndex, VM.k1, false);
  static const PTag kRefractivePower
      //(0046,0251)
      = const PTag._(
          'RefractivePower', 0x00460251, 'Refractive Power', kFLIndex, VM.k1, false);
  static const PTag kRelativeElevation
      //(0046,0252)
      = const PTag._(
          'RelativeElevation', 0x00460252, 'Relative Elevation', kFLIndex, VM.k1, false);
  static const PTag kCornealWavefront
      //(0046,0253)
      = const PTag._(
          'CornealWavefront', 0x00460253, 'Corneal Wavefront', kFLIndex, VM.k1, false);
  static const PTag kImagedVolumeWidth
      //(0048,0001)
      = const PTag._(
          'ImagedVolumeWidth', 0x00480001, 'Imaged Volume Width', kFLIndex, VM.k1, false);
  static const PTag kImagedVolumeHeight
      //(0048,0002)
      = const PTag._(
          'ImagedVolumeHeight', 0x00480002, 'Imaged Volume Height', kFLIndex, VM.k1, false);
  static const PTag kImagedVolumeDepth
      //(0048,0003)
      = const PTag._(
          'ImagedVolumeDepth', 0x00480003, 'Imaged Volume Depth', kFLIndex, VM.k1, false);
  ...
  static const PTag kFocusMethod
      //(0048,0011)
      = const PTag._('FocusMethod', 0x00480011, 'Focus Method', kCSIndex, VM.k1, false);
  ...
  static const PTag kNumberOfFocalPlanes
      //(0048,0013)
      = const PTag._('NumberOfFocalPlanes', 0x00480013, 'Number of Focal Planes', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kOpticalPathSequence
      //(0048,0105)
      = const PTag._('OpticalPathSequence', 0x00480105, 'Optical Path Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kCondenserLensPower
      //(0048,0111)
      = const PTag._(
          'CondenserLensPower', 0x00480111, 'Condenser Lens Power', kDSIndex, VM.k1, false);
  static const PTag kObjectiveLensPower
      //(0048,0112)
      = const PTag._(
          'ObjectiveLensPower', 0x00480112, 'Objective Lens Power', kDSIndex, VM.k1, false);
  ...
  static const PTag kColumnPositionInTotalImagePixelMatrix
      ...
      = const PTag._('ColumnPositionInTotalImagePixelMatrix', 0x0048021E,
          'Column Position In Total Image Pixel Matrix', kSLIndex, VM.k1, false);
  ...
  static const PTag kCalibrationImage
      //(0050,0004)
      = const PTag._(
          'CalibrationImage', 0x00500004, 'Calibration Image', kCSIndex, VM.k1, false);
  static const PTag kDeviceSequence
      //(0050,0010)
      =
      const PTag._('DeviceSequence', 0x00500010, 'Device Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kDeviceLength
      //(0050,0014)
      = const PTag._('DeviceLength', 0x00500014, 'Device Length', kDSIndex, VM.k1, false);
  ...
  static const PTag kDeviceDiameter
      //(0050,0016)
      =
      const PTag._('DeviceDiameter', 0x00500016, 'Device Diameter', kDSIndex, VM.k1, false);
  static const PTag kDeviceDiameterUnits
      //(0050,0017)
      = const PTag._('DeviceDiameterUnits', 0x00500017, 'Device Diameter Units', kCSIndex,
          VM.k1, false);
  static const PTag kDeviceVolume
      //(0050,0018)
      = const PTag._('DeviceVolume', 0x00500018, 'Device Volume', kDSIndex, VM.k1, false);
  static const PTag kInterMarkerDistance
      //(0050,0019)
      = const PTag._('InterMarkerDistance', 0x00500019, 'Inter-Marker Distance', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kContainerComponentID
      //(0050,001B)
      = const PTag._('ContainerComponentID', 0x0050001B, 'Container Component ID', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kDeviceDescription
      //(0050,0020)
      = const PTag._(
          'DeviceDescription', 0x00500020, 'Device Description', kLOIndex, VM.k1, false);
  static const PTag kContrastBolusIngredientPercentByVolume
      //(0052,0001)
      = const PTag._('ContrastBolusIngredientPercentByVolume', 0x00520001,
          'Contrast/Bolus Ingredient Percent by Volume', kFLIndex, VM.k1, false);
  static const PTag kOCTFocalDistance
      //(0052,0002)
      = const PTag._(
          'OCTFocalDistance', 0x00520002, 'OCT Focal Distance', kFDIndex, VM.k1, false);
  static const PTag kBeamSpotSize
      //(0052,0003)
      = const PTag._('BeamSpotSize', 0x00520003, 'Beam Spot Size', kFDIndex, VM.k1, false);
  ...
  static const PTag kOCTAcquisitionDomain
      //(0052,0006)
      = const PTag._('OCTAcquisitionDomain', 0x00520006, 'OCT Acquisition Domain', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kAxialResolution
      //(0052,0008)
      = const PTag._(
          'AxialResolution', 0x00520008, 'Axial Resolution', kFDIndex, VM.k1, false);
  static const PTag kRangingDepth
      //(0052,0009)
      = const PTag._('RangingDepth', 0x00520009, 'Ranging Depth', kFDIndex, VM.k1, false);
  static const PTag kALineRate
      //(0052,0011)
      = const PTag._('ALineRate', 0x00520011, 'A-line Rate', kFDIndex, VM.k1, false);
  static const PTag kALinesPerFrame
      //(0052,0012)
      = const PTag._(
          'ALinesPerFrame', 0x00520012, 'A-lines Per Frame', kUSIndex, VM.k1, false);
  ...
  static const PTag kALinePixelSpacing
      //(0052,0014)
      = const PTag._(
          'ALinePixelSpacing', 0x00520014, 'A-line Pixel Spacing', kFDIndex, VM.k1, false);
  ...
  static const PTag kOCTZOffsetApplied
      //(0052,0026)
      = const PTag._(
          'OCTZOffsetApplied', 0x00520026, 'OCT Z Offset Applied', kCSIndex, VM.k1, false);
  ...
  static const PTag kSeamLineLocation
      //(0052,0033)
      = const PTag._(
          'SeamLineLocation', 0x00520033, 'Seam Line Location', kFDIndex, VM.k1, false);
  static const PTag kFirstALineLocation
      //(0052,0034)
      = const PTag._('FirstALineLocation', 0x00520034, 'First A-line Location', kFDIndex,
          VM.k1, false);
  static const PTag kSeamLineIndex
      //(0052,0036)
      =
      const PTag._('SeamLineIndex', 0x00520036, 'Seam Line Index', kUSIndex, VM.k1, false);
  ...
  static const PTag kInterpolationType
      //(0052,0039)
      = const PTag._(
          'InterpolationType', 0x00520039, 'Interpolation Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kEnergyWindowVector
      //(0054,0010)
      = const PTag._('EnergyWindowVector', 0x00540010, 'Energy Window Vector', kUSIndex,
          VM.k1_n, false);
  ...
  static const PTag kEnergyWindowName
      //(0054,0018)
      = const PTag._(
          'EnergyWindowName', 0x00540018, 'Energy Window Name', kSHIndex, VM.k1, false);
  static const PTag kDetectorVector
      //(0054,0020)
      = const PTag._(
          'DetectorVector', 0x00540020, 'Detector Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfDetectors
      //(0054,0021)
      = const PTag._(
          'NumberOfDetectors', 0x00540021, 'Number of Detectors', kUSIndex, VM.k1, false);
  ...
  static const PTag kPhaseVector
      //(0054,0030)
      = const PTag._('PhaseVector', 0x00540030, 'Phase Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfPhases
      //(0054,0031)
      = const PTag._(
          'NumberOfPhases', 0x00540031, 'Number of Phases', kUSIndex, VM.k1, false);
  ...
  static const PTag kPhaseDelay
      //(0054,0036)
      = const PTag._('PhaseDelay', 0x00540036, 'Phase Delay', kISIndex, VM.k1, false);
  static const PTag kPauseBetweenFrames
      //(0054,0038)
      = const PTag._(
          'PauseBetweenFrames', 0x00540038, 'Pause Between Frames', kISIndex, VM.k1, false);
  static const PTag kPhaseDescription
      //(0054,0039)
      = const PTag._(
          'PhaseDescription', 0x00540039, 'Phase Description', kCSIndex, VM.k1, false);
  static const PTag kRotationVector
      //(0054,0050)
      = const PTag._(
          'RotationVector', 0x00540050, 'Rotation Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfRotations
      //(0054,0051)
      = const PTag._(
          'NumberOfRotations', 0x00540051, 'Number of Rotations', kUSIndex, VM.k1, false);
  ...
  static const PTag kRRIntervalVector
      //(0054,0060)
      = const PTag._(
          'RRIntervalVector', 0x00540060, 'R-R Interval Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfRRIntervals
      //(0054,0061)
      = const PTag._('NumberOfRRIntervals', 0x00540061, 'Number of R-R Intervals', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kTimeSlotVector
      //(0054,0070)
      = const PTag._(
          'TimeSlotVector', 0x00540070, 'Time Slot Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfTimeSlots
      //(0054,0071)
      = const PTag._(
          'NumberOfTimeSlots', 0x00540071, 'Number of Time Slots', kUSIndex, VM.k1, false);
  ...
  static const PTag kTimeSlotTime
      //(0054,0073)
      = const PTag._('TimeSlotTime', 0x00540073, 'Time Slot Time', kDSIndex, VM.k1, false);
  static const PTag kSliceVector
      //(0054,0080)
      = const PTag._('SliceVector', 0x00540080, 'Slice Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfSlices
      //(0054,0081)
      = const PTag._(
          'NumberOfSlices', 0x00540081, 'Number of Slices', kUSIndex, VM.k1, false);
  static const PTag kAngularViewVector
      //(0054,0090)
      = const PTag._(
          'AngularViewVector', 0x00540090, 'Angular View Vector', kUSIndex, VM.k1_n, false);
  static const PTag kTimeSliceVector
      //(0054,0100)
      = const PTag._(
          'TimeSliceVector', 0x00540100, 'Time Slice Vector', kUSIndex, VM.k1_n, false);
  static const PTag kNumberOfTimeSlices
      //(0054,0101)
      = const PTag._('NumberOfTimeSlices', 0x00540101, 'Number of Time Slices', kUSIndex,
          VM.k1, false);
  static const PTag kStartAngle
      //(0054,0200)
      = const PTag._('StartAngle', 0x00540200, 'Start Angle', kDSIndex, VM.k1, false);
  ...
  static const PTag kTriggerVector
      //(0054,0210)
      =
      const PTag._('TriggerVector', 0x00540210, 'Trigger Vector', kISIndex, VM.k1_n, false);
  ...
  static const PTag kViewCodeSequence
      //(0054,0220)
      = const PTag._(
          'ViewCodeSequence', 0x00540220, 'View Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kEnergyWindowNumber
      //(0054,0308)
      = const PTag._(
          'EnergyWindowNumber', 0x00540308, 'Energy Window Number', kUSIndex, VM.k1, false);
  ...
  static const PTag kSeriesType
      //(0054,1000)
      = const PTag._('SeriesType', 0x00541000, 'Series Type', kCSIndex, VM.k2, false);
  static const PTag kUnits
      //(0054,1001)
      = const PTag._('Units', 0x00541001, 'Units', kCSIndex, VM.k1, false);
  static const PTag kCountsSource
      //(0054,1002)
      = const PTag._('CountsSource', 0x00541002, 'Counts Source', kCSIndex, VM.k1, false);
  static const PTag kReprojectionMethod
      //(0054,1004)
      = const PTag._(
          'ReprojectionMethod', 0x00541004, 'Reprojection Method', kCSIndex, VM.k1, false);
  ...
  static const PTag kDecayCorrection
      //(0054,1102)
      = const PTag._(
          'DecayCorrection', 0x00541102, 'Decay Correction', kCSIndex, VM.k1, false);
  static const PTag kReconstructionMethod
      //(0054,1103)
      = const PTag._('ReconstructionMethod', 0x00541103, 'Reconstruction Method', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kAxialAcceptance
      //(0054,1200)
      = const PTag._(
          'AxialAcceptance', 0x00541200, 'Axial Acceptance', kDSIndex, VM.k1, false);
  static const PTag kAxialMash
      //(0054,1201)
      = const PTag._('AxialMash', 0x00541201, 'Axial Mash', kISIndex, VM.k2, false);
  static const PTag kTransverseMash
      //(0054,1202)
      =
      const PTag._('TransverseMash', 0x00541202, 'Transverse Mash', kISIndex, VM.k1, false);
  static const PTag kDetectorElementSize
      //(0054,1203)
      = const PTag._('DetectorElementSize', 0x00541203, 'Detector Element Size', kDSIndex,
          VM.k2, false);
  ...
  static const PTag kSecondaryCountsType
      //(0054,1220)
      = const PTag._('SecondaryCountsType', 0x00541220, 'Secondary Counts Type', kCSIndex,
          VM.k1_n, false);
  static const PTag kFrameReferenceTime
      //(0054,1300)
      = const PTag._(
          'FrameReferenceTime', 0x00541300, 'Frame Reference Time', kDSIndex, VM.k1, false);
  ...
  static const PTag kDecayFactor
      //(0054,1321)
      = const PTag._('DecayFactor', 0x00541321, 'Decay Factor', kDSIndex, VM.k1, false);
  ...
  static const PTag kDeadTimeFactor
      //(0054,1324)
      = const PTag._(
          'DeadTimeFactor', 0x00541324, 'Dead Time Factor', kDSIndex, VM.k1, false);
  static const PTag kImageIndex
      //(0054,1330)
      = const PTag._('ImageIndex', 0x00541330, 'Image Index', kUSIndex, VM.k1, false);
  static const PTag kCountsIncluded
      //(0054,1400)
      = const PTag._(
          'CountsIncluded', 0x00541400, 'Counts Included', kCSIndex, VM.k1_n, true);
  ...
  static const PTag kHistogramSequence
      //(0060,3000)
      = const PTag._(
          'HistogramSequence', 0x00603000, 'Histogram Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kHistogramBinWidth
      //(0060,3008)
      = const PTag._(
          'HistogramBinWidth', 0x00603008, 'Histogram Bin Width', kUSIndex, VM.k1, false);
  static const PTag kHistogramExplanation
      //(0060,3010)
      = const PTag._('HistogramExplanation', 0x00603010, 'Histogram Explanation', kLOIndex,
          VM.k1, false);
  static const PTag kHistogramData
      //(0060,3020)
      =
      const PTag._('HistogramData', 0x00603020, 'Histogram Data', kULIndex, VM.k1_n, false);
  static const PTag kSegmentationType
      //(0062,0001)
      = const PTag._(
          'SegmentationType', 0x00620001, 'Segmentation Type', kCSIndex, VM.k1, false);
  static const PTag kSegmentSequence
      //(0062,0002)
      = const PTag._(
          'SegmentSequence', 0x00620002, 'Segment Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSegmentNumber
      //(0062,0004)
      = const PTag._('SegmentNumber', 0x00620004, 'Segment Number', kUSIndex, VM.k1, false);
  static const PTag kSegmentLabel
      //(0062,0005)
      = const PTag._('SegmentLabel', 0x00620005, 'Segment Label', kLOIndex, VM.k1, false);
  static const PTag kSegmentDescription
      //(0062,0006)
      = const PTag._(
          'SegmentDescription', 0x00620006, 'Segment Description', kSTIndex, VM.k1, false);
  static const PTag kSegmentAlgorithmType
      //(0062,0008)
      = const PTag._('SegmentAlgorithmType', 0x00620008, 'Segment Algorithm Type', kCSIndex,
          VM.k1, false);
  static const PTag kSegmentAlgorithmName
      //(0062,0009)
      = const PTag._('SegmentAlgorithmName', 0x00620009, 'Segment Algorithm Name', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kSegmentedPropertyTypeModifierCodeSequence
      ...
      = const PTag._('SegmentedPropertyTypeModifierCodeSequence', 0x00620011,
          'Segmented Property Type Modifier Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kUsedSegmentsSequence
      //(0062,0012)
      = const PTag._('UsedSegmentsSequence', 0x00620012, 'Used Segments Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kGridDimensions
      //(0064,0007)
      =
      const PTag._('GridDimensions', 0x00640007, 'Grid Dimensions', kULIndex, VM.k3, false);
  static const PTag kGridResolution
      //(0064,0008)
      =
      const PTag._('GridResolution', 0x00640008, 'Grid Resolution', kFDIndex, VM.k3, false);
  static const PTag kVectorGridData
      //(0064,0009)
      = const PTag._(
          'VectorGridData', 0x00640009, 'Vector Grid Data', kOFIndex, VM.k1, false);
  static const PTag kPreDeformationMatrixRegistrationSequence
      ...
      = const PTag._('PreDeformationMatrixRegistrationSequence', 0x0064000F,
          'Pre Deformation Matrix Registration Sequence', kSQIndex, VM.k1, false);
  static const PTag kPostDeformationMatrixRegistrationSequence
      ...
      = const PTag._('PostDeformationMatrixRegistrationSequence', 0x00640010,
          'Post Deformation Matrix Registration Sequence', kSQIndex, VM.k1, false);
  static const PTag kNumberOfSurfaces
      //(0066,0001)
      = const PTag._(
          'NumberOfSurfaces', 0x00660001, 'Number of Surfaces', kULIndex, VM.k1, false);
  static const PTag kSurfaceSequence
      //(0066,0002)
      = const PTag._(
          'SurfaceSequence', 0x00660002, 'Surface Sequence', kSQIndex, VM.k1, false);
  static const PTag kSurfaceNumber
      //(0066,0003)
      = const PTag._('SurfaceNumber', 0x00660003, 'Surface Number', kULIndex, VM.k1, false);
  static const PTag kSurfaceComments
      //(0066,0004)
      = const PTag._(
          'SurfaceComments', 0x00660004, 'Surface Comments', kLTIndex, VM.k1, false);
  static const PTag kSurfaceProcessing
      //(0066,0009)
      = const PTag._(
          'SurfaceProcessing', 0x00660009, 'Surface Processing', kCSIndex, VM.k1, false);
  ...
  static const PTag kFiniteVolume
      //(0066,000E)
      = const PTag._('FiniteVolume', 0x0066000E, 'Finite Volume', kCSIndex, VM.k1, false);
  ...
  static const PTag kPointCoordinatesData
      //(0066,0016)
      = const PTag._('PointCoordinatesData', 0x00660016, 'Point Coordinates Data', kOFIndex,
          VM.k1, false);
  ...
  static const PTag kMeanPointDistance
      //(0066,0018)
      = const PTag._(
          'MeanPointDistance', 0x00660018, 'Mean Point Distance', kFLIndex, VM.k1, false);
  static const PTag kMaximumPointDistance
      //(0066,0019)
      = const PTag._('MaximumPointDistance', 0x00660019, 'Maximum Point Distance', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kAxisOfRotation
      //(0066,001B)
      = const PTag._(
          'AxisOfRotation', 0x0066001B, 'Axis of Rotation', kFLIndex, VM.k3, false);
  static const PTag kCenterOfRotation
      //(0066,001C)
      = const PTag._(
          'CenterOfRotation', 0x0066001C, 'Center of Rotation', kFLIndex, VM.k3, false);
  static const PTag kNumberOfVectors
      //(0066,001E)
      = const PTag._(
          'NumberOfVectors', 0x0066001E, 'Number of Vectors', kULIndex, VM.k1, false);
  static const PTag kVectorDimensionality
      //(0066,001F)
      = const PTag._('VectorDimensionality', 0x0066001F, 'Vector Dimensionality', kUSIndex,
          VM.k1, false);
  static const PTag kVectorAccuracy
      //(0066,0020)
      = const PTag._(
          'VectorAccuracy', 0x00660020, 'Vector Accuracy', kFLIndex, VM.k1_n, false);
  static const PTag kVectorCoordinateData
      //(0066,0021)
      = const PTag._('VectorCoordinateData', 0x00660021, 'Vector Coordinate Data', kOFIndex,
          VM.k1, false);
  ...
  static const PTag kEdgePointIndexList
      //(0066,0024)
      = const PTag._('EdgePointIndexList', 0x00660024, 'Edge Point Index List', kOWIndex,
          VM.k1, false);
  ...
  static const PTag kTriangleFanSequence
      //(0066,0027)
      = const PTag._('TriangleFanSequence', 0x00660027, 'Triangle Fan Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kLineSequence
      //(0066,0028)
      = const PTag._('LineSequence', 0x00660028, 'Line Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSurfaceCount
      //(0066,002A)
      = const PTag._('SurfaceCount', 0x0066002A, 'Surface Count', kULIndex, VM.k1, false);
  ...
  static const PTag kAlgorithmVersion
      //(0066,0031)
      = const PTag._(
          'AlgorithmVersion', 0x00660031, 'Algorithm Version', kLOIndex, VM.k1, false);
  static const PTag kAlgorithmParameters
      //(0066,0032)
      = const PTag._('AlgorithmParameters', 0x00660032, 'Algorithm Parameters', kLTIndex,
          VM.k1, false);
  static const PTag kFacetSequence
      //(0066,0034)
      = const PTag._('FacetSequence', 0x00660034, 'Facet Sequence', kSQIndex, VM.k1, false);
  static const PTag kSurfaceProcessingAlgorithmIdentificationSequence
      ...
      = const PTag._('SurfaceProcessingAlgorithmIdentificationSequence', 0x00660035,
          'Surface Processing Algorithm Identification Sequence', kSQIndex, VM.k1, false);
  static const PTag kAlgorithmName
      //(0066,0036)
      = const PTag._('AlgorithmName', 0x00660036, 'Algorithm Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kLongEdgePointIndexList = const PTag._(
      'LongEdgePointIndexList', 0x00660042, 'Long Edge Point Index List', kOLIndex, VM.k1);
  static const PTag kLongVertexPointIndexList = const PTag._('LongVertexPointIndexList',
      0x00660043, 'Long Vertex Point Index List', kOLIndex, VM.k1);
  static const PTag kTrackSetSequence =
      const PTag._('TrackSetSequence', 0x00660101, 'Track Set Sequence', kSQIndex, VM.k1);
  static const PTag kTrackSequence =
      const PTag._('TrackSequence', 0x00660102, 'Track Sequence', kSQIndex, VM.k1);
  ...
  static const PTag kTrackSetNumber =
      const PTag._('TrackSetNumber', 0x00660105, 'Track Set Number', kULIndex, VM.k1);
  static const PTag kTrackSetLabel =
      const PTag._('TrackSetLabel', 0x00660106, 'Track Set Label', kLOIndex, VM.k1);
  static const PTag kTrackSetDescription = const PTag._(
      'TrackSetDescription', 0x00660107, 'Track Set Description', kUTIndex, VM.k1);
  ...
  static const PTag kMeasurementsSequence = const PTag._(
      'MeasurementsSequence', 0x00660121, 'Measurements Sequence', kSQIndex, VM.k1);
  ...
  static const PTag kFloatingPointValues = const PTag._(
      'FloatingPointValues', 0x00660125, 'Floating Point Values', kOFIndex, VM.k1);
  static const PTag kTrackPointIndexList = const PTag._(
      'TrackPointIndexList', 0x00660129, 'Track Point Index List', kOLIndex, VM.k1);
  static const PTag kTrackStatisticsSequence = const PTag._(
      'TrackStatisticsSequence', 0x00660130, 'Track Statistics Sequence', kSQIndex, VM.k1);
  static const PTag kMeasurementValuesSequence = const PTag._('MeasurementValuesSequence',
      0x00660132, 'Measurement Values Sequence', kSQIndex, VM.k1);
  ...
  static const PTag kImplantSize
      //(0068,6210)
      = const PTag._('ImplantSize', 0x00686210, 'Implant Size', kLOIndex, VM.k1, false);
  ...
  static const PTag kImplantType
      //(0068,6223)
      = const PTag._('ImplantType', 0x00686223, 'Implant Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kEffectiveDateTime
      //(0068,6226)
      = const PTag._(
          'EffectiveDateTime', 0x00686226, 'Effective DateTime', kDTIndex, VM.k1, false);
  ...
  static const PTag kInformationSummary
      //(0068,6280)
      = const PTag._(
          'InformationSummary', 0x00686280, 'Information Summary', kSTIndex, VM.k1, false);
  static const PTag kImplantRegulatoryDisapprovalCodeSequence
      ...
      = const PTag._('ImplantRegulatoryDisapprovalCodeSequence', 0x006862A0,
          'Implant Regulatory Disapproval Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kHPGLDocumentSequence
      //(0068,62C0)
      = const PTag._('HPGLDocumentSequence', 0x006862C0, 'HPGL Document Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kHPGLDocumentID
      //(0068,62D0)
      = const PTag._(
          'HPGLDocumentID', 0x006862D0, 'HPGL Document ID', kUSIndex, VM.k1, false);
  static const PTag kHPGLDocumentLabel
      //(0068,62D5)
      = const PTag._(
          'HPGLDocumentLabel', 0x006862D5, 'HPGL Document Label', kLOIndex, VM.k1, false);
  ...
  static const PTag kViewOrientationModifier
      ...
      = const PTag._('ViewOrientationModifier', 0x006862F0, 'View Orientation Modifier',
          kFDIndex, VM.k9, false);
  static const PTag kHPGLDocumentScaling
      //(0068,62F2)
      = const PTag._('HPGLDocumentScaling', 0x006862F2, 'HPGL Document Scaling', kFDIndex,
          VM.k1, false);
  static const PTag kHPGLDocument
      //(0068,6300)
      = const PTag._('HPGLDocument', 0x00686300, 'HPGL Document', kOBIndex, VM.k1, false);
  ...
  static const PTag kHPGLPenSequence
      //(0068,6320)
      = const PTag._(
          'HPGLPenSequence', 0x00686320, 'HPGL Pen Sequence', kSQIndex, VM.k1, false);
  static const PTag kHPGLPenNumber
      //(0068,6330)
      =
      const PTag._('HPGLPenNumber', 0x00686330, 'HPGL Pen Number', kUSIndex, VM.k1, false);
  static const PTag kHPGLPenLabel
      //(0068,6340)
      = const PTag._('HPGLPenLabel', 0x00686340, 'HPGL Pen Label', kLOIndex, VM.k1, false);
  static const PTag kHPGLPenDescription
      //(0068,6345)
      = const PTag._(
          'HPGLPenDescription', 0x00686345, 'HPGL Pen Description', kSTIndex, VM.k1, false);
  ...
  static const PTag kBoundingRectangle
      //(0068,6347)
      = const PTag._(
          'BoundingRectangle', 0x00686347, 'Bounding Rectangle', kFDIndex, VM.k4, false);
  ...
  static const PTag kSurfaceModelLabel
      //(0068,6380)
      = const PTag._(
          'SurfaceModelLabel', 0x00686380, 'Surface Model Label', kLOIndex, VM.k1, false);
  ...
  static const PTag kMatingFeatureSetID
      //(0068,63C0)
      = const PTag._('MatingFeatureSetID', 0x006863C0, 'Mating Feature Set ID', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kMatingFeatureID
      //(0068,63F0)
      = const PTag._(
          'MatingFeatureID', 0x006863F0, 'Mating Feature ID', kUSIndex, VM.k1, false);
  ...
  static const PTag kDegreeOfFreedomID
      //(0068,6410)
      = const PTag._(
          'DegreeOfFreedomID', 0x00686410, 'Degree of Freedom ID', kUSIndex, VM.k1, false);
  static const PTag kDegreeOfFreedomType
      //(0068,6420)
      = const PTag._('DegreeOfFreedomType', 0x00686420, 'Degree of Freedom Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kTwoDMatingPoint
      //(0068,6450)
      = const PTag._(
          'TwoDMatingPoint', 0x00686450, '2D Mating Point', kFDIndex, VM.k2, false);
  static const PTag kTwoDMatingAxes
      //(0068,6460)
      =
      const PTag._('TwoDMatingAxes', 0x00686460, '2D Mating Axes', kFDIndex, VM.k4, false);
  ...
  static const PTag kRangeOfFreedom
      //(0068,64A0)
      = const PTag._(
          'RangeOfFreedom', 0x006864A0, 'Range of Freedom', kFDIndex, VM.k2, false);
  static const PTag kThreeDMatingPoint
      //(0068,64C0)
      = const PTag._(
          'ThreeDMatingPoint', 0x006864C0, '3D Mating Point', kFDIndex, VM.k3, false);
  static const PTag kThreeDMatingAxes
      //(0068,64D0)
      = const PTag._(
          'ThreeDMatingAxes', 0x006864D0, '3D Mating Axes', kFDIndex, VM.k9, false);
  ...
  static const PTag kPlanningLandmarkID
      //(0068,6530)
      = const PTag._(
          'PlanningLandmarkID', 0x00686530, 'Planning Landmark ID', kUSIndex, VM.k1, false);
  ...
  static const PTag kPlanningLandmarkIdentificationCodeSequence
      ...
      = const PTag._('PlanningLandmarkIdentificationCodeSequence', 0x00686545,
          'Planning Landmark Identification Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kTwoDPointCoordinates
      //(0068,6560)
      = const PTag._('TwoDPointCoordinates', 0x00686560, '2D Point Coordinates', kFDIndex,
          VM.k2, false);
  static const PTag kThreeDPointCoordinates
      //(0068,6590)
      = const PTag._('ThreeDPointCoordinates', 0x00686590, '3D Point Coordinates', kFDIndex,
          VM.k3, false);
  ...
  static const PTag kTwoDLineCoordinates
      //(0068,65B0)
      = const PTag._(
          'TwoDLineCoordinates', 0x006865B0, '2D Line Coordinates', kFDIndex, VM.k4, false);
  static const PTag kThreeDLineCoordinates
      //(0068,65D0)
      = const PTag._('ThreeDLineCoordinates', 0x006865D0, '3D Line Coordinates', kFDIndex,
          VM.k6, false);
  ...
  static const PTag kTwoDPlaneIntersection
      //(0068,65F0)
      = const PTag._('TwoDPlaneIntersection', 0x006865F0, '2D Plane Intersection', kFDIndex,
          VM.k4, false);
  static const PTag kThreeDPlaneOrigin
      //(0068,6610)
      = const PTag._(
          'ThreeDPlaneOrigin', 0x00686610, '3D Plane Origin', kFDIndex, VM.k3, false);
  static const PTag kThreeDPlaneNormal
      //(0068,6620)
      = const PTag._(
          'ThreeDPlaneNormal', 0x00686620, '3D Plane Normal', kFDIndex, VM.k3, false);
  ...
  static const PTag kGraphicLayer
      //(0070,0002)
      = const PTag._('GraphicLayer', 0x00700002, 'Graphic Layer', kCSIndex, VM.k1, false);
  ...
  static const PTag kUnformattedTextValue
      //(0070,0006)
      = const PTag._('UnformattedTextValue', 0x00700006, 'Unformatted Text Value', kSTIndex,
          VM.k1, false);
  static const PTag kTextObjectSequence
      //(0070,0008)
      = const PTag._(
          'TextObjectSequence', 0x00700008, 'Text Object Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kAnchorPoint
      //(0070,0014)
      = const PTag._('AnchorPoint', 0x00700014, 'Anchor Point', kFLIndex, VM.k2, false);
  ...
  static const PTag kGraphicDimensions
      //(0070,0020)
      = const PTag._(
          'GraphicDimensions', 0x00700020, 'Graphic Dimensions', kUSIndex, VM.k1, false);
  ...
  static const PTag kGraphicData
      //(0070,0022)
      = const PTag._('GraphicData', 0x00700022, 'Graphic Data', kFLIndex, VM.k2_n, false);
  static const PTag kGraphicType
      //(0070,0023)
      = const PTag._('GraphicType', 0x00700023, 'Graphic Type', kCSIndex, VM.k1, false);
  static const PTag kGraphicFilled
      //(0070,0024)
      = const PTag._('GraphicFilled', 0x00700024, 'Graphic Filled', kCSIndex, VM.k1, false);
  ...
  static const PTag kImageHorizontalFlip
      //(0070,0041)
      = const PTag._('ImageHorizontalFlip', 0x00700041, 'Image Horizontal Flip', kCSIndex,
          VM.k1, false);
  static const PTag kImageRotation
      //(0070,0042)
      = const PTag._('ImageRotation', 0x00700042, 'Image Rotation', kUSIndex, VM.k1, false);
  ...
  static const PTag kDisplayedAreaBottomRightHandCornerTrial
      ...
      = const PTag._('DisplayedAreaBottomRightHandCornerTrial', 0x00700051,
          'Displayed Area Bottom Right Hand Corner (Trial)', kUSIndex, VM.k2, true);
  ...
  static const PTag kGraphicLayerSequence
      //(0070,0060)
      = const PTag._('GraphicLayerSequence', 0x00700060, 'Graphic Layer Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kGraphicLayerOrder
      //(0070,0062)
      = const PTag._(
          'GraphicLayerOrder', 0x00700062, 'Graphic Layer Order', kISIndex, VM.k1, false);
  static const PTag kGraphicLayerRecommendedDisplayGrayscaleValue
      ...
      = const PTag._('GraphicLayerRecommendedDisplayGrayscaleValue', 0x00700066,
          'Graphic Layer Recommended Display Grayscale Value', kUSIndex, VM.k1, false);
  ...
  static const PTag kContentLabel
      //(0070,0080)
      = const PTag._('ContentLabel', 0x00700080, 'Content Label', kCSIndex, VM.k1, false);
  static const PTag kContentDescription
      //(0070,0081)
      = const PTag._(
          'ContentDescription', 0x00700081, 'Content Description', kLOIndex, VM.k1, false);
  ...
  static const PTag kContentCreatorName
      //(0070,0084)
      = const PTag._('ContentCreatorName', 0x00700084, 'Content Creator\'s Name', kPNIndex,
          VM.k1, false);
  static const PTag kContentCreatorIdentificationCodeSequence
      ...
      = const PTag._('ContentCreatorIdentificationCodeSequence', 0x00700086,
          'Content Creator\'s Identification Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kPresentationSizeMode
      //(0070,0100)
      = const PTag._('PresentationSizeMode', 0x00700100, 'Presentation Size Mode', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kGraphicGroupLabel
      //(0070,0207)
      = const PTag._(
          'GraphicGroupLabel', 0x00700207, 'Graphic Group Label', kLOIndex, VM.k1, false);
  ...
  static const PTag kFontNameType
      //(0070,0228)
      = const PTag._('FontNameType', 0x00700228, 'Font Name Type', kCSIndex, VM.k1, false);
  static const PTag kCSSFontName
      //(0070,0229)
      = const PTag._('CSSFontName', 0x00700229, 'CSS Font Name', kLOIndex, VM.k1, false);
  static const PTag kRotationAngle
      //(0070,0230)
      = const PTag._('RotationAngle', 0x00700230, 'Rotation Angle', kFDIndex, VM.k1, false);
  static const PTag kTextStyleSequence
      //(0070,0231)
      = const PTag._(
          'TextStyleSequence', 0x00700231, 'Text Style Sequence', kSQIndex, VM.k1, false);
  static const PTag kLineStyleSequence
      //(0070,0232)
      = const PTag._(
          'LineStyleSequence', 0x00700232, 'Line Style Sequence', kSQIndex, VM.k1, false);
  static const PTag kFillStyleSequence
      //(0070,0233)
      = const PTag._(
          'FillStyleSequence', 0x00700233, 'Fill Style Sequence', kSQIndex, VM.k1, false);
  static const PTag kGraphicGroupSequence
      //(0070,0234)
      = const PTag._('GraphicGroupSequence', 0x00700234, 'Graphic Group Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kHorizontalAlignment
      //(0070,0242)
      = const PTag._('HorizontalAlignment', 0x00700242, 'Horizontal Alignment', kCSIndex,
          VM.k1, false);
  static const PTag kVerticalAlignment
      //(0070,0243)
      = const PTag._(
          'VerticalAlignment', 0x00700243, 'Vertical Alignment', kCSIndex, VM.k1, false);
  static const PTag kShadowStyle
      //(0070,0244)
      = const PTag._('ShadowStyle', 0x00700244, 'Shadow Style', kCSIndex, VM.k1, false);
  static const PTag kShadowOffsetX
      //(0070,0245)
      =
      const PTag._('ShadowOffsetX', 0x00700245, 'Shadow Offset X', kFLIndex, VM.k1, false);
  static const PTag kShadowOffsetY
      //(0070,0246)
      =
      const PTag._('ShadowOffsetY', 0x00700246, 'Shadow Offset Y', kFLIndex, VM.k1, false);
  ...
  static const PTag kUnderlined
      //(0070,0248)
      = const PTag._('Underlined', 0x00700248, 'Underlined', kCSIndex, VM.k1, false);
  ...
  static const PTag kLineThickness
      //(0070,0253)
      = const PTag._('LineThickness', 0x00700253, 'Line Thickness', kFLIndex, VM.k1, false);
  static const PTag kLineDashingStyle
      //(0070,0254)
      = const PTag._(
          'LineDashingStyle', 0x00700254, 'Line Dashing Style', kCSIndex, VM.k1, false);
  static const PTag kLinePattern
      //(0070,0255)
      = const PTag._('LinePattern', 0x00700255, 'Line Pattern', kULIndex, VM.k1, false);
  static const PTag kFillPattern
      //(0070,0256)
      = const PTag._('FillPattern', 0x00700256, 'Fill Pattern', kOBIndex, VM.k1, false);
  ...
  static const PTag kShadowOpacity
      //(0070,0258)
      = const PTag._('ShadowOpacity', 0x00700258, 'Shadow Opacity', kFLIndex, VM.k1, false);
  static const PTag kGapLength
      //(0070,0261)
      = const PTag._('GapLength', 0x00700261, 'Gap Length', kFLIndex, VM.k1, false);
  static const PTag kDiameterOfVisibility
      //(0070,0262)
      = const PTag._('DiameterOfVisibility', 0x00700262, 'Diameter of Visibility', kFLIndex,
          VM.k1, false);
  static const PTag kRotationPoint
      //(0070,0273)
      = const PTag._('RotationPoint', 0x00700273, 'Rotation Point', kFLIndex, VM.k2, false);
  static const PTag kTickAlignment
      //(0070,0274)
      = const PTag._('TickAlignment', 0x00700274, 'Tick Alignment', kCSIndex, VM.k1, false);
  static const PTag kShowTickLabel
      //(0070,0278)
      =
      const PTag._('ShowTickLabel', 0x00700278, 'Show Tick Label', kCSIndex, VM.k1, false);
  static const PTag kTickLabelAlignment
      //(0070,0279)
      = const PTag._(
          'TickLabelAlignment', 0x00700279, 'Tick Label Alignment', kCSIndex, VM.k1, false);
  static const PTag kCompoundGraphicUnits
      //(0070,0282)
      = const PTag._('CompoundGraphicUnits', 0x00700282, 'Compound Graphic Units', kCSIndex,
          VM.k1, false);
  static const PTag kPatternOnOpacity
      //(0070,0284)
      = const PTag._(
          'PatternOnOpacity', 0x00700284, 'Pattern On Opacity', kFLIndex, VM.k1, false);
  static const PTag kPatternOffOpacity
      //(0070,0285)
      = const PTag._(
          'PatternOffOpacity', 0x00700285, 'Pattern Off Opacity', kFLIndex, VM.k1, false);
  static const PTag kMajorTicksSequence
      //(0070,0287)
      = const PTag._(
          'MajorTicksSequence', 0x00700287, 'Major Ticks Sequence', kSQIndex, VM.k1, false);
  static const PTag kTickPosition
      //(0070,0288)
      = const PTag._('TickPosition', 0x00700288, 'Tick Position', kFLIndex, VM.k1, false);
  static const PTag kTickLabel
      //(0070,0289)
      = const PTag._('TickLabel', 0x00700289, 'Tick Label', kSHIndex, VM.k1, false);
  static const PTag kCompoundGraphicType
      //(0070,0294)
      = const PTag._('CompoundGraphicType', 0x00700294, 'Compound Graphic Type', kCSIndex,
          VM.k1, false);
  static const PTag kGraphicGroupID
      //(0070,0295)
      = const PTag._(
          'GraphicGroupID', 0x00700295, 'Graphic Group ID', kULIndex, VM.k1, false);
  static const PTag kShapeType
      //(0070,0306)
      = const PTag._('ShapeType', 0x00700306, 'Shape Type', kCSIndex, VM.k1, false);
  static const PTag kRegistrationSequence
      //(0070,0308)
      = const PTag._('RegistrationSequence', 0x00700308, 'Registration Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kMatrixSequence
      //(0070,030A)
      =
      const PTag._('MatrixSequence', 0x0070030A, 'Matrix Sequence', kSQIndex, VM.k1, false);
  static const PTag kFrameOfReferenceTransformationMatrixType
      ...
      = const PTag._('FrameOfReferenceTransformationMatrixType', 0x0070030C,
          'Frame of Reference Transformation Matrix Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kFiducialDescription
      //(0070,030F)
      = const PTag._('FiducialDescription', 0x0070030F, 'Fiducial Description', kSTIndex,
          VM.k1, false);
  static const PTag kFiducialIdentifier
      //(0070,0310)
      = const PTag._(
          'FiducialIdentifier', 0x00700310, 'Fiducial Identifier', kSHIndex, VM.k1, false);
  ...
  static const PTag kFiducialUID
      //(0070,031A)
      = const PTag._('FiducialUID', 0x0070031A, 'Fiducial UID', kUIIndex, VM.k1, false);
  static const PTag kFiducialSetSequence
      //(0070,031C)
      = const PTag._('FiducialSetSequence', 0x0070031C, 'Fiducial Set Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kFiducialSequence
      //(0070,031E)
      = const PTag._(
          'FiducialSequence', 0x0070031E, 'Fiducial Sequence', kSQIndex, VM.k1, false);
  static const PTag kGraphicLayerRecommendedDisplayCIELabValue
      ...
      = const PTag._('GraphicLayerRecommendedDisplayCIELabValue', 0x00700401,
          'Graphic Layer Recommended Display CIELab Value', kUSIndex, VM.k3, false);
  static const PTag kBlendingSequence
      //(0070,0402)
      = const PTag._(
          'BlendingSequence', 0x00700402, 'Blending Sequence', kSQIndex, VM.k1, false);
  static const PTag kRelativeOpacity
      //(0070,0403)
      = const PTag._(
          'RelativeOpacity', 0x00700403, 'Relative Opacity', kFLIndex, VM.k1, false);
  ...
  static const PTag kBlendingPosition
      //(0070,0405)
      = const PTag._(
          'BlendingPosition', 0x00700405, 'Blending Position', kCSIndex, VM.k1, false);
  static const PTag kHangingProtocolName
      //(0072,0002)
      = const PTag._('HangingProtocolName', 0x00720002, 'Hanging Protocol Name', kSHIndex,
          VM.k1, false);
  ...
  static const PTag kHangingProtocolLevel
      //(0072,0006)
      = const PTag._('HangingProtocolLevel', 0x00720006, 'Hanging Protocol Level', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kHangingProtocolUserIdentificationCodeSequence
      ...
      = const PTag._('HangingProtocolUserIdentificationCodeSequence', 0x0072000E,
          'Hanging Protocol User Identification Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kImageSetsSequence
      //(0072,0020)
      = const PTag._(
          'ImageSetsSequence', 0x00720020, 'Image Sets Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSelectorAttribute
      //(0072,0026)
      = const PTag._(
          'SelectorAttribute', 0x00720026, 'Selector Attribute', kATIndex, VM.k1, false);
  static const PTag kSelectorValueNumber
      //(0072,0028)
      = const PTag._('SelectorValueNumber', 0x00720028, 'Selector Value Number', kUSIndex,
          VM.k1, false);
  ...
  static const PTag kImageSetNumber
      //(0072,0032)
      = const PTag._(
          'ImageSetNumber', 0x00720032, 'Image Set Number', kUSIndex, VM.k1, false);
  ...
  static const PTag kRelativeTime
      //(0072,0038)
      = const PTag._('RelativeTime', 0x00720038, 'Relative Time', kUSIndex, VM.k2, false);
  static const PTag kRelativeTimeUnits
      //(0072,003A)
      = const PTag._(
          'RelativeTimeUnits', 0x0072003A, 'Relative Time Units', kCSIndex, VM.k1, false);
  static const PTag kAbstractPriorValue
      //(0072,003C)
      = const PTag._(
          'AbstractPriorValue', 0x0072003C, 'Abstract Prior Value', kSSIndex, VM.k2, false);
  ...
  static const PTag kImageSetLabel
      //(0072,0040)
      =
      const PTag._('ImageSetLabel', 0x00720040, 'Image Set Label', kLOIndex, VM.k1, false);
  static const PTag kSelectorAttributeVR
      //(0072,0050)
      = const PTag._('SelectorAttributeVR', 0x00720050, 'Selector Attribute VR', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kSelectorSequencePointerPrivateCreator
      ...
      = const PTag._('SelectorSequencePointerPrivateCreator', 0x00720054,
          'Selector Sequence Pointer Private Creator', kLOIndex, VM.k1_n, false);
  ...
  static const PTag kSelectorAEValue
      //(0072,005E)
      = const PTag._(
          'SelectorAEValue', 0x0072005E, 'Selector AE Value', kAEIndex, VM.k1_n, false);
  static const PTag kSelectorASValue
      //(0072,005F)
      = const PTag._(
          'SelectorASValue', 0x0072005F, 'Selector AS Value', kASIndex, VM.k1_n, false);
  static const PTag kSelectorATValue
      //(0072,0060)
      = const PTag._(
          'SelectorATValue', 0x00720060, 'Selector AT Value', kATIndex, VM.k1_n, false);
  static const PTag kSelectorDAValue
      //(0072,0061)
      = const PTag._(
          'SelectorDAValue', 0x00720061, 'Selector DA Value', kDAIndex, VM.k1_n, false);
  static const PTag kSelectorCSValue
      //(0072,0062)
      = const PTag._(
          'SelectorCSValue', 0x00720062, 'Selector CS Value', kCSIndex, VM.k1_n, false);
  static const PTag kSelectorDTValue
      //(0072,0063)
      = const PTag._(
          'SelectorDTValue', 0x00720063, 'Selector DT Value', kDTIndex, VM.k1_n, false);
  static const PTag kSelectorISValue
      //(0072,0064)
      = const PTag._(
          'SelectorISValue', 0x00720064, 'Selector IS Value', kISIndex, VM.k1_n, false);
  static const PTag kSelectorOBValue
      //(0072,0065)
      = const PTag._(
          'SelectorOBValue', 0x00720065, 'Selector OB Value', kOBIndex, VM.k1_n, false);
  static const PTag kSelectorLOValue
      //(0072,0066)
      = const PTag._(
          'SelectorLOValue', 0x00720066, 'Selector LO Value', kLOIndex, VM.k1_n, false);
  static const PTag kSelectorOFValue
      //(0072,0067)
      = const PTag._(
          'SelectorOFValue', 0x00720067, 'Selector OF Value', kOFIndex, VM.k1_n, false);
  static const PTag kSelectorLTValue
      //(0072,0068)
      = const PTag._(
          'SelectorLTValue', 0x00720068, 'Selector LT Value', kLTIndex, VM.k1, false);
  static const PTag kSelectorOWValue
      //(0072,0069)
      = const PTag._(
          'SelectorOWValue', 0x00720069, 'Selector OW Value', kOWIndex, VM.k1_n, false);
  static const PTag kSelectorPNValue
      //(0072,006A)
      = const PTag._(
          'SelectorPNValue', 0x0072006A, 'Selector PN Value', kPNIndex, VM.k1_n, false);
  static const PTag kSelectorTMValue
      //(0072,006B)
      = const PTag._(
          'SelectorTMValue', 0x00720069, 'Selector TM Value', kTMIndex, VM.k1_n, false);
  static const PTag kSelectorSHValue
      //(0072,006C)
      = const PTag._(
          'SelectorSHValue', 0x0072006C, 'Selector SH Value', kSHIndex, VM.k1_n, false);
  static const PTag kSelectorUNValue
      //(0072,006D)
      = const PTag._(
          'SelectorUNValue', 0x0072006D, 'Selector UN Value', kUNIndex, VM.k1_n, false);
  static const PTag kSelectorSTValue
      //(0072,006E)
      = const PTag._(
          'SelectorSTValue', 0x0072006E, 'Selector ST Value', kSTIndex, VM.k1, false);
  static const PTag kSelectorUCValue
      //(0072,006F)
      = const PTag._(
          'SelectorUCValue', 0x0072006F, 'Selector UC Value', kUCIndex, VM.k1_n, false);
  static const PTag kSelectorUTValue
      //(0072,0070)
      = const PTag._(
          'SelectorUTValue', 0x00720070, 'Selector UT Value', kUTIndex, VM.k1, false);
  static const PTag kSelectorURValue
      //(0072,0071)
      = const PTag._(
          'SelectorURValue', 0x00720071, 'Selector UR Value', kURIndex, VM.k1_n, false);
  static const PTag kSelectorDSValue
      //(0072,0072)
      = const PTag._(
          'SelectorDSValue', 0x00720072, 'Selector DS Value', kDSIndex, VM.k1_n, false);
  static const PTag kSelectorODValue
      //(0072,0073)
      = const PTag._(
          'SelectorODValue', 0x00720073, 'Selector OD Value', kODIndex, VM.k1, false);
  static const PTag kSelectorFDValue
      //(0072,0074)
      = const PTag._(
          'SelectorFDValue', 0x00720074, 'Selector FD Value', kFDIndex, VM.k1_n, false);
  static const PTag kSelectorOLValue
      //(0072,0075)
      = const PTag._(
          'SelectorOLValue', 0x00720075, 'Selector OL Value', kOLIndex, VM.k1_n, false);
  static const PTag kSelectorFLValue
      //(0072,0076)
      = const PTag._(
          'SelectorFLValue', 0x00720076, 'Selector FL Value', kFLIndex, VM.k1_n, false);
  static const PTag kSelectorULValue
      //(0072,0078)
      = const PTag._(
          'SelectorULValue', 0x00720078, 'Selector UL Value', kULIndex, VM.k1_n, false);
  static const PTag kSelectorUSValue
      //(0072,007A)
      = const PTag._(
          'SelectorUSValue', 0x0072007A, 'Selector US Value', kUSIndex, VM.k1_n, false);
  static const PTag kSelectorSLValue
      //(0072,007C)
      = const PTag._(
          'SelectorSLValue', 0x0072007C, 'Selector SL Value', kSLIndex, VM.k1_n, false);
  static const PTag kSelectorSSValue
      //(0072,007E)
      = const PTag._(
          'SelectorSSValue', 0x0072007E, 'Selector SS Value', kSSIndex, VM.k1_n, false);
  static const PTag kSelectorUIValue
      //(0072,007F)
      = const PTag._(
          'SelectorUIValue', 0x0072007F, 'Selector UI Value', kUIIndex, VM.k1_n, false);
  ...
  static const PTag kNumberOfScreens
      //(0072,0100)
      = const PTag._(
          'NumberOfScreens', 0x00720100, 'Number of Screens', kUSIndex, VM.k1, false);
  ...
  static const PTag kDisplaySetsSequence
      //(0072,0200)
      = const PTag._('DisplaySetsSequence', 0x00720200, 'Display Sets Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kDisplaySetNumber
      //(0072,0202)
      = const PTag._(
          'DisplaySetNumber', 0x00720202, 'Display Set Number', kUSIndex, VM.k1, false);
  static const PTag kDisplaySetLabel
      //(0072,0203)
      = const PTag._(
          'DisplaySetLabel', 0x00720203, 'Display Set Label', kLOIndex, VM.k1, false);
  ...
  static const PTag kNavigationDisplaySet
      //(0072,0216)
      = const PTag._('NavigationDisplaySet', 0x00720216, 'Navigation Display Set', kUSIndex,
          VM.k1, false);
  static const PTag kReferenceDisplaySets
      //(0072,0218)
      = const PTag._('ReferenceDisplaySets', 0x00720218, 'Reference Display Sets', kUSIndex,
          VM.k1_n, false);
  static const PTag kImageBoxesSequence
      //(0072,0300)
      = const PTag._(
          'ImageBoxesSequence', 0x00720300, 'Image Boxes Sequence', kSQIndex, VM.k1, false);
  static const PTag kImageBoxNumber
      //(0072,0302)
      = const PTag._(
          'ImageBoxNumber', 0x00720302, 'Image Box Number', kUSIndex, VM.k1, false);
  static const PTag kImageBoxLayoutType
      //(0072,0304)
      = const PTag._('ImageBoxLayoutType', 0x00720304, 'Image Box Layout Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kFilterByCategory
      //(0072,0402)
      = const PTag._(
          'FilterByCategory', 0x00720402, 'Filter-by Category', kCSIndex, VM.k1, false);
  ...
  static const PTag kFilterByOperator
      //(0072,0406)
      = const PTag._(
          'FilterByOperator', 0x00720406, 'Filter-by Operator', kCSIndex, VM.k1, false);
  ...
  static const PTag kReformattingInterval
      //(0072,0514)
      = const PTag._('ReformattingInterval', 0x00720514, 'Reformatting Interval', kFDIndex,
          VM.k1, false);
  static const PTag kReformattingOperationInitialViewDirection
      ...
      = const PTag._('ReformattingOperationInitialViewDirection', 0x00720516,
          'Reformatting Operation Initial View Direction', kCSIndex, VM.k1, false);
  static const PTag kThreeDRenderingType
      //(0072,0520)
      = const PTag._(
          'ThreeDRenderingType', 0x00720520, '3D Rendering Type', kCSIndex, VM.k1_n, false);
  ...
  static const PTag kSortByCategory
      //(0072,0602)
      = const PTag._(
          'SortByCategory', 0x00720602, 'Sort-by Category', kCSIndex, VM.k1, false);
  static const PTag kSortingDirection
      //(0072,0604)
      = const PTag._(
          'SortingDirection', 0x00720604, 'Sorting Direction', kCSIndex, VM.k1, false);
  ...
  static const PTag kPseudoColorType
      //(0072,0704)
      = const PTag._(
          'PseudoColorType', 0x00720704, 'Pseudo-Color Type', kCSIndex, VM.k1, false);
  static const PTag kPseudoColorPaletteInstanceReferenceSequence
      ...
      = const PTag._('PseudoColorPaletteInstanceReferenceSequence', 0x00720705,
          'Pseudo-Color Palette Instance Reference Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kProcedureStepState
      //(0074,1000)
      = const PTag._(
          'ProcedureStepState', 0x00741000, 'Procedure Step State', kCSIndex, VM.k1, false);
  static const PTag kProcedureStepProgressInformationSequence
      ...
      = const PTag._('ProcedureStepProgressInformationSequence', 0x00741002,
          'Procedure Step Progress Information Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kContactURI
      //(0074,100a)
      = const PTag._('ContactURI', 0x0074100a, 'Contact URI', kURIndex, VM.k1, false);
  static const PTag kContactDisplayName
      //(0074,100c)
      = const PTag._(
          'ContactDisplayName', 0x0074100c, 'Contact Display Name', kLOIndex, VM.k1, false);
  static const PTag kProcedureStepDiscontinuationReasonCodeSequence
      ...
      = const PTag._('ProcedureStepDiscontinuationReasonCodeSequence', 0x0074100e,
          'Procedure Step Discontinuation Reason Code Sequence', kSQIndex, VM.k1, false);
  static const PTag kBeamTaskSequence
      //(0074,1020)
      = const PTag._(
          'BeamTaskSequence', 0x00741020, 'Beam Task Sequence', kSQIndex, VM.k1, false);
  static const PTag kBeamTaskType
      //(0074,1022)
      = const PTag._('BeamTaskType', 0x00741022, 'Beam Task Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kAutosequenceFlag
      //(0074,1025)
      = const PTag._(
          'AutosequenceFlag', 0x00741025, 'Autosequence Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kDoubleExposureFlag
      //(0074,1034)
      = const PTag._(
          'DoubleExposureFlag', 0x00741034, 'Double Exposure Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kConventionalControlPointVerificationSequence
      ...
      = const PTag._('ConventionalControlPointVerificationSequence', 0x0074104C,
          'Conventional Control Point Verification Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kWorklistLabel
      //(0074,1202)
      = const PTag._('WorklistLabel', 0x00741202, 'Worklist Label', kLOIndex, VM.k1, false);
  static const PTag kProcedureStepLabel
      //(0074,1204)
      = const PTag._(
          'ProcedureStepLabel', 0x00741204, 'Procedure Step Label', kLOIndex, VM.k1, false);
  ...
  static const PTag kUnifiedProcedureStepPerformedProcedureSequence
      ...
      = const PTag._('UnifiedProcedureStepPerformedProcedureSequence', 0x00741216,
          'Unified Procedure Step Performed Procedure Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kDeletionLock
      //(0074,1230)
      = const PTag._('DeletionLock', 0x00741230, 'Deletion Lock', kLOIndex, VM.k1, false);
  static const PTag kReceivingAE
      //(0074,1234)
      = const PTag._('ReceivingAE', 0x00741234, 'Receiving AE', kAEIndex, VM.k1, false);
  static const PTag kRequestingAE
      //(0074,1236)
      = const PTag._('RequestingAE', 0x00741236, 'Requesting AE', kAEIndex, VM.k1, false);
  ...
  static const PTag kSCPStatus
      //(0074,1242)
      = const PTag._('SCPStatus', 0x00741242, 'SCP Status', kCSIndex, VM.k1, false);
  ...
  static const PTag kBeamOrderIndex
      //(0074,1324)
      = const PTag._(
          'BeamOrderIndex', 0x00741324, 'Beam Order Index', kULIndex, VM.k1, false);
  ...
  static const PTag kReplacedImplantAssemblyTemplateSequence
      ...
      = const PTag._('ReplacedImplantAssemblyTemplateSequence', 0x00760008,
          'Replaced Implant Assembly Template Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kOriginalImplantAssemblyTemplateSequence
      ...
      = const PTag._('OriginalImplantAssemblyTemplateSequence', 0x0076000C,
          'Original Implant Assembly Template Sequence', kSQIndex, VM.k1, false);
  static const PTag kDerivationImplantAssemblyTemplateSequence
      ...
      = const PTag._('DerivationImplantAssemblyTemplateSequence', 0x0076000E,
          'Derivation Implant Assembly Template Sequence', kSQIndex, VM.k1, false);
  static const PTag kImplantAssemblyTemplateTargetAnatomySequence
      ...
      = const PTag._('ImplantAssemblyTemplateTargetAnatomySequence', 0x00760010,
          'Implant Assembly Template Target Anatomy Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSurgicalTechnique
      //(0076,0030)
      = const PTag._(
          'SurgicalTechnique', 0x00760030, 'Surgical Technique', kLOIndex, VM.k1, false);
  ...
  static const PTag kComponentSequence
      //(0076,0040)
      = const PTag._(
          'ComponentSequence', 0x00760040, 'Component Sequence', kSQIndex, VM.k1, false);
  static const PTag kComponentID
      //(0076,0055)
      = const PTag._('ComponentID', 0x00760055, 'Component ID', kUSIndex, VM.k1, false);
  ...
  static const PTag kComponent1ReferencedMatingFeatureSetID
      ...
      = const PTag._('Component1ReferencedMatingFeatureSetID', 0x00760080,
          'Component 1 Referenced Mating Feature Set ID', kUSIndex, VM.k1, false);
  ...
  static const PTag kComponent2ReferencedMatingFeatureSetID
      ...
      = const PTag._('Component2ReferencedMatingFeatureSetID', 0x007600B0,
          'Component 2 Referenced Mating Feature Set ID', kUSIndex, VM.k1, false);
  ...
  static const PTag kImplantTemplateGroupTargetAnatomySequence
      ...
      = const PTag._('ImplantTemplateGroupTargetAnatomySequence', 0x00780028,
          'Implant Template Group Target Anatomy Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kThreeDImplantTemplateGroupMemberMatchingPoint
      ...
      = const PTag._('ThreeDImplantTemplateGroupMemberMatchingPoint', 0x00780050,
          '3D Implant Template Group Member Matching Point', kFDIndex, VM.k3, false);
  static const PTag kThreeDImplantTemplateGroupMemberMatchingAxes
      ...
      = const PTag._('ThreeDImplantTemplateGroupMemberMatchingAxes', 0x00780060,
          '3D Implant Template Group Member Matching Axes', kFDIndex, VM.k9, false);
  ...
  static const PTag kTwoDImplantTemplateGroupMemberMatchingPoint
      ...
      = const PTag._('TwoDImplantTemplateGroupMemberMatchingPoint', 0x00780090,
          '2D Implant Template Group Member Matching Point', kFDIndex, VM.k2, false);
  static const PTag kTwoDImplantTemplateGroupMemberMatchingAxes
      ...
      = const PTag._('TwoDImplantTemplateGroupMemberMatchingAxes', 0x007800A0,
          '2D Implant Template Group Member Matching Axes', kFDIndex, VM.k4, false);
  static const PTag kImplantTemplateGroupVariationDimensionSequence
      ...
      = const PTag._('ImplantTemplateGroupVariationDimensionSequence', 0x007800B0,
          'Implant Template Group Variation Dimension Sequence', kSQIndex, VM.k1, false);
  static const PTag kImplantTemplateGroupVariationDimensionName
      ...
      = const PTag._('ImplantTemplateGroupVariationDimensionName', 0x007800B2,
          'Implant Template Group Variation Dimension Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kReferencedImplantTemplateGroupMemberID
      ...
      = const PTag._('ReferencedImplantTemplateGroupMemberID', 0x007800B6,
          'Referenced Implant Template Group Member ID', kUSIndex, VM.k1, false);
  static const PTag kImplantTemplateGroupVariationDimensionRank
      ...
      = const PTag._('ImplantTemplateGroupVariationDimensionRank', 0x007800B8,
          'Implant Template Group Variation Dimension Rank', kUSIndex, VM.k1, false);
  static const PTag kSurfaceScanAcquisitionTypeCodeSequence
      //(0080,0001)
      = const PTag._('SurfaceScanAcquisitionTypeCodeSequence', 0x00800001,
          'Surface Scan Acquisition Type Code Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kShotDurationTime
      //(0080,0004)
      = const PTag._(
          'ShotDurationTime', 0x00800004, 'Shot Duration Time', kFDIndex, VM.k1, false);
  static const PTag kShotOffsetTime
      //(0080,0005)
      = const PTag._(
          'ShotOffsetTime', 0x00800005, 'Shot Offset Time', kFDIndex, VM.k1, false);
  ...
  static const PTag kUVMappingSequence
      //(0080,0008)
      = const PTag._(
          'UVMappingSequence', 0x00800008, 'UV Mapping Sequence', kSQIndex, VM.k1, false);
  static const PTag kTextureLabel
      //(0080,0009)
      = const PTag._('TextureLabel', 0x00800009, 'Texture Label', kSHIndex, VM.k1, false);
  static const PTag kUValueData
      //(0080,0010)
      = const PTag._('UValueData', 0x00800010, 'U Value Data', kOFIndex, VM.k1_n, false);
  static const PTag kVValueData
      //(0080,0011)
      = const PTag._('VValueData', 0x00800011, 'V Value Data', kOFIndex, VM.k1_n, false);
  ...
  static const PTag kIconImageSequence
      //(0088,0200)
      = const PTag._(
          'IconImageSequence', 0x00880200, 'Icon Image Sequence', kSQIndex, VM.k1, false);
  static const PTag kTopicTitle
      //(0088,0904)
      = const PTag._('TopicTitle', 0x00880904, 'Topic Title', kLOIndex, VM.k1, true);
  static const PTag kTopicSubject
      //(0088,0906)
      = const PTag._('TopicSubject', 0x00880906, 'Topic Subject', kSTIndex, VM.k1, true);
  static const PTag kTopicAuthor
      //(0088,0910)
      = const PTag._('TopicAuthor', 0x00880910, 'Topic Author', kLOIndex, VM.k1, true);
  static const PTag kTopicKeywords
      //(0088,0912)
      =
      const PTag._('TopicKeywords', 0x00880912, 'Topic Keywords', kLOIndex, VM.k1_32, true);
  static const PTag kSOPInstanceStatus
      //(0100,0410)
      = const PTag._(
          'SOPInstanceStatus', 0x01000410, 'SOP Instance Status', kCSIndex, VM.k1, false);
  ...
  static const PTag kAuthorizationEquipmentCertificationNumber
      ...
      = const PTag._('AuthorizationEquipmentCertificationNumber', 0x01000426,
          'Authorization Equipment Certification Number', kLOIndex, VM.k1, false);
  static const PTag kMACIDNumber
      //(0400,0005)
      = const PTag._('MACIDNumber', 0x04000005, 'MAC ID Number', kUSIndex, VM.k1, false);
  ...
  static const PTag kMACAlgorithm
      //(0400,0015)
      = const PTag._('MACAlgorithm', 0x04000015, 'MAC Algorithm', kCSIndex, VM.k1, false);
  static const PTag kDataElementsSigned
      //(0400,0020)
      = const PTag._('DataElementsSigned', 0x04000020, 'Data Elements Signed', kATIndex,
          VM.k1_n, false);
  static const PTag kDigitalSignatureUID
      //(0400,0100)
      = const PTag._('DigitalSignatureUID', 0x04000100, 'Digital Signature UID', kUIIndex,
          VM.k1, false);
  ...
  static const PTag kCertificateType
      //(0400,0110)
      = const PTag._(
          'CertificateType', 0x04000110, 'Certificate Type', kCSIndex, VM.k1, false);
  static const PTag kCertificateOfSigner
      //(0400,0115)
      = const PTag._('CertificateOfSigner', 0x04000115, 'Certificate of Signer', kOBIndex,
          VM.k1, false);
  static const PTag kSignature
      //(0400,0120)
      = const PTag._('Signature', 0x04000120, 'Signature', kOBIndex, VM.k1, false);
  ...
  static const PTag kCertifiedTimestamp
      //(0400,0310)
      = const PTag._(
          'CertifiedTimestamp', 0x04000310, 'Certified Timestamp', kOBIndex, VM.k1, false);
  ...
  static const PTag kEncryptedContent
      //(0400,0520)
      = const PTag._(
          'EncryptedContent', 0x04000520, 'Encrypted Content', kOBIndex, VM.k1, false);
  ...
  static const PTag kModifyingSystem
      //(0400,0563)
      = const PTag._(
          'ModifyingSystem', 0x04000563, 'Modifying System', kLOIndex, VM.k1, false);
  ...
  static const PTag kEscapeTriplet
      //(1000,0000)
      = const PTag._('EscapeTriplet', 0x10000000, 'Escape Triplet', kUSIndex, VM.k3, true);
  static const PTag kRunLengthTriplet
      //(1000,0001)
      = const PTag._(
          'RunLengthTriplet', 0x10000001, 'Run Length Triplet', kUSIndex, VM.k3, true);
  static const PTag kHuffmanTableSize
      //(1000,0002)
      = const PTag._(
          'HuffmanTableSize', 0x10000002, 'Huffman Table Size', kUSIndex, VM.k1, true);
  static const PTag kHuffmanTableTriplet
      //(1000,0003)
      = const PTag._('HuffmanTableTriplet', 0x10000003, 'Huffman Table Triplet', kUSIndex,
          VM.k3, true);
  static const PTag kShiftTableSize
      //(1000,0004)
      =
      const PTag._('ShiftTableSize', 0x10000004, 'Shift Table Size', kUSIndex, VM.k1, true);
  static const PTag kShiftTableTriplet
      //(1000,0005)
      = const PTag._(
          'ShiftTableTriplet', 0x10000005, 'Shift Table Triplet', kUSIndex, VM.k3, true);
  static const PTag kZonalMap
      //(1010,0000)
      = const PTag._('ZonalMap', 0x10100000, 'Zonal Map', kUSIndex, VM.k1_n, true);
  static const PTag kNumberOfCopies
      //(2000,0010)
      = const PTag._(
          'NumberOfCopies', 0x20000010, 'Number of Copies', kISIndex, VM.k1, false);
  ...
  static const PTag kPrintPriority
      //(2000,0020)
      = const PTag._('PrintPriority', 0x20000020, 'Print Priority', kCSIndex, VM.k1, false);
  static const PTag kMediumType
      //(2000,0030)
      = const PTag._('MediumType', 0x20000030, 'Medium Type', kCSIndex, VM.k1, false);
  static const PTag kFilmDestination
      //(2000,0040)
      = const PTag._(
          'FilmDestination', 0x20000040, 'Film Destination', kCSIndex, VM.k1, false);
  static const PTag kFilmSessionLabel
      //(2000,0050)
      = const PTag._(
          'FilmSessionLabel', 0x20000050, 'Film Session Label', kLOIndex, VM.k1, false);
  static const PTag kMemoryAllocation
      //(2000,0060)
      = const PTag._(
          'MemoryAllocation', 0x20000060, 'Memory Allocation', kISIndex, VM.k1, false);
  ...
  static const PTag kCollationFlag
      //(2000,0063)
      = const PTag._('CollationFlag', 0x20000063, 'Collation Flag', kCSIndex, VM.k1, true);
  static const PTag kAnnotationFlag
      //(2000,0065)
      =
      const PTag._('AnnotationFlag', 0x20000065, 'Annotation Flag', kCSIndex, VM.k1, true);
  static const PTag kImageOverlayFlag
      //(2000,0067)
      = const PTag._(
          'ImageOverlayFlag', 0x20000067, 'Image Overlay Flag', kCSIndex, VM.k1, true);
  static const PTag kPresentationLUTFlag
      //(2000,0069)
      = const PTag._('PresentationLUTFlag', 0x20000069, 'Presentation LUT Flag', kCSIndex,
          VM.k1, true);
  ...
  static const PTag kMemoryBitDepth
      //(2000,00A0)
      = const PTag._(
          'MemoryBitDepth', 0x200000A0, 'Memory Bit Depth', kUSIndex, VM.k1, false);
  static const PTag kPrintingBitDepth
      //(2000,00A1)
      = const PTag._(
          'PrintingBitDepth', 0x200000A1, 'Printing Bit Depth', kUSIndex, VM.k1, false);
  ...
  static const PTag kImageDisplayFormat
      //(2010,0010)
      = const PTag._(
          'ImageDisplayFormat', 0x20100010, 'Image Display Format', kSTIndex, VM.k1, false);
  ...
  static const PTag kFilmOrientation
      //(2010,0040)
      = const PTag._(
          'FilmOrientation', 0x20100040, 'Film Orientation', kCSIndex, VM.k1, false);
  static const PTag kFilmSizeID
      //(2010,0050)
      = const PTag._('FilmSizeID', 0x20100050, 'Film Size ID', kCSIndex, VM.k1, false);
  static const PTag kPrinterResolutionID
      //(2010,0052)
      = const PTag._('PrinterResolutionID', 0x20100052, 'Printer Resolution ID', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kMagnificationType
      //(2010,0060)
      = const PTag._(
          'MagnificationType', 0x20100060, 'Magnification Type', kCSIndex, VM.k1, false);
  static const PTag kSmoothingType
      //(2010,0080)
      = const PTag._('SmoothingType', 0x20100080, 'Smoothing Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kDefaultSmoothingType
      //(2010,00A8)
      = const PTag._('DefaultSmoothingType', 0x201000A8, 'Default Smoothing Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kBorderDensity
      //(2010,0100)
      = const PTag._('BorderDensity', 0x20100100, 'Border Density', kCSIndex, VM.k1, false);
  static const PTag kEmptyImageDensity
      //(2010,0110)
      = const PTag._(
          'EmptyImageDensity', 0x20100110, 'Empty Image Density', kCSIndex, VM.k1, false);
  static const PTag kMinDensity
      //(2010,0120)
      = const PTag._('MinDensity', 0x20100120, 'Min Density', kUSIndex, VM.k1, false);
  static const PTag kMaxDensity
      //(2010,0130)
      = const PTag._('MaxDensity', 0x20100130, 'Max Density', kUSIndex, VM.k1, false);
  ...
  static const PTag kMaximumCollatedFilms
      //(2010,0154)
      = const PTag._('MaximumCollatedFilms', 0x20100154, 'Maximum Collated Films', kISIndex,
          VM.k1, false);
  static const PTag kIllumination
      //(2010,015E)
      = const PTag._('Illumination', 0x2010015E, 'Illumination', kUSIndex, VM.k1, false);
  ...
  static const PTag kPrinterPixelSpacing
      //(2010,0376)
      = const PTag._('PrinterPixelSpacing', 0x20100376, 'Printer Pixel Spacing', kDSIndex,
          VM.k2, false);
  ...
  static const PTag kImageBoxPosition
      //(2020,0010)
      = const PTag._(
          'ImageBoxPosition', 0x20200010, 'Image Box Position', kUSIndex, VM.k1, false);
  ...
  static const PTag kRequestedImageSize
      //(2020,0030)
      = const PTag._(
          'RequestedImageSize', 0x20200030, 'Requested Image Size', kDSIndex, VM.k1, false);
  ...
  static const PTag kDecimateCropResult
      //(2020,00A2)
      = const PTag._(
          'DecimateCropResult', 0x202000A2, 'Decimate/Crop Result', kCSIndex, VM.k1, false);
  ...
  static const PTag kAnnotationPosition
      //(2030,0010)
      = const PTag._(
          'AnnotationPosition', 0x20300010, 'Annotation Position', kUSIndex, VM.k1, false);
  static const PTag kTextString
      //(2030,0020)
      = const PTag._('TextString', 0x20300020, 'Text String', kLOIndex, VM.k1, false);
  ...
  static const PTag kOverlaySmoothingType
      //(2040,0070)
      = const PTag._('OverlaySmoothingType', 0x20400070, 'Overlay Smoothing Type', kCSIndex,
          VM.k1, true);
  ...
  static const PTag kOverlayMode
      //(2040,0090)
      = const PTag._('OverlayMode', 0x20400090, 'Overlay Mode', kCSIndex, VM.k1, true);
  static const PTag kThresholdDensity
      //(2040,0100)
      = const PTag._(
          'ThresholdDensity', 0x20400100, 'Threshold Density', kCSIndex, VM.k1, true);
  ...
  static const PTag kPresentationLUTShape
      //(2050,0020)
      = const PTag._('PresentationLUTShape', 0x20500020, 'Presentation LUT Shape', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kPrintJobID
      //(2100,0010)
      = const PTag._('PrintJobID', 0x21000010, 'Print Job ID', kSHIndex, VM.k1, true);
  static const PTag kExecutionStatus
      //(2100,0020)
      = const PTag._(
          'ExecutionStatus', 0x21000020, 'Execution Status', kCSIndex, VM.k1, false);
  static const PTag kExecutionStatusInfo
      //(2100,0030)
      = const PTag._('ExecutionStatusInfo', 0x21000030, 'Execution Status Info', kCSIndex,
          VM.k1, false);
  static const PTag kCreationDate
      //(2100,0040)
      = const PTag._('CreationDate', 0x21000040, 'Creation Date', kDAIndex, VM.k1, false);
  static const PTag kCreationTime
      //(2100,0050)
      = const PTag._('CreationTime', 0x21000050, 'Creation Time', kTMIndex, VM.k1, false);
  static const PTag kOriginator
      //(2100,0070)
      = const PTag._('Originator', 0x21000070, 'Originator', kAEIndex, VM.k1, false);
  static const PTag kDestinationAE
      //(2100,0140)
      = const PTag._('DestinationAE', 0x21000140, 'Destination AE', kAEIndex, VM.k1, true);
  ...
  static const PTag kNumberOfFilms
      //(2100,0170)
      =
      const PTag._('NumberOfFilms', 0x21000170, 'Number of Films', kISIndex, VM.k1, false);
  static const PTag kReferencedPrintJobSequencePullStoredPrint
      ...
      = const PTag._('ReferencedPrintJobSequencePullStoredPrint', 0x21000500,
          'Referenced Print Job Sequence (Pull Stored Print)', kSQIndex, VM.k1, true);
  static const PTag kPrinterStatus
      //(2110,0010)
      = const PTag._('PrinterStatus', 0x21100010, 'Printer Status', kCSIndex, VM.k1, false);
  static const PTag kPrinterStatusInfo
      //(2110,0020)
      = const PTag._(
          'PrinterStatusInfo', 0x21100020, 'Printer Status Info', kCSIndex, VM.k1, false);
  static const PTag kPrinterName
      //(2110,0030)
      = const PTag._('PrinterName', 0x21100030, 'Printer Name', kLOIndex, VM.k1, false);
  static const PTag kPrintQueueID
      //(2110,0099)
      = const PTag._('PrintQueueID', 0x21100099, 'Print Queue ID', kSHIndex, VM.k1, true);
  static const PTag kQueueStatus
      //(2120,0010)
      = const PTag._('QueueStatus', 0x21200010, 'Queue Status', kCSIndex, VM.k1, true);
  ...
  static const PTag kLabelUsingInformationExtractedFromInstances
      ...
      = const PTag._('LabelUsingInformationExtractedFromInstances', 0x22000001,
          'Label Using Information Extracted From Instances', kCSIndex, VM.k1, false);
  static const PTag kLabelText
      //(2200,0002)
      = const PTag._('LabelText', 0x22000002, 'Label Text', kUTIndex, VM.k1, false);
  static const PTag kLabelStyleSelection
      //(2200,0003)
      = const PTag._('LabelStyleSelection', 0x22000003, 'Label Style Selection', kCSIndex,
          VM.k1, false);
  static const PTag kMediaDisposition
      //(2200,0004)
      = const PTag._(
          'MediaDisposition', 0x22000004, 'Media Disposition', kLTIndex, VM.k1, false);
  static const PTag kBarcodeValue
      //(2200,0005)
      = const PTag._('BarcodeValue', 0x22000005, 'Barcode Value', kLTIndex, VM.k1, false);
  static const PTag kBarcodeSymbology
      //(2200,0006)
      = const PTag._(
          'BarcodeSymbology', 0x22000006, 'Barcode Symbology', kCSIndex, VM.k1, false);
  static const PTag kAllowMediaSplitting
      //(2200,0007)
      = const PTag._('AllowMediaSplitting', 0x22000007, 'Allow Media Splitting', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kPreserveCompositeInstancesAfterMediaCreation
      ...
      = const PTag._('PreserveCompositeInstancesAfterMediaCreation', 0x2200000A,
          'Preserve Composite Instances After Media Creation', kCSIndex, VM.k1, false);
  ...
  static const PTag kFailureAttributes
      //(2200,000E)
      = const PTag._(
          'FailureAttributes', 0x2200000E, 'Failure Attributes', kATIndex, VM.k1_n, false);
  ...
  static const PTag kRequestPriority
      //(2200,0020)
      = const PTag._(
          'RequestPriority', 0x22000020, 'Request Priority', kCSIndex, VM.k1, false);
  static const PTag kRTImageLabel
      //(3002,0002)
      = const PTag._('RTImageLabel', 0x30020002, 'RT Image Label', kSHIndex, VM.k1, false);
  static const PTag kRTImageName
      //(3002,0003)
      = const PTag._('RTImageName', 0x30020003, 'RT Image Name', kLOIndex, VM.k1, false);
  static const PTag kRTImageDescription
      //(3002,0004)
      = const PTag._(
          'RTImageDescription', 0x30020004, 'RT Image Description', kSTIndex, VM.k1, false);
  static const PTag kReportedValuesOrigin
      //(3002,000A)
      = const PTag._('ReportedValuesOrigin', 0x3002000A, 'Reported Values Origin', kCSIndex,
          VM.k1, false);
  static const PTag kRTImagePlane
      //(3002,000C)
      = const PTag._('RTImagePlane', 0x3002000C, 'RT Image Plane', kCSIndex, VM.k1, false);
  ...
  static const PTag kRTImageOrientation
      //(3002,0010)
      = const PTag._(
          'RTImageOrientation', 0x30020010, 'RT Image Orientation', kDSIndex, VM.k6, false);
  ...
  static const PTag kRTImagePosition
      //(3002,0012)
      = const PTag._(
          'RTImagePosition', 0x30020012, 'RT Image Position', kDSIndex, VM.k2, false);
  static const PTag kRadiationMachineName
      //(3002,0020)
      = const PTag._('RadiationMachineName', 0x30020020, 'Radiation Machine Name', kSHIndex,
          VM.k1, false);
  static const PTag kRadiationMachineSAD
      //(3002,0022)
      = const PTag._('RadiationMachineSAD', 0x30020022, 'Radiation Machine SAD', kDSIndex,
          VM.k1, false);
  static const PTag kRadiationMachineSSD
      //(3002,0024)
      = const PTag._('RadiationMachineSSD', 0x30020024, 'Radiation Machine SSD', kDSIndex,
          VM.k1, false);
  static const PTag kRTImageSID
      //(3002,0026)
      = const PTag._('RTImageSID', 0x30020026, 'RT Image SID', kDSIndex, VM.k1, false);
  ...
  static const PTag kFractionNumber
      //(3002,0029)
      =
      const PTag._('FractionNumber', 0x30020029, 'Fraction Number', kISIndex, VM.k1, false);
  static const PTag kExposureSequence
      //(3002,0030)
      = const PTag._(
          'ExposureSequence', 0x30020030, 'Exposure Sequence', kSQIndex, VM.k1, false);
  static const PTag kMetersetExposure
      //(3002,0032)
      = const PTag._(
          'MetersetExposure', 0x30020032, 'Meterset Exposure', kDSIndex, VM.k1, false);
  static const PTag kDiaphragmPosition
      //(3002,0034)
      = const PTag._(
          'DiaphragmPosition', 0x30020034, 'Diaphragm Position', kDSIndex, VM.k4, false);
  static const PTag kFluenceMapSequence
      //(3002,0040)
      = const PTag._(
          'FluenceMapSequence', 0x30020040, 'Fluence Map Sequence', kSQIndex, VM.k1, false);
  static const PTag kFluenceDataSource
      //(3002,0041)
      = const PTag._(
          'FluenceDataSource', 0x30020041, 'Fluence Data Source', kCSIndex, VM.k1, false);
  static const PTag kFluenceDataScale
      //(3002,0042)
      = const PTag._(
          'FluenceDataScale', 0x30020042, 'Fluence Data Scale', kDSIndex, VM.k1, false);
  ...
  static const PTag kFluenceMode
      //(3002,0051)
      = const PTag._('FluenceMode', 0x30020051, 'Fluence Mode', kCSIndex, VM.k1, false);
  static const PTag kFluenceModeID
      //(3002,0052)
      =
      const PTag._('FluenceModeID', 0x30020052, 'Fluence Mode ID', kSHIndex, VM.k1, false);
  static const PTag kDVHType
      //(3004,0001)
      = const PTag._('DVHType', 0x30040001, 'DVH Type', kCSIndex, VM.k1, false);
  static const PTag kDoseUnits
      //(3004,0002)
      = const PTag._('DoseUnits', 0x30040002, 'Dose Units', kCSIndex, VM.k1, false);
  ...
  static const PTag kDoseComment
      //(3004,0006)
      = const PTag._('DoseComment', 0x30040006, 'Dose Comment', kLOIndex, VM.k1, false);
  static const PTag kNormalizationPoint
      //(3004,0008)
      = const PTag._(
          'NormalizationPoint', 0x30040008, 'Normalization Point', kDSIndex, VM.k3, false);
  static const PTag kDoseSummationType
      //(3004,000A)
      = const PTag._(
          'DoseSummationType', 0x3004000A, 'Dose Summation Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kDoseGridScaling
      //(3004,000E)
      = const PTag._(
          'DoseGridScaling', 0x3004000E, 'Dose Grid Scaling', kDSIndex, VM.k1, false);
  static const PTag kRTDoseROISequence
      //(3004,0010)
      = const PTag._(
          'RTDoseROISequence', 0x30040010, 'RT Dose ROI Sequence', kSQIndex, VM.k1, false);
  static const PTag kDoseValue
      //(3004,0012)
      = const PTag._('DoseValue', 0x30040012, 'Dose Value', kDSIndex, VM.k1, false);
  ...
  static const PTag kDVHSequence
      //(3004,0050)
      = const PTag._('DVHSequence', 0x30040050, 'DVH Sequence', kSQIndex, VM.k1, false);
  static const PTag kDVHDoseScaling
      //(3004,0052)
      = const PTag._(
          'DVHDoseScaling', 0x30040052, 'DVH Dose Scaling', kDSIndex, VM.k1, false);
  static const PTag kDVHVolumeUnits
      //(3004,0054)
      = const PTag._(
          'DVHVolumeUnits', 0x30040054, 'DVH Volume Units', kCSIndex, VM.k1, false);
  static const PTag kDVHNumberOfBins
      //(3004,0056)
      = const PTag._(
          'DVHNumberOfBins', 0x30040056, 'DVH Number of Bins', kISIndex, VM.k1, false);
  static const PTag kDVHData
      //(3004,0058)
      = const PTag._('DVHData', 0x30040058, 'DVH Data', kDSIndex, VM.k2_2n, false);
  ...
  static const PTag kDVHMinimumDose
      //(3004,0070)
      = const PTag._(
          'DVHMinimumDose', 0x30040070, 'DVH Minimum Dose', kDSIndex, VM.k1, false);
  static const PTag kDVHMaximumDose
      //(3004,0072)
      = const PTag._(
          'DVHMaximumDose', 0x30040072, 'DVH Maximum Dose', kDSIndex, VM.k1, false);
  static const PTag kDVHMeanDose
      //(3004,0074)
      = const PTag._('DVHMeanDose', 0x30040074, 'DVH Mean Dose', kDSIndex, VM.k1, false);
  static const PTag kStructureSetLabel
      //(3006,0002)
      = const PTag._(
          'StructureSetLabel', 0x30060002, 'Structure Set Label', kSHIndex, VM.k1, false);
  static const PTag kStructureSetName
      //(3006,0004)
      = const PTag._(
          'StructureSetName', 0x30060004, 'Structure Set Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kStructureSetDate
      //(3006,0008)
      = const PTag._(
          'StructureSetDate', 0x30060008, 'Structure Set Date', kDAIndex, VM.k1, false);
  static const PTag kStructureSetTime
      //(3006,0009)
      = const PTag._(
          'StructureSetTime', 0x30060009, 'Structure Set Time', kTMIndex, VM.k1, false);
  ...
  static const PTag kContourImageSequence
      //(3006,0016)
      = const PTag._('ContourImageSequence', 0x30060016, 'Contour Image Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kROINumber
      //(3006,0022)
      = const PTag._('ROINumber', 0x30060022, 'ROI Number', kISIndex, VM.k1, false);
  ...
  static const PTag kROIDescription
      //(3006,0028)
      =
      const PTag._('ROIDescription', 0x30060028, 'ROI Description', kSTIndex, VM.k1, false);
  static const PTag kROIDisplayColor
      //(3006,002A)
      = const PTag._(
          'ROIDisplayColor', 0x3006002A, 'ROI Display Color', kISIndex, VM.k3, false);
  static const PTag kROIVolume
      //(3006,002C)
      = const PTag._('ROIVolume', 0x3006002C, 'ROI Volume', kDSIndex, VM.k1, false);
  ...
  static const PTag kRTROIRelationship
      //(3006,0033)
      = const PTag._(
          'RTROIRelationship', 0x30060033, 'RT ROI Relationship', kCSIndex, VM.k1, false);
  ...
  static const PTag kROIContourSequence
      //(3006,0039)
      = const PTag._(
          'ROIContourSequence', 0x30060039, 'ROI Contour Sequence', kSQIndex, VM.k1, false);
  static const PTag kContourSequence
      //(3006,0040)
      = const PTag._(
          'ContourSequence', 0x30060040, 'Contour Sequence', kSQIndex, VM.k1, false);
  static const PTag kContourGeometricType
      //(3006,0042)
      = const PTag._('ContourGeometricType', 0x30060042, 'Contour Geometric Type', kCSIndex,
          VM.k1, false);
  static const PTag kContourSlabThickness
      //(3006,0044)
      = const PTag._('ContourSlabThickness', 0x30060044, 'Contour Slab Thickness', kDSIndex,
          VM.k1, false);
  static const PTag kContourOffsetVector
      //(3006,0045)
      = const PTag._('ContourOffsetVector', 0x30060045, 'Contour Offset Vector', kDSIndex,
          VM.k3, false);
  ...
  static const PTag kContourNumber
      //(3006,0048)
      = const PTag._('ContourNumber', 0x30060048, 'Contour Number', kISIndex, VM.k1, false);
  static const PTag kAttachedContours
      //(3006,0049)
      = const PTag._(
          'AttachedContours', 0x30060049, 'Attached Contours', kISIndex, VM.k1_n, false);
  static const PTag kContourData
      //(3006,0050)
      = const PTag._('ContourData', 0x30060050, 'Contour Data', kDSIndex, VM.k3_3n, false);
  ...
  static const PTag kObservationNumber
      //(3006,0082)
      = const PTag._(
          'ObservationNumber', 0x30060082, 'Observation Number', kISIndex, VM.k1, false);
  static const PTag kReferencedROINumber
      //(3006,0084)
      = const PTag._('ReferencedROINumber', 0x30060084, 'Referenced ROI Number', kISIndex,
          VM.k1, false);
  static const PTag kROIObservationLabel
      //(3006,0085)
      = const PTag._('ROIObservationLabel', 0x30060085, 'ROI Observation Label', kSHIndex,
          VM.k1, false);
  ...
  static const PTag kROIInterpreter
      //(3006,00A6)
      =
      const PTag._('ROIInterpreter', 0x300600A6, 'ROI Interpreter', kPNIndex, VM.k1, false);
  ...
  static const PTag kROIPhysicalProperty
      //(3006,00B2)
      = const PTag._('ROIPhysicalProperty', 0x300600B2, 'ROI Physical Property', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kROIElementalCompositionAtomicMassFraction
      ...
      = const PTag._('ROIElementalCompositionAtomicMassFraction', 0x300600B8,
          'ROI Elemental Composition Atomic Mass Fraction', kFLIndex, VM.k1, false);
  ...
  static const PTag kMeasuredDoseType
      //(3008,0014)
      = const PTag._(
          'MeasuredDoseType', 0x30080014, 'Measured Dose Type', kCSIndex, VM.k1, false);
  static const PTag kMeasuredDoseValue
      //(3008,0016)
      = const PTag._(
          'MeasuredDoseValue', 0x30080016, 'Measured Dose Value', kDSIndex, VM.k1, false);
  ...
  static const PTag kSpecifiedMeterset
      //(3008,0042)
      = const PTag._(
          'SpecifiedMeterset', 0x30080042, 'Specified Meterset', kDSIndex, VM.k1, false);
  static const PTag kDeliveredMeterset
      //(3008,0044)
      = const PTag._(
          'DeliveredMeterset', 0x30080044, 'Delivered Meterset', kDSIndex, VM.k1, false);
  static const PTag kMetersetRateSet
      //(3008,0045)
      = const PTag._(
          'MetersetRateSet', 0x30080045, 'Meterset Rate Set', kFLIndex, VM.k1, false);
  ...
  static const PTag kDoseRateDelivered
      //(3008,0048)
      = const PTag._(
          'DoseRateDelivered', 0x30080048, 'Dose Rate Delivered', kDSIndex, VM.k1, false);
  static const PTag kTreatmentSummaryCalculatedDoseReferenceSequence
      ...
      = const PTag._('TreatmentSummaryCalculatedDoseReferenceSequence', 0x30080050,
          'Treatment Summary Calculated Dose Reference Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kFirstTreatmentDate
      //(3008,0054)
      = const PTag._(
          'FirstTreatmentDate', 0x30080054, 'First Treatment Date', kDAIndex, VM.k1, false);
  ...
  static const PTag kOverrideSequence
      //(3008,0060)
      = const PTag._(
          'OverrideSequence', 0x30080060, 'Override Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kParameterItemIndex
      //(3008,0063)
      = const PTag._(
          'ParameterItemIndex', 0x30080063, 'Parameter Item Index', kISIndex, VM.k1, false);
  ...
  static const PTag kParameterPointer
      //(3008,0065)
      = const PTag._(
          'ParameterPointer', 0x30080065, 'Parameter Pointer', kATIndex, VM.k1, false);
  static const PTag kOverrideReason
      //(3008,0066)
      =
      const PTag._('OverrideReason', 0x30080066, 'Override Reason', kSTIndex, VM.k1, false);
  ...
  static const PTag kCorrectionValue
      //(3008,006A)
      = const PTag._(
          'CorrectionValue', 0x3008006A, 'Correction Value', kFLIndex, VM.k1, false);
  ...
  static const PTag kStartMeterset
      //(3008,0078)
      = const PTag._('StartMeterset', 0x30080078, 'Start Meterset', kDSIndex, VM.k1, false);
  static const PTag kEndMeterset
      //(3008,007A)
      = const PTag._('EndMeterset', 0x3008007A, 'End Meterset', kDSIndex, VM.k1, false);
  static const PTag kReferencedMeasuredDoseReferenceSequence
      ...
      = const PTag._('ReferencedMeasuredDoseReferenceSequence', 0x30080080,
          'Referenced Measured Dose Reference Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kReferencedCalculatedDoseReferenceSequence
      ...
      = const PTag._('ReferencedCalculatedDoseReferenceSequence', 0x30080090,
          'Referenced Calculated Dose Reference Sequence', kSQIndex, VM.k1, false);
  static const PTag kReferencedCalculatedDoseReferenceNumber
      ...
      = const PTag._('ReferencedCalculatedDoseReferenceNumber', 0x30080092,
          'Referenced Calculated Dose Reference Number', kISIndex, VM.k1, false);
  ...
  static const PTag kTreatmentSummaryMeasuredDoseReferenceSequence
      ...
      = const PTag._('TreatmentSummaryMeasuredDoseReferenceSequence', 0x300800E0,
          'Treatment Summary Measured Dose Reference Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSourceSerialNumber
      //(3008,0105)
      = const PTag._(
          'SourceSerialNumber', 0x30080105, 'Source Serial Number', kLOIndex, VM.k1, false);
  static const PTag kTreatmentSessionApplicationSetupSequence
      ...
      = const PTag._('TreatmentSessionApplicationSetupSequence', 0x30080110,
          'Treatment Session Application Setup Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kFractionGroupType
      //(3008,0224)
      = const PTag._(
          'FractionGroupType', 0x30080224, 'Fraction Group Type', kCSIndex, VM.k1, false);
  static const PTag kBeamStopperPosition
      //(3008,0230)
      = const PTag._('BeamStopperPosition', 0x30080230, 'Beam Stopper Position', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kTreatmentDate
      //(3008,0250)
      = const PTag._('TreatmentDate', 0x30080250, 'Treatment Date', kDAIndex, VM.k1, false);
  static const PTag kTreatmentTime
      //(3008,0251)
      = const PTag._('TreatmentTime', 0x30080251, 'Treatment Time', kTMIndex, VM.k1, false);
  static const PTag kRTPlanLabel
      //(300A,0002)
      = const PTag._('RTPlanLabel', 0x300A0002, 'RT Plan Label', kSHIndex, VM.k1, false);
  static const PTag kRTPlanName
      //(300A,0003)
      = const PTag._('RTPlanName', 0x300A0003, 'RT Plan Name', kLOIndex, VM.k1, false);
  static const PTag kRTPlanDescription
      //(300A,0004)
      = const PTag._(
          'RTPlanDescription', 0x300A0004, 'RT Plan Description', kSTIndex, VM.k1, false);
  static const PTag kRTPlanDate
      //(300A,0006)
      = const PTag._('RTPlanDate', 0x300A0006, 'RT Plan Date', kDAIndex, VM.k1, false);
  static const PTag kRTPlanTime
      //(300A,0007)
      = const PTag._('RTPlanTime', 0x300A0007, 'RT Plan Time', kTMIndex, VM.k1, false);
  static const PTag kTreatmentProtocols
      //(300A,0009)
      = const PTag._('TreatmentProtocols', 0x300A0009, 'Treatment Protocols', kLOIndex,
          VM.k1_n, false);
  static const PTag kPlanIntent
      //(300A,000A)
      = const PTag._('PlanIntent', 0x300A000A, 'Plan Intent', kCSIndex, VM.k1, false);
  static const PTag kTreatmentSites
      //(300A,000B)
      = const PTag._(
          'TreatmentSites', 0x300A000B, 'Treatment Sites', kLOIndex, VM.k1_n, false);
  static const PTag kRTPlanGeometry
      //(300A,000C)
      = const PTag._(
          'RTPlanGeometry', 0x300A000C, 'RT Plan Geometry', kCSIndex, VM.k1, false);
  ...
  static const PTag kDoseReferenceNumber
      //(300A,0012)
      = const PTag._('DoseReferenceNumber', 0x300A0012, 'Dose Reference Number', kISIndex,
          VM.k1, false);
  static const PTag kDoseReferenceUID
      //(300A,0013)
      = const PTag._(
          'DoseReferenceUID', 0x300A0013, 'Dose Reference UID', kUIIndex, VM.k1, false);
  ...
  static const PTag kNominalPriorDose
      //(300A,001A)
      = const PTag._(
          'NominalPriorDose', 0x300A001A, 'Nominal Prior Dose', kDSIndex, VM.k1, false);
  static const PTag kDoseReferenceType
      //(300A,0020)
      = const PTag._(
          'DoseReferenceType', 0x300A0020, 'Dose Reference Type', kCSIndex, VM.k1, false);
  static const PTag kConstraintWeight
      //(300A,0021)
      = const PTag._(
          'ConstraintWeight', 0x300A0021, 'Constraint Weight', kDSIndex, VM.k1, false);
  static const PTag kDeliveryWarningDose
      //(300A,0022)
      = const PTag._('DeliveryWarningDose', 0x300A0022, 'Delivery Warning Dose', kDSIndex,
          VM.k1, false);
  static const PTag kDeliveryMaximumDose
      //(300A,0023)
      = const PTag._('DeliveryMaximumDose', 0x300A0023, 'Delivery Maximum Dose', kDSIndex,
          VM.k1, false);
  static const PTag kTargetMinimumDose
      //(300A,0025)
      = const PTag._(
          'TargetMinimumDose', 0x300A0025, 'Target Minimum Dose', kDSIndex, VM.k1, false);
  ...
  static const PTag kTargetMaximumDose
      //(300A,0027)
      = const PTag._(
          'TargetMaximumDose', 0x300A0027, 'Target Maximum Dose', kDSIndex, VM.k1, false);
  ...
  static const PTag kToleranceTableNumber
      //(300A,0042)
      = const PTag._('ToleranceTableNumber', 0x300A0042, 'Tolerance Table Number', kISIndex,
          VM.k1, false);
  static const PTag kToleranceTableLabel
      //(300A,0043)
      = const PTag._('ToleranceTableLabel', 0x300A0043, 'Tolerance Table Label', kSHIndex,
          VM.k1, false);
  static const PTag kGantryAngleTolerance
      //(300A,0044)
      = const PTag._('GantryAngleTolerance', 0x300A0044, 'Gantry Angle Tolerance', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kRTPlanRelationship
      //(300A,0055)
      = const PTag._(
          'RTPlanRelationship', 0x300A0055, 'RT Plan Relationship', kCSIndex, VM.k1, false);
  ...
  static const PTag kFractionGroupNumber
      //(300A,0071)
      = const PTag._('FractionGroupNumber', 0x300A0071, 'Fraction Group Number', kISIndex,
          VM.k1, false);
  ...
  static const PTag kFractionPattern
      //(300A,007B)
      = const PTag._(
          'FractionPattern', 0x300A007B, 'Fraction Pattern', kLTIndex, VM.k1, false);
  static const PTag kNumberOfBeams
      //(300A,0080)
      =
      const PTag._('NumberOfBeams', 0x300A0080, 'Number of Beams', kISIndex, VM.k1, false);
  ...
  static const PTag kBeamMeterset
      //(300A,0086)
      = const PTag._('BeamMeterset', 0x300A0086, 'Beam Meterset', kDSIndex, VM.k1, false);
  static const PTag kBeamDosePointDepth
      //(300A,0088)
      = const PTag._(
          'BeamDosePointDepth', 0x300A0088, 'Beam Dose Point Depth', kFLIndex, VM.k1, true);
  ...
  static const PTag kBeamDosePointSSD
      //(300A,008A)
      = const PTag._(
          'BeamDosePointSSD', 0x300A008A, 'Beam Dose Point SSD', kFLIndex, VM.k1, true);
  static const PTag kBeamDoseMeaning
      //(300A,008B)
      = const PTag._(
          'BeamDoseMeaning', 0x300A008B, 'Beam Dose Meaning', kCSIndex, VM.k1, false);
  static const PTag kBeamDoseVerificationControlPointSequence
      ...
      = const PTag._('BeamDoseVerificationControlPointSequence', 0x300A008C,
          'Beam Dose Verification Control Point Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kBrachyApplicationSetupDoseSpecificationPoint
      ...
      = const PTag._('BrachyApplicationSetupDoseSpecificationPoint', 0x300A00A2,
          'Brachy Application Setup Dose Specification Point', kDSIndex, VM.k3, false);
  ...
  static const PTag kBeamSequence
      //(300A,00B0)
      = const PTag._('BeamSequence', 0x300A00B0, 'Beam Sequence', kSQIndex, VM.k1, false);
  static const PTag kTreatmentMachineName
      //(300A,00B2)
      = const PTag._('TreatmentMachineName', 0x300A00B2, 'Treatment Machine Name', kSHIndex,
          VM.k1, false);
  static const PTag kPrimaryDosimeterUnit
      //(300A,00B3)
      = const PTag._('PrimaryDosimeterUnit', 0x300A00B3, 'Primary Dosimeter Unit', kCSIndex,
          VM.k1, false);
  static const PTag kSourceAxisDistance
      //(300A,00B4)
      = const PTag._(
          'SourceAxisDistance', 0x300A00B4, 'Source-Axis Distance', kDSIndex, VM.k1, false);
  ...
  static const PTag kBeamNumber
      //(300A,00C0)
      = const PTag._('BeamNumber', 0x300A00C0, 'Beam Number', kISIndex, VM.k1, false);
  ...
  static const PTag kBeamDescription
      //(300A,00C3)
      = const PTag._(
          'BeamDescription', 0x300A00C3, 'Beam Description', kSTIndex, VM.k1, false);
  ...
  static const PTag kRadiationType
      //(300A,00C6)
      = const PTag._('RadiationType', 0x300A00C6, 'Radiation Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kReferenceImageNumber
      //(300A,00C8)
      = const PTag._('ReferenceImageNumber', 0x300A00C8, 'Reference Image Number', kISIndex,
          VM.k1, false);
  ...
  static const PTag kImagingDeviceSpecificAcquisitionParameters
      ...
      = const PTag._('ImagingDeviceSpecificAcquisitionParameters', 0x300A00CC,
          'Imaging Device-Specific Acquisition Parameters', kLOIndex, VM.k1_n, false);
  ...
  static const PTag kNumberOfWedges
      //(300A,00D0)
      = const PTag._(
          'NumberOfWedges', 0x300A00D0, 'Number of Wedges', kISIndex, VM.k1, false);
  static const PTag kWedgeSequence
      //(300A,00D1)
      = const PTag._('WedgeSequence', 0x300A00D1, 'Wedge Sequence', kSQIndex, VM.k1, false);
  static const PTag kWedgeNumber
      //(300A,00D2)
      = const PTag._('WedgeNumber', 0x300A00D2, 'Wedge Number', kISIndex, VM.k1, false);
  static const PTag kWedgeType
      //(300A,00D3)
      = const PTag._('WedgeType', 0x300A00D3, 'Wedge Type', kCSIndex, VM.k1, false);
  static const PTag kWedgeID
      //(300A,00D4)
      = const PTag._('WedgeID', 0x300A00D4, 'Wedge ID', kSHIndex, VM.k1, false);
  static const PTag kWedgeAngle
      //(300A,00D5)
      = const PTag._('WedgeAngle', 0x300A00D5, 'Wedge Angle', kISIndex, VM.k1, false);
  static const PTag kWedgeFactor
      //(300A,00D6)
      = const PTag._('WedgeFactor', 0x300A00D6, 'Wedge Factor', kDSIndex, VM.k1, false);
  static const PTag kTotalWedgeTrayWaterEquivalentThickness
      //(300A,00D7)
      = const PTag._('TotalWedgeTrayWaterEquivalentThickness', 0x300A00D7,
          'Total Wedge Tray Water-Equivalent Thickness', kFLIndex, VM.k1, false);
  static const PTag kWedgeOrientation
      //(300A,00D8)
      = const PTag._(
          'WedgeOrientation', 0x300A00D8, 'Wedge Orientation', kDSIndex, VM.k1, false);
  ...
  static const PTag kBolusDescription
      //(300A,00DD)
      = const PTag._(
          'BolusDescription', 0x300A00DD, 'Bolus Description', kSTIndex, VM.k1, false);
  static const PTag kNumberOfCompensators
      //(300A,00E0)
      = const PTag._('NumberOfCompensators', 0x300A00E0, 'Number of Compensators', kISIndex,
          VM.k1, false);
  static const PTag kMaterialID
      //(300A,00E1)
      = const PTag._('MaterialID', 0x300A00E1, 'Material ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kCompensatorSequence
      //(300A,00E3)
      = const PTag._('CompensatorSequence', 0x300A00E3, 'Compensator Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kCompensatorNumber
      //(300A,00E4)
      = const PTag._(
          'CompensatorNumber', 0x300A00E4, 'Compensator Number', kISIndex, VM.k1, false);
  static const PTag kCompensatorID
      //(300A,00E5)
      = const PTag._('CompensatorID', 0x300A00E5, 'Compensator ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kCompensatorRows
      //(300A,00E7)
      = const PTag._(
          'CompensatorRows', 0x300A00E7, 'Compensator Rows', kISIndex, VM.k1, false);
  static const PTag kCompensatorColumns
      //(300A,00E8)
      = const PTag._(
          'CompensatorColumns', 0x300A00E8, 'Compensator Columns', kISIndex, VM.k1, false);
  ...
  static const PTag kCompensatorPosition
      //(300A,00EA)
      = const PTag._('CompensatorPosition', 0x300A00EA, 'Compensator Position', kDSIndex,
          VM.k2, false);
  ...
  static const PTag kNumberOfBoli
      //(300A,00ED)
      = const PTag._('NumberOfBoli', 0x300A00ED, 'Number of Boli', kISIndex, VM.k1, false);
  static const PTag kCompensatorType
      //(300A,00EE)
      = const PTag._(
          'CompensatorType', 0x300A00EE, 'Compensator Type', kCSIndex, VM.k1, false);
  static const PTag kCompensatorTrayID
      //(300A,00EF)
      = const PTag._(
          'CompensatorTrayID', 0x300A00EF, 'Compensator Tray ID', kSHIndex, VM.k1, false);
  static const PTag kNumberOfBlocks
      //(300A,00F0)
      = const PTag._(
          'NumberOfBlocks', 0x300A00F0, 'Number of Blocks', kISIndex, VM.k1, false);
  ...
  static const PTag kTotalBlockTrayWaterEquivalentThickness
      ...
      = const PTag._('TotalBlockTrayWaterEquivalentThickness', 0x300A00F3,
          'Total Block Tray Water-Equivalent Thickness', kFLIndex, VM.k1, false);
  static const PTag kBlockSequence
      //(300A,00F4)
      = const PTag._('BlockSequence', 0x300A00F4, 'Block Sequence', kSQIndex, VM.k1, false);
  static const PTag kBlockTrayID
      //(300A,00F5)
      = const PTag._('BlockTrayID', 0x300A00F5, 'Block Tray ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kBlockType
      //(300A,00F8)
      = const PTag._('BlockType', 0x300A00F8, 'Block Type', kCSIndex, VM.k1, false);
  static const PTag kAccessoryCode
      //(300A,00F9)
      = const PTag._('AccessoryCode', 0x300A00F9, 'Accessory Code', kLOIndex, VM.k1, false);
  static const PTag kBlockDivergence
      //(300A,00FA)
      = const PTag._(
          'BlockDivergence', 0x300A00FA, 'Block Divergence', kCSIndex, VM.k1, false);
  ...
  static const PTag kBlockNumber
      //(300A,00FC)
      = const PTag._('BlockNumber', 0x300A00FC, 'Block Number', kISIndex, VM.k1, false);
  static const PTag kBlockName
      //(300A,00FE)
      = const PTag._('BlockName', 0x300A00FE, 'Block Name', kLOIndex, VM.k1, false);
  static const PTag kBlockThickness
      //(300A,0100)
      =
      const PTag._('BlockThickness', 0x300A0100, 'Block Thickness', kDSIndex, VM.k1, false);
  static const PTag kBlockTransmission
      //(300A,0102)
      = const PTag._(
          'BlockTransmission', 0x300A0102, 'Block Transmission', kDSIndex, VM.k1, false);
  static const PTag kBlockNumberOfPoints
      //(300A,0104)
      = const PTag._('BlockNumberOfPoints', 0x300A0104, 'Block Number of Points', kISIndex,
          VM.k1, false);
  static const PTag kBlockData
      //(300A,0106)
      = const PTag._('BlockData', 0x300A0106, 'Block Data', kDSIndex, VM.k2_2n, false);
  static const PTag kApplicatorSequence
      //(300A,0107)
      = const PTag._(
          'ApplicatorSequence', 0x300A0107, 'Applicator Sequence', kSQIndex, VM.k1, false);
  static const PTag kApplicatorID
      //(300A,0108)
      = const PTag._('ApplicatorID', 0x300A0108, 'Applicator ID', kSHIndex, VM.k1, false);
  static const PTag kApplicatorType
      //(300A,0109)
      =
      const PTag._('ApplicatorType', 0x300A0109, 'Applicator Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kControlPointSequence
      //(300A,0111)
      = const PTag._('ControlPointSequence', 0x300A0111, 'Control Point Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kControlPointIndex
      //(300A,0112)
      = const PTag._(
          'ControlPointIndex', 0x300A0112, 'Control Point Index', kISIndex, VM.k1, false);
  static const PTag kNominalBeamEnergy
      //(300A,0114)
      = const PTag._(
          'NominalBeamEnergy', 0x300A0114, 'Nominal Beam Energy', kDSIndex, VM.k1, false);
  static const PTag kDoseRateSet
      //(300A,0115)
      = const PTag._('DoseRateSet', 0x300A0115, 'Dose Rate Set', kDSIndex, VM.k1, false);
  ...
  static const PTag kWedgePosition
      //(300A,0118)
      = const PTag._('WedgePosition', 0x300A0118, 'Wedge Position', kCSIndex, VM.k1, false);
  ...
  static const PTag kLeafJawPositions
      //(300A,011C)
      = const PTag._(
          'LeafJawPositions', 0x300A011C, 'Leaf/Jaw Positions', kDSIndex, VM.k2_2n, false);
  static const PTag kGantryAngle
      //(300A,011E)
      = const PTag._('GantryAngle', 0x300A011E, 'Gantry Angle', kDSIndex, VM.k1, false);
  ...
  static const PTag kPatientSupportAngle
      //(300A,0122)
      = const PTag._('PatientSupportAngle', 0x300A0122, 'Patient Support Angle', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kIsocenterPosition
      //(300A,012C)
      = const PTag._(
          'IsocenterPosition', 0x300A012C, 'Isocenter Position', kDSIndex, VM.k3, false);
  static const PTag kSurfaceEntryPoint
      //(300A,012E)
      = const PTag._(
          'SurfaceEntryPoint', 0x300A012E, 'Surface Entry Point', kDSIndex, VM.k3, false);
  ...
  static const PTag kTableTopPitchAngle
      //(300A,0140)
      = const PTag._('TableTopPitchAngle', 0x300A0140, 'Table Top Pitch Angle', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kTableTopRollAngle
      //(300A,0144)
      = const PTag._(
          'TableTopRollAngle', 0x300A0144, 'Table Top Roll Angle', kFLIndex, VM.k1, false);
  ...
  static const PTag kHeadFixationAngle
      //(300A,0148)
      = const PTag._(
          'HeadFixationAngle', 0x300A0148, 'Head Fixation Angle', kFLIndex, VM.k1, false);
  static const PTag kGantryPitchAngle
      //(300A,014A)
      = const PTag._(
          'GantryPitchAngle', 0x300A014A, 'Gantry Pitch Angle', kFLIndex, VM.k1, false);
  ...
  static const PTag kPatientSetupSequence
      //(300A,0180)
      = const PTag._('PatientSetupSequence', 0x300A0180, 'Patient Setup Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kPatientSetupNumber
      //(300A,0182)
      = const PTag._(
          'PatientSetupNumber', 0x300A0182, 'Patient Setup Number', kISIndex, VM.k1, false);
  static const PTag kPatientSetupLabel
      //(300A,0183)
      = const PTag._(
          'PatientSetupLabel', 0x300A0183, 'Patient Setup Label', kLOIndex, VM.k1, false);
  ...
  static const PTag kFixationDeviceType
      //(300A,0192)
      = const PTag._(
          'FixationDeviceType', 0x300A0192, 'Fixation Device Type', kCSIndex, VM.k1, false);
  static const PTag kFixationDeviceLabel
      //(300A,0194)
      = const PTag._('FixationDeviceLabel', 0x300A0194, 'Fixation Device Label', kSHIndex,
          VM.k1, false);
  ...
  static const PTag kShieldingDeviceType
      //(300A,01A2)
      = const PTag._('ShieldingDeviceType', 0x300A01A2, 'Shielding Device Type', kCSIndex,
          VM.k1, false);
  static const PTag kShieldingDeviceLabel
      //(300A,01A4)
      = const PTag._('ShieldingDeviceLabel', 0x300A01A4, 'Shielding Device Label', kSHIndex,
          VM.k1, false);
  ...
  static const PTag kSetupTechnique
      //(300A,01B0)
      =
      const PTag._('SetupTechnique', 0x300A01B0, 'Setup Technique', kCSIndex, VM.k1, false);
  ...
  static const PTag kSetupDeviceSequence
      //(300A,01B4)
      = const PTag._('SetupDeviceSequence', 0x300A01B4, 'Setup Device Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kSetupDeviceType
      //(300A,01B6)
      = const PTag._(
          'SetupDeviceType', 0x300A01B6, 'Setup Device Type', kCSIndex, VM.k1, false);
  static const PTag kSetupDeviceLabel
      //(300A,01B8)
      = const PTag._(
          'SetupDeviceLabel', 0x300A01B8, 'Setup Device Label', kSHIndex, VM.k1, false);
  ...
  static const PTag kSetupDeviceParameter
      //(300A,01BC)
      = const PTag._('SetupDeviceParameter', 0x300A01BC, 'Setup Device Parameter', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kBrachyTreatmentType
      //(300A,0202)
      = const PTag._('BrachyTreatmentType', 0x300A0202, 'Brachy Treatment Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kSourceSequence
      //(300A,0210)
      =
      const PTag._('SourceSequence', 0x300A0210, 'Source Sequence', kSQIndex, VM.k1, false);
  static const PTag kSourceNumber
      //(300A,0212)
      = const PTag._('SourceNumber', 0x300A0212, 'Source Number', kISIndex, VM.k1, false);
  static const PTag kSourceType
      //(300A,0214)
      = const PTag._('SourceType', 0x300A0214, 'Source Type', kCSIndex, VM.k1, false);
  static const PTag kSourceManufacturer
      //(300A,0216)
      = const PTag._(
          'SourceManufacturer', 0x300A0216, 'Source Manufacturer', kLOIndex, VM.k1, false);
  static const PTag kActiveSourceDiameter
      //(300A,0218)
      = const PTag._('ActiveSourceDiameter', 0x300A0218, 'Active Source Diameter', kDSIndex,
          VM.k1, false);
  static const PTag kActiveSourceLength
      //(300A,021A)
      = const PTag._(
          'ActiveSourceLength', 0x300A021A, 'Active Source Length', kDSIndex, VM.k1, false);
  static const PTag kSourceModelID
      //(300A,021B)
      =
      const PTag._('SourceModelID', 0x300A021B, 'Source Model ID', kSHIndex, VM.k1, false);
  static const PTag kSourceDescription
      //(300A,021C)
      = const PTag._(
          'SourceDescription', 0x300A021C, 'Source Description', kLOIndex, VM.k1, false);
  ...
  static const PTag kSourceIsotopeName
      //(300A,0226)
      = const PTag._(
          'SourceIsotopeName', 0x300A0226, 'Source Isotope Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kSourceStrengthUnits
      //(300A,0229)
      = const PTag._('SourceStrengthUnits', 0x300A0229, 'Source Strength Units', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kSourceStrength
      //(300A,022B)
      =
      const PTag._('SourceStrength', 0x300A022B, 'Source Strength', kDSIndex, VM.k1, false);
  ...
  static const PTag kApplicationSetupType
      //(300A,0232)
      = const PTag._('ApplicationSetupType', 0x300A0232, 'Application Setup Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kApplicationSetupName
      //(300A,0236)
      = const PTag._('ApplicationSetupName', 0x300A0236, 'Application Setup Name', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kTemplateNumber
      //(300A,0240)
      =
      const PTag._('TemplateNumber', 0x300A0240, 'Template Number', kISIndex, VM.k1, false);
  static const PTag kTemplateType
      //(300A,0242)
      = const PTag._('TemplateType', 0x300A0242, 'Template Type', kSHIndex, VM.k1, false);
  static const PTag kTemplateName
      //(300A,0244)
      = const PTag._('TemplateName', 0x300A0244, 'Template Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kBrachyAccessoryDeviceNominalTransmission
      ...
      = const PTag._('BrachyAccessoryDeviceNominalTransmission', 0x300A026C,
          'Brachy Accessory Device Nominal Transmission', kDSIndex, VM.k1, false);
  static const PTag kChannelSequence
      //(300A,0280)
      = const PTag._(
          'ChannelSequence', 0x300A0280, 'Channel Sequence', kSQIndex, VM.k1, false);
  static const PTag kChannelNumber
      //(300A,0282)
      = const PTag._('ChannelNumber', 0x300A0282, 'Channel Number', kISIndex, VM.k1, false);
  static const PTag kChannelLength
      //(300A,0284)
      = const PTag._('ChannelLength', 0x300A0284, 'Channel Length', kDSIndex, VM.k1, false);
  static const PTag kChannelTotalTime
      //(300A,0286)
      = const PTag._(
          'ChannelTotalTime', 0x300A0286, 'Channel Total Time', kDSIndex, VM.k1, false);
  static const PTag kSourceMovementType
      //(300A,0288)
      = const PTag._(
          'SourceMovementType', 0x300A0288, 'Source Movement Type', kCSIndex, VM.k1, false);
  static const PTag kNumberOfPulses
      //(300A,028A)
      = const PTag._(
          'NumberOfPulses', 0x300A028A, 'Number of Pulses', kISIndex, VM.k1, false);
  ...
  static const PTag kSourceApplicatorID
      //(300A,0291)
      = const PTag._(
          'SourceApplicatorID', 0x300A0291, 'Source Applicator ID', kSHIndex, VM.k1, false);
  static const PTag kSourceApplicatorType
      //(300A,0292)
      = const PTag._('SourceApplicatorType', 0x300A0292, 'Source Applicator Type', kCSIndex,
          VM.k1, false);
  static const PTag kSourceApplicatorName
      //(300A,0294)
      = const PTag._('SourceApplicatorName', 0x300A0294, 'Source Applicator Name', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kSourceApplicatorWallNominalTransmission
      ...
      = const PTag._('SourceApplicatorWallNominalTransmission', 0x300A029E,
          'Source Applicator Wall Nominal Transmission', kDSIndex, VM.k1, false);
  ...
  static const PTag kTransferTubeNumber
      //(300A,02A2)
      = const PTag._(
          'TransferTubeNumber', 0x300A02A2, 'Transfer Tube Number', kISIndex, VM.k1, false);
  static const PTag kTransferTubeLength
      //(300A,02A4)
      = const PTag._(
          'TransferTubeLength', 0x300A02A4, 'Transfer Tube Length', kDSIndex, VM.k1, false);
  ...
  static const PTag kChannelShieldNumber
      //(300A,02B2)
      = const PTag._('ChannelShieldNumber', 0x300A02B2, 'Channel Shield Number', kISIndex,
          VM.k1, false);
  static const PTag kChannelShieldID
      //(300A,02B3)
      = const PTag._(
          'ChannelShieldID', 0x300A02B3, 'Channel Shield ID', kSHIndex, VM.k1, false);
  static const PTag kChannelShieldName
      //(300A,02B4)
      = const PTag._(
          'ChannelShieldName', 0x300A02B4, 'Channel Shield Name', kLOIndex, VM.k1, false);
  ...
  static const PTag kCumulativeTimeWeight
      //(300A,02D6)
      = const PTag._('CumulativeTimeWeight', 0x300A02D6, 'Cumulative Time Weight', kDSIndex,
          VM.k1, false);
  ...
  static const PTag kTotalCompensatorTrayWaterEquivalentThickness
      ...
      = const PTag._('TotalCompensatorTrayWaterEquivalentThickness', 0x300A02E3,
          'Total Compensator Tray Water-Equivalent Thickness', kFLIndex, VM.k1, false);
  ...
  static const PTag kRadiationMassNumber
      //(300A,0302)
      = const PTag._('RadiationMassNumber', 0x300A0302, 'Radiation Mass Number', kISIndex,
          VM.k1, false);
  ...
  static const PTag kRadiationChargeState
      //(300A,0306)
      = const PTag._('RadiationChargeState', 0x300A0306, 'Radiation Charge State', kSSIndex,
          VM.k1, false);
  ...
  static const PTag kSnoutSequence
      //(300A,030C)
      = const PTag._('SnoutSequence', 0x300A030C, 'Snout Sequence', kSQIndex, VM.k1, false);
  static const PTag kSnoutPosition
      //(300A,030D)
      = const PTag._('SnoutPosition', 0x300A030D, 'Snout Position', kFLIndex, VM.k1, false);
  ...
  static const PTag kRangeShifterSequence
      //(300A,0314)
      = const PTag._('RangeShifterSequence', 0x300A0314, 'Range Shifter Sequence', kSQIndex,
          VM.k1, false);
  static const PTag kRangeShifterNumber
      //(300A,0316)
      = const PTag._(
          'RangeShifterNumber', 0x300A0316, 'Range Shifter Number', kISIndex, VM.k1, false);
  static const PTag kRangeShifterID
      //(300A,0318)
      = const PTag._(
          'RangeShifterID', 0x300A0318, 'Range Shifter ID', kSHIndex, VM.k1, false);
  static const PTag kRangeShifterType
      //(300A,0320)
      = const PTag._(
          'RangeShifterType', 0x300A0320, 'Range Shifter Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kLateralSpreadingDeviceWaterEquivalentThickness
      ...
      = const PTag._('LateralSpreadingDeviceWaterEquivalentThickness', 0x300A033C,
          'Lateral Spreading Device Water Equivalent Thickness', kFLIndex, VM.k1, false);
  ...
  static const PTag kRangeModulatorNumber
      //(300A,0344)
      = const PTag._('RangeModulatorNumber', 0x300A0344, 'Range Modulator Number', kISIndex,
          VM.k1, false);
  static const PTag kRangeModulatorID
      //(300A,0346)
      = const PTag._(
          'RangeModulatorID', 0x300A0346, 'Range Modulator ID', kSHIndex, VM.k1, false);
  static const PTag kRangeModulatorType
      //(300A,0348)
      = const PTag._(
          'RangeModulatorType', 0x300A0348, 'Range Modulator Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kPatientSupportType
      //(300A,0350)
      = const PTag._(
          'PatientSupportType', 0x300A0350, 'Patient Support Type', kCSIndex, VM.k1, false);
  static const PTag kPatientSupportID
      //(300A,0352)
      = const PTag._(
          'PatientSupportID', 0x300A0352, 'Patient Support ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kMetersetRate
      //(300A,035A)
      = const PTag._('MetersetRate', 0x300A035A, 'Meterset Rate', kFLIndex, VM.k1, false);
  ...
  static const PTag kRangeShifterSetting
      //(300A,0362)
      = const PTag._('RangeShifterSetting', 0x300A0362, 'Range Shifter Setting', kLOIndex,
          VM.k1, false);
  ...
  static const PTag kIsocenterToLateralSpreadingDeviceDistance
      ...
      = const PTag._('IsocenterToLateralSpreadingDeviceDistance', 0x300A0374,
          'Isocenter to Lateral Spreading Device Distance', kFLIndex, VM.k1, false);
  ...
  static const PTag kRangeModulatorGatingStopWaterEquivalentThickness
      ...
      = const PTag._('RangeModulatorGatingStopWaterEquivalentThickness', 0x300A0388,
          'Range Modulator Gating Stop Water Equivalent Thickness', kFLIndex, VM.k1, false);
  ...
  static const PTag kScanSpotTuneID
      //(300A,0390)
      = const PTag._(
          'ScanSpotTuneID', 0x300A0390, 'Scan Spot Tune ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kScanSpotPositionMap
      //(300A,0394)
      = const PTag._('ScanSpotPositionMap', 0x300A0394, 'Scan Spot Position Map', kFLIndex,
          VM.k1_n, false);
  ...
  static const PTag kScanningSpotSize
      //(300A,0398)
      = const PTag._(
          'ScanningSpotSize', 0x300A0398, 'Scanning Spot Size', kFLIndex, VM.k2, false);
  static const PTag kNumberOfPaintings
      //(300A,039A)
      = const PTag._(
          'NumberOfPaintings', 0x300A039A, 'Number of Paintings', kISIndex, VM.k1, false);
  ...
  static const PTag kIonBeamSequence
      //(300A,03A2)
      = const PTag._(
          'IonBeamSequence', 0x300A03A2, 'Ion Beam Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIonBlockSequence
      //(300A,03A6)
      = const PTag._(
          'IonBlockSequence', 0x300A03A6, 'Ion Block Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kIonWedgeSequence
      //(300A,03AA)
      = const PTag._(
          'IonWedgeSequence', 0x300A03AA, 'Ion Wedge Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kSetupImageComment
      //(300A,0402)
      = const PTag._(
          'SetupImageComment', 0x300A0402, 'Setup Image Comment', kSTIndex, VM.k1, false);
  ...
  static const PTag kGeneralAccessoryID
      //(300A,0421)
      = const PTag._(
          'GeneralAccessoryID', 0x300A0421, 'General Accessory ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kGeneralAccessoryType
      //(300A,0423)
      = const PTag._('GeneralAccessoryType', 0x300A0423, 'General Accessory Type', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kApplicatorOpening
      //(300A,0433)
      = const PTag._(
          'ApplicatorOpening', 0x300A0433, 'Applicator Opening', kFLIndex, VM.k1, false);
  static const PTag kApplicatorOpeningX
      //(300A,0434)
      = const PTag._(
          'ApplicatorOpeningX', 0x300A0434, 'Applicator Opening X', kFLIndex, VM.k1, false);
  static const PTag kApplicatorOpeningY
      //(300A,0435)
      = const PTag._(
          'ApplicatorOpeningY', 0x300A0435, 'Applicator Opening Y', kFLIndex, VM.k1, false);
  static const PTag kSourceToApplicatorMountingPositionDistance
      ...
      = const PTag._('SourceToApplicatorMountingPositionDistance', 0x300A0436,
          'Source to Applicator Mounting Position Distance', kFLIndex, VM.k1, false);
  ...
  static const PTag kReferencedBeamNumber
      //(300C,0006)
      = const PTag._('ReferencedBeamNumber', 0x300C0006, 'Referenced Beam Number', kISIndex,
          VM.k1, false);
  ...
  static const PTag kReferencedBrachyApplicationSetupSequence
      ...
      = const PTag._('ReferencedBrachyApplicationSetupSequence', 0x300C000A,
          'Referenced Brachy Application Setup Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kApprovalStatus
      //(300E,0002)
      =
      const PTag._('ApprovalStatus', 0x300E0002, 'Approval Status', kCSIndex, VM.k1, false);
  static const PTag kReviewDate
      //(300E,0004)
      = const PTag._('ReviewDate', 0x300E0004, 'Review Date', kDAIndex, VM.k1, false);
  static const PTag kReviewTime
      //(300E,0005)
      = const PTag._('ReviewTime', 0x300E0005, 'Review Time', kTMIndex, VM.k1, false);
  static const PTag kReviewerName
      //(300E,0008)
      = const PTag._('ReviewerName', 0x300E0008, 'Reviewer Name', kPNIndex, VM.k1, false);
  ...
  static const PTag kTextComments
      //(4000,4000)
      = const PTag._('TextComments', 0x40004000, 'Text Comments', kLTIndex, VM.k1, true);
  static const PTag kResultsID
      //(4008,0040)
      = const PTag._('ResultsID', 0x40080040, 'Results ID', kSHIndex, VM.k1, true);
  static const PTag kResultsIDIssuer
      //(4008,0042)
      = const PTag._(
          'ResultsIDIssuer', 0x40080042, 'Results ID Issuer', kLOIndex, VM.k1, true);
  ...
  static const PTag kInterpretationText
      //(4008,010B)
      = const PTag._(
          'InterpretationText', 0x4008010B, 'Interpretation Text', kSTIndex, VM.k1, true);
  static const PTag kInterpretationAuthor
      //(4008,010C)
      = const PTag._('InterpretationAuthor', 0x4008010C, 'Interpretation Author', kPNIndex,
          VM.k1, true);
  ...
  static const PTag kDistributionName
      //(4008,0119)
      = const PTag._(
          'DistributionName', 0x40080119, 'Distribution Name', kPNIndex, VM.k1, true);
  static const PTag kDistributionAddress
      //(4008,011A)
      = const PTag._(
          'DistributionAddress', 0x4008011A, 'Distribution Address', kLOIndex, VM.k1, true);
  static const PTag kInterpretationID
      //(4008,0200)
      = const PTag._(
          'InterpretationID', 0x40080200, 'Interpretation ID', kSHIndex, VM.k1, true);
  ...
  static const PTag kInterpretationTypeID
      //(4008,0210)
      = const PTag._('InterpretationTypeID', 0x40080210, 'Interpretation Type ID', kCSIndex,
          VM.k1, true);
  ...
  static const PTag kImpressions
      //(4008,0300)
      = const PTag._('Impressions', 0x40080300, 'Impressions', kSTIndex, VM.k1, true);
  static const PTag kResultsComments
      //(4008,4000)
      = const PTag._(
          'ResultsComments', 0x40084000, 'Results Comments', kSTIndex, VM.k1, true);
  static const PTag kLowEnergyDetectors
      //(4010,0001)
      = const PTag._(
          'LowEnergyDetectors', 0x40100001, 'Low Energy Detectors', kCSIndex, VM.k1, false);
  static const PTag kHighEnergyDetectors
      //(4010,0002)
      = const PTag._('HighEnergyDetectors', 0x40100002, 'High Energy Detectors', kCSIndex,
          VM.k1, false);
  ...
  static const PTag kThreatROIBase
      //(4010,1004)
      =
      const PTag._('ThreatROIBase', 0x40101004, 'Threat ROI Base', kFLIndex, VM.k3, false);
  static const PTag kThreatROIExtents
      //(4010,1005)
      = const PTag._(
          'ThreatROIExtents', 0x40101005, 'Threat ROI Extents', kFLIndex, VM.k3, false);
  static const PTag kThreatROIBitmap
      //(4010,1006)
      = const PTag._(
          'ThreatROIBitmap', 0x40101006, 'Threat ROI Bitmap', kOBIndex, VM.k1, false);
  static const PTag kRouteSegmentID
      //(4010,1007)
      = const PTag._(
          'RouteSegmentID', 0x40101007, 'Route Segment ID', kSHIndex, VM.k1, false);
  static const PTag kGantryType
      //(4010,1008)
      = const PTag._('GantryType', 0x40101008, 'Gantry Type', kCSIndex, VM.k1, false);
  static const PTag kOOIOwnerType
      //(4010,1009)
      = const PTag._('OOIOwnerType', 0x40101009, 'OOI Owner Type', kCSIndex, VM.k1, false);
  static const PTag kRouteSegmentSequence
      //(4010,100A)
      = const PTag._('RouteSegmentSequence', 0x4010100A, 'Route Segment Sequence', kSQIndex,
          VM.k1, false);
  ...
  static const PTag kThreatSequence
      //(4010,1011)
      =
      const PTag._('ThreatSequence', 0x40101011, 'Threat Sequence', kSQIndex, VM.k1, false);
  static const PTag kThreatCategory
      //(4010,1012)
      =
      const PTag._('ThreatCategory', 0x40101012, 'Threat Category', kCSIndex, VM.k1, false);
  ...
  static const PTag kATDAbilityAssessment
      //(4010,1014)
      = const PTag._('ATDAbilityAssessment', 0x40101014, 'ATD Ability Assessment', kCSIndex,
          VM.k1, false);
  static const PTag kATDAssessmentFlag
      //(4010,1015)
      = const PTag._(
          'ATDAssessmentFlag', 0x40101015, 'ATD Assessment Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kZEffective
      //(4010,1019)
      = const PTag._('ZEffective', 0x40101019, 'Z Effective', kFLIndex, VM.k1, false);
  static const PTag kBoardingPassID
      //(4010,101A)
      = const PTag._(
          'BoardingPassID', 0x4010101A, 'Boarding Pass ID', kSHIndex, VM.k1, false);
  static const PTag kCenterOfMass
      //(4010,101B)
      = const PTag._('CenterOfMass', 0x4010101B, 'Center of Mass', kFLIndex, VM.k3, false);
  static const PTag kCenterOfPTO
      //(4010,101C)
      = const PTag._('CenterOfPTO', 0x4010101C, 'Center of PTO', kFLIndex, VM.k3, false);
  static const PTag kBoundingPolygon
      //(4010,101D)
      = const PTag._(
          'BoundingPolygon', 0x4010101D, 'Bounding Polygon', kFLIndex, VM.k6_n, false);
  ...
  static const PTag kAbortReason
      //(4010,1021)
      = const PTag._('AbortReason', 0x40101021, 'Abort Reason', kCSIndex, VM.k1_n, false);
  static const PTag kVolumeOfPTO
      //(4010,1023)
      = const PTag._('VolumeOfPTO', 0x40101023, 'Volume of PTO', kFLIndex, VM.k1, false);
  static const PTag kAbortFlag
      //(4010,1024)
      = const PTag._('AbortFlag', 0x40101024, 'Abort Flag', kCSIndex, VM.k1, false);
  ...
  static const PTag kRouteSegmentEndTime
      //(4010,1026)
      = const PTag._('RouteSegmentEndTime', 0x40101026, 'Route Segment End Time', kDTIndex,
          VM.k1, false);
  ...
  static const PTag kAssignedLocation
      //(4010,102A)
      = const PTag._(
          'AssignedLocation', 0x4010102A, 'Assigned Location', kSHIndex, VM.k1, false);
  static const PTag kAlarmDecisionTime
      //(4010,102B)
      = const PTag._(
          'AlarmDecisionTime', 0x4010102B, 'Alarm Decision Time', kDTIndex, VM.k1, false);
  static const PTag kAlarmDecision
      //(4010,1031)
      = const PTag._('AlarmDecision', 0x40101031, 'Alarm Decision', kCSIndex, VM.k1, false);
  ...
  static const PTag kDICOSVersion
      //(4010,103A)
      = const PTag._('DICOSVersion', 0x4010103A, 'DICOS Version', kCSIndex, VM.k1, false);
  ...
  static const PTag kAcquisitionStatus
      //(4010,1044)
      = const PTag._(
          'AcquisitionStatus', 0x40101044, 'Acquisition Status', kCSIndex, VM.k1, false);
  ...
  static const PTag kPhantomType
      //(4010,1046)
      = const PTag._('PhantomType', 0x40101046, 'Phantom Type', kCSIndex, VM.k1, false);
  static const PTag kOOIOwnerSequence
      //(4010,1047)
      = const PTag._(
          'OOIOwnerSequence', 0x40101047, 'OOI Owner Sequence', kSQIndex, VM.k1, false);
  static const PTag kScanType
      //(4010,1048)
      = const PTag._('ScanType', 0x40101048, 'Scan Type', kCSIndex, VM.k1, false);
  static const PTag kItineraryID
      //(4010,1051)
      = const PTag._('ItineraryID', 0x40101051, 'Itinerary ID', kLOIndex, VM.k1, false);
  static const PTag kItineraryIDType
      //(4010,1052)
      = const PTag._(
          'ItineraryIDType', 0x40101052, 'Itinerary ID Type', kSHIndex, VM.k1, false);
  ...
  static const PTag kInboundArrivalType
      //(4010,1056)
      = const PTag._(
          'InboundArrivalType', 0x40101056, 'Inbound Arrival Type', kCSIndex, VM.k1, false);
  static const PTag kCarrierID
      //(4010,1058)
      = const PTag._('CarrierID', 0x40101058, 'Carrier ID', kSHIndex, VM.k1, false);
  ...
  static const PTag kSourceOrientation
      //(4010,1060)
      = const PTag._(
          'SourceOrientation', 0x40101060, 'Source Orientation', kFLIndex, VM.k3, false);
  static const PTag kSourcePosition
      //(4010,1061)
      =
      const PTag._('SourcePosition', 0x40101061, 'Source Position', kFLIndex, VM.k3, false);
  static const PTag kBeltHeight
      //(4010,1062)
      = const PTag._('BeltHeight', 0x40101062, 'Belt Height', kFLIndex, VM.k1, false);
  ...
  static const PTag kOOITypeDescriptor
      //(4010,1068)
      = const PTag._(
          'OOITypeDescriptor', 0x40101068, 'OOI Type Descriptor', kLTIndex, VM.k1, false);
  static const PTag kTotalProcessingTime
      //(4010,1069)
      = const PTag._('TotalProcessingTime', 0x40101069, 'Total Processing Time', kFLIndex,
          VM.k1, false);
  ...
  static const PTag kAITDeviceType
      //(4010,1070)
      =
      const PTag._('AITDeviceType', 0x40101070, 'AIT Device Type', kCSIndex, VM.k1, false);
  ...
  static const PTag kSNRThreshold
      //(4010,1073)
      = const PTag._('SNRThreshold', 0x40101073, 'SNR Threshold', kFDIndex, VM.k1, false);
  ...
  static const PTag kPTORegionSequence
      //(4010,107B)
      = const PTag._(
          'PTORegionSequence', 0x4010107B, 'PTO Region Sequence', kSQIndex, VM.k1, false);
  ...
  static const PTag kCurveDimensions
      //(5000,0005)
      = const PTag._(
          'CurveDimensions', 0x50000005, 'Curve Dimensions', kUSIndex, VM.k1, true);
  static const PTag kNumberOfPoints
      //(5000,0010)
      =
      const PTag._('NumberOfPoints', 0x50000010, 'Number of Points', kUSIndex, VM.k1, true);
  static const PTag kTypeOfData
      //(5000,0020)
      = const PTag._('TypeOfData', 0x50000020, 'Type of Data', kCSIndex, VM.k1, true);
  static const PTag kCurveDescription
      //(5000,0022)
      = const PTag._(
          'CurveDescription', 0x50000022, 'Curve Description', kLOIndex, VM.k1, true);
  static const PTag kAxisUnits
      //(5000,0030)
      = const PTag._('AxisUnits', 0x50000030, 'Axis Units', kSHIndex, VM.k1_n, true);
  static const PTag kAxisLabels
      //(5000,0040)
      = const PTag._('AxisLabels', 0x50000040, 'Axis Labels', kSHIndex, VM.k1_n, true);
  ...
  static const PTag kCurveRange
      //(5000,0106)
      = const PTag._('CurveRange', 0x50000106, 'Curve Range', kSHIndex, VM.k1_n, true);
  static const PTag kCurveDataDescriptor
      //(5000,0110)
      = const PTag._('CurveDataDescriptor', 0x50000110, 'Curve Data Descriptor', kUSIndex,
          VM.k1_n, true);
  static const PTag kCoordinateStartValue
      //(5000,0112)
      = const PTag._('CoordinateStartValue', 0x50000112, 'Coordinate Start Value', kUSIndex,
          VM.k1_n, true);
  static const PTag kCoordinateStepValue
      //(5000,0114)
      = const PTag._('CoordinateStepValue', 0x50000114, 'Coordinate Step Value', kUSIndex,
          VM.k1_n, true);
  static const PTag kCurveActivationLayer
      //(5000,1001)
      = const PTag._('CurveActivationLayer', 0x50001001, 'Curve Activation Layer', kCSIndex,
          VM.k1, true);
  static const PTag kAudioType
      //(5000,2000)
      = const PTag._('AudioType', 0x50002000, 'Audio Type', kUSIndex, VM.k1, true);
  static const PTag kAudioSampleFormat
      //(5000,2002)
      = const PTag._(
          'AudioSampleFormat', 0x50002002, 'Audio Sample Format', kUSIndex, VM.k1, true);
  static const PTag kNumberOfChannels
      //(5000,2004)
      = const PTag._(
          'NumberOfChannels', 0x50002004, 'Number of Channels', kUSIndex, VM.k1, true);
  static const PTag kNumberOfSamples
      //(5000,2006)
      = const PTag._(
          'NumberOfSamples', 0x50002006, 'Number of Samples', kULIndex, VM.k1, true);
  static const PTag kSampleRate
      //(5000,2008)
      = const PTag._('SampleRate', 0x50002008, 'Sample Rate', kULIndex, VM.k1, true);
  static const PTag kTotalTime
      //(5000,200A)
      = const PTag._('TotalTime', 0x5000200A, 'Total Time', kULIndex, VM.k1, true);
  static const PTag kAudioSampleData
      //(5000,200C)
      = const PTag._(
          'AudioSampleData', 0x5000200C, 'Audio Sample Data', kOBOWIndex, VM.k1, true);
  static const PTag kAudioComments
      //(5000,200E)
      = const PTag._('AudioComments', 0x5000200E, 'Audio Comments', kLTIndex, VM.k1, true);
  static const PTag kCurveLabel
      //(5000,2500)
      = const PTag._('CurveLabel', 0x50002500, 'Curve Label', kLOIndex, VM.k1, true);
  ...
  static const PTag kCurveData
      //(5000,3000)
      = const PTag._('CurveData', 0x50003000, 'Curve Data', kOBOWIndex, VM.k1, true);
  ...
  static const PTag kWaveformSequence
      //(5400,0100)
      = const PTag._(
          'WaveformSequence', 0x54000100, 'Waveform Sequence', kSQIndex, VM.k1, false);
  static const PTag kChannelMinimumValue
      //(5400,0110)
      = const PTag._('ChannelMinimumValue', 0x54000110, 'Channel Minimum Value', kOBOWIndex,
          VM.k1, false);
  static const PTag kChannelMaximumValue
      //(5400,0112)
      = const PTag._('ChannelMaximumValue', 0x54000112, 'Channel Maximum Value', kOBOWIndex,
          VM.k1, false);
  ...
  static const PTag kWaveformData
      //(5400,1010)
      = const PTag._('WaveformData', 0x54001010, 'Waveform Data', kOBOWIndex, VM.k1, false);
  ...
  static const PTag kSpectroscopyData
      //(5600,0020)
      = const PTag._(
          'SpectroscopyData', 0x56000020, 'Spectroscopy Data', kOFIndex, VM.k1, false);
  static const PTag kOverlayRows
      //(6000,0010)
      = const PTag._('OverlayRows', 0x60000010, 'Overlay Rows', kUSIndex, VM.k1, false);
  static const PTag kOverlayColumns
      //(6000,0011)
      =
      const PTag._('OverlayColumns', 0x60000011, 'Overlay Columns', kUSIndex, VM.k1, false);
  static const PTag kOverlayPlanes
      //(6000,0012)
      = const PTag._('OverlayPlanes', 0x60000012, 'Overlay Planes', kUSIndex, VM.k1, true);
  ...
  static const PTag kOverlayDescription
      //(6000,0022)
      = const PTag._(
          'OverlayDescription', 0x60000022, 'Overlay Description', kLOIndex, VM.k1, false);
  static const PTag kOverlayType
      //(6000,0040)
      = const PTag._('OverlayType', 0x60000040, 'Overlay Type', kCSIndex, VM.k1, false);
  static const PTag kOverlaySubtype
      //(6000,0045)
      =
      const PTag._('OverlaySubtype', 0x60000045, 'Overlay Subtype', kLOIndex, VM.k1, false);
  static const PTag kOverlayOrigin
      //(6000,0050)
      = const PTag._('OverlayOrigin', 0x60000050, 'Overlay Origin', kSSIndex, VM.k2, false);
  static const PTag kImageFrameOrigin
      //(6000,0051)
      = const PTag._(
          'ImageFrameOrigin', 0x60000051, 'Image Frame Origin', kUSIndex, VM.k1, false);
  static const PTag kOverlayPlaneOrigin
      //(6000,0052)
      = const PTag._(
          'OverlayPlaneOrigin', 0x60000052, 'Overlay Plane Origin', kUSIndex, VM.k1, true);
  ...
  static const PTag kOverlayBitsGrouped
      //(6000,0069)
      = const PTag._(
          'OverlayBitsGrouped', 0x60000069, 'Overlay Bits Grouped', kUSIndex, VM.k1, true);
  static const PTag kOverlayBitsAllocated
      //(6000,0100)
      = const PTag._('OverlayBitsAllocated', 0x60000100, 'Overlay Bits Allocated', kUSIndex,
          VM.k1, false);
  static const PTag kOverlayBitPosition
      //(6000,0102)
      = const PTag._(
          'OverlayBitPosition', 0x60000102, 'Overlay Bit Position', kUSIndex, VM.k1, false);
  static const PTag kOverlayFormat
      //(6000,0110)
      = const PTag._('OverlayFormat', 0x60000110, 'Overlay Format', kCSIndex, VM.k1, true);
  static const PTag kOverlayLocation
      //(6000,0200)
      = const PTag._(
          'OverlayLocation', 0x60000200, 'Overlay Location', kUSIndex, VM.k1, true);
  static const PTag kOverlayCodeLabel
      //(6000,0800)
      = const PTag._(
          'OverlayCodeLabel', 0x60000800, 'Overlay Code Label', kCSIndex, VM.k1_n, true);
  ...
  static const PTag kOverlaysGray
      //(6000,1200)
      =
      const PTag._('OverlaysGray', 0x60001200, 'Overlays - Gray', kUSIndex, VM.k1_n, true);
  static const PTag kOverlaysRed
      //(6000,1201)
      = const PTag._('OverlaysRed', 0x60001201, 'Overlays - Red', kUSIndex, VM.k1_n, true);
  static const PTag kOverlaysGreen
      //(6000,1202)
      = const PTag._(
          'OverlaysGreen', 0x60001202, 'Overlays - Green', kUSIndex, VM.k1_n, true);
  static const PTag kOverlaysBlue
      //(6000,1203)
      =
      const PTag._('OverlaysBlue', 0x60001203, 'Overlays - Blue', kUSIndex, VM.k1_n, true);
  ...
  static const PTag kROIStandardDeviation
      //(6000,1303)
      = const PTag._('ROIStandardDeviation', 0x60001303, 'ROI Standard Deviation', kDSIndex,
          VM.k1, false);
  static const PTag kOverlayLabel
      //(6000,1500)
      = const PTag._('OverlayLabel', 0x60001500, 'Overlay Label', kLOIndex, VM.k1, false);
  static const PTag kOverlayData
      //(6000,3000)
      = const PTag._('OverlayData', 0x60003000, 'Overlay Data', kOBOWIndex, VM.k1, false);
  static const PTag kOverlayComments
      //(6000,4000)
      = const PTag._(
          'OverlayComments', 0x60004000, 'Overlay Comments', kLTIndex, VM.k1, true);
...
*/
  ...
  static const PTag kCoefficientsSDVN
      //(7FE0,0020)
      = const PTag._(
          'CoefficientsSDVN', 0x7FE00020, 'Coefficients SDVN', kOWIndex, VM.k1, true);
  static const PTag kCoefficientsSDHN
      //(7FE0,0030)
      = const PTag._(
          'CoefficientsSDHN', 0x7FE00030, 'Coefficients SDHN', kOWIndex, VM.k1, true);
  static const PTag kCoefficientsSDDN
      //(7FE0,0040)
      = const PTag._(
          'CoefficientsSDDN', 0x7FE00040, 'Coefficients SDDN', kOWIndex, VM.k1, true);
  static const PTag kVariablePixelData
      //(7F00,0010)
      = const PTag._(
          'VariablePixelData', 0x7F000010, 'Variable Pixel Data', kOBOWIndex, VM.k1, true);
  ...
  static const PTag kCoefficientCoding = const PTag._(
      'CoefficientCoding', 0x00280402, 'Coefficient Coding', kLOIndex, VM.k1_n, true);

  //(0028,0403)
  static const PTag kCoefficientCodingPointers = const PTag._('CoefficientCodingPointers',
      0x00280403, 'Coefficient Coding Pointers', kATIndex, VM.k1_n, true);

  //**** DcmDir Group Length Tags - Note: these are not included in PS3.6 ****
  static const PTag kGroup4Length =
      const PTag._('Group4Length', 0x00040000, 'Group 0004 Length', kULIndex, VM.k1, true);

  //**** Public Group Length Tags - Note: these are not included in PS3.6 ****
  static const PTag kGroup8Length =
      const PTag._('Group8Length', 0x00080000, 'Group 0008 Length', kULIndex, VM.k1, true);

  static const PTag kGroup10Length =
      const PTag._('Group10Length', 0x00100000, 'Group 0010 Length', kULIndex, VM.k1, true);

  static const PTag kGroup12Length =
      const PTag._('Group12Length', 0x00120000, 'Group 0012 Length', kULIndex, VM.k1, true);

  static const PTag kGroup14Length = const PTag._(
      'Group14Length', 0x000140000, 'Group 00014 Length', kULIndex, VM.k1, true);

  static const PTag kGroup18Length =
      const PTag._('Group18Length', 0x00180000, 'Group 0018 Length', kULIndex, VM.k1, true);

  static const PTag kGroup20Length =
      const PTag._('Group20Length', 0x00200000, 'Group 0020 Length', kULIndex, VM.k1, true);

  static const PTag kGroup22Length =
      const PTag._('Group22Length', 0x00220000, 'Group 0022 Length', kULIndex, VM.k1, true);

  static const PTag kGroup24Length =
      const PTag._('Group24Length', 0x00240000, 'Group 0024 Length', kULIndex, VM.k1, true);

  static const PTag kGroup28Length =
      const PTag._('Group28Length', 0x00280000, 'Group 0028 Length', kULIndex, VM.k1, true);

  static const PTag kGroup32Length =
      const PTag._('Group32Length', 0x00320000, 'Group 0032 Length', kULIndex, VM.k1, true);

  static const PTag kGroup38Length =
      const PTag._('Group38Length', 0x00380000, 'Group 0038 Length', kULIndex, VM.k1, true);

  static const PTag kGroup3aLength =
      const PTag._('Group3aLength', 0x003a0000, 'Group 003a Length', kULIndex, VM.k1, true);

  static const PTag kGroup40Length =
      const PTag._('Group40Length', 0x00400000, 'Group 0040 Length', kULIndex, VM.k1, true);

  static const PTag kGroup42Length =
      const PTag._('Group42Length', 0x00420000, 'Group 0042 Length', kULIndex, VM.k1, true);

  static const PTag kGroup44Length =
      const PTag._('Group44Length', 0x00440000, 'Group 0044 Length', kULIndex, VM.k1, true);

  static const PTag kGroup46Length =
      const PTag._('Group46Length', 0x00460000, 'Group 0046 Length', kULIndex, VM.k1, true);

  static const PTag kGroup48Length =
      const PTag._('Group48Length', 0x00480000, 'Group 0048 Length', kULIndex, VM.k1, true);

  static const PTag kGroup50Length =
      const PTag._('Group50Length', 0x00500000, 'Group 0050 Length', kULIndex, VM.k1, true);

  static const PTag kGroup52Length =
      const PTag._('Group52Length', 0x00520000, 'Group 0052 Length', kULIndex, VM.k1, true);

  static const PTag kGroup54Length =
      const PTag._('Group54Length', 0x00540000, 'Group 0054 Length', kULIndex, VM.k1, true);

  static const PTag kGroup60Length =
      const PTag._('Group60Length', 0x00600000, 'Group 0060 Length', kULIndex, VM.k1, true);

  static const PTag kGroup62Length =
      const PTag._('Group62Length', 0x00620000, 'Group 0062 Length', kULIndex, VM.k1, true);

  static const PTag kGroup64Length =
      const PTag._('Group64Length', 0x00640000, 'Group 0064 Length', kULIndex, VM.k1, true);

  static const PTag kGroup66Length =
      const PTag._('Group66Length', 0x00660000, 'Group 0066 Length', kULIndex, VM.k1, true);

  static const PTag kGroup68Length =
      const PTag._('Group68Length', 0x00680000, 'Group 0068 Length', kULIndex, VM.k1, true);

  static const PTag kGroup70Length =
      const PTag._('Group70Length', 0x00700000, 'Group 0070 Length', kULIndex, VM.k1, true);

  static const PTag kGroup72Length =
      const PTag._('Group72Length', 0x00720000, 'Group 0072 Length', kULIndex, VM.k1, true);

  static const PTag kGroup74Length =
      const PTag._('Group74Length', 0x00740000, 'Group 0074 Length', kULIndex, VM.k1, true);

  static const PTag kGroup76Length =
      const PTag._('Group76Length', 0x00760000, 'Group 0076 Length', kULIndex, VM.k1, true);

  static const PTag kGroup78Length =
      const PTag._('Group78Length', 0x00780000, 'Group 0078 Length', kULIndex, VM.k1, true);

  static const PTag kGroup80Length =
      const PTag._('Group80Length', 0x00800000, 'Group 0080 Length', kULIndex, VM.k1, true);

  static const PTag kGroup88Length =
      const PTag._('Group88Length', 0x00880000, 'Group 0088 Length', kULIndex, VM.k1, true);
  ...
  static const PTag kGroup2000Length = const PTag._(
      'Group2000Length', 0x20000000, 'Group 2000 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2010Length = const PTag._(
      'Group2010Length', 0x20010000, 'Group 2010 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2020Length = const PTag._(
      'Group2020Length', 0x20200000, 'Group 2020 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2030Length = const PTag._(
      'Group2030Length', 0x20300000, 'Group 2030 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2040Length = const PTag._(
      'Group2040Length', 0x20400000, 'Group 2040 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2050Length = const PTag._(
      'Group2050Length', 0x20500000, 'Group 2050 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2100Length = const PTag._(
      'Group2100Length', 0x21000000, 'Group 2100 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2110Length = const PTag._(
      'Group2110Length', 0x21100000, 'Group 2110 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2120Length = const PTag._(
      'Group2120Length', 0x21200000, 'Group 2120 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2130Length = const PTag._(
      'Group2130Length', 0x21300000, 'Group 2130 Length', kULIndex, VM.k1, true);

  static const PTag kGroup2200Length = const PTag._(
      'Group2200Length', 0x22000000, 'Group 2200 Length', kULIndex, VM.k1, true);

  static const PTag kGroup3002Length = const PTag._(
      'Group3002Length', 0x30020000, 'Group 3002 Length', kULIndex, VM.k1, true);

  static const PTag kGroup3004Length = const PTag._(
      'Group3004Length', 0x30040000, 'Group 3004 Length', kULIndex, VM.k1, true);

  static const PTag kGroup3006Length = const PTag._(
      'Group3006Length', 0x30060000, 'Group 3006 Length', kULIndex, VM.k1, true);

  static const PTag kGroup3008Length = const PTag._(
      'Group3008Length', 0x30080000, 'Group 3008 Length', kULIndex, VM.k1, true);

  static const PTag kGroup300aLength = const PTag._(
      'Group300aLength', 0x300a0000, 'Group 300a Length', kULIndex, VM.k1, true);

  static const PTag kGroup300cLength = const PTag._(
      'Group300cLength', 0x300c0000, 'Group 300c Length', kULIndex, VM.k1, true);

  static const PTag kGroup300eLength = const PTag._(
      'Group300eLength', 0x300e0000, 'Group 300e Length', kULIndex, VM.k1, true);

  static const PTag kGroup4000Length = const PTag._(
      'Group4000Length', 0x40000000, 'Group 4000 Length', kULIndex, VM.k1, true);

  static const PTag kGroup4008Length = const PTag._(
      'Group4008Length', 0x40080000, 'Group 4008 Length', kULIndex, VM.k1, true);

  static const PTag kGroup4010Length = const PTag._(
      'Group4010Length', 0x40100000, 'Group 4010 Length', kULIndex, VM.k1, true);

  static const PTag kGroup4ffeLength = const PTag._(
      'Group4ffeLength', 0x4ffe0000, 'Group 4ffe Length', kULIndex, VM.k1, true);

  static const PTag kGroup5000Length = const PTag._(
      'Group5000Length', 0x50000000, 'Group 5000 Length', kULIndex, VM.k1, true);

  static const PTag kGroup5200Length = const PTag._(
      'Group5200Length', 0x52000000, 'Group 5200 Length', kULIndex, VM.k1, true);

  static const PTag kGroup5400Length = const PTag._(
      'Group5400Length', 0x54000000, 'Group 5400 Length', kULIndex, VM.k1, true);

  static const PTag kGroup5600Length = const PTag._(
      'Group5600Length', 0x56000000, 'Group 5600 Length', kULIndex, VM.k1, true);

  static const PTag kGroup6000Length = const PTag._(
      'Group6000Length', 0x60000000, 'Group 6000 Length', kULIndex, VM.k1, true);
...
class PTagGroupLength extends PTag {
  ...
  PTagGroupLength(int code)
      : super._('kPublicGroupLength${hex(code)}', code,
            'Public Group Length for ${Tag.toDcm(code)}', kULIndex, VM.k1, true, EType.k3);

  PTagGroupLength.keyword(String keyword)
      : super._('kPublicGroupLength$keyword', int.parse(keyword),
            'Public Group Length for $keyword', kULIndex, VM.k1, true, EType.k3);
...
class PTagUnknown extends PTag {
  ...
  PTagUnknown(int code, int vrIndex)
      : super._('kUnknownPublicTag_${hex16(Group.fromTag(code))}', code,
            'Unknown DICOM Tag ${Tag.toDcm(code)}', vrIndex, VM.k1_n, false, EType.k3);
