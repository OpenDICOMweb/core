...
import 'package:core/src/values/uid/uid_string.dart';
import 'package:core/src/values/uid/well_known_uids.dart';
import 'package:core/src/values/uuid.dart';

export 'package:core/src/values/uid/constants.dart';
export 'package:core/src/values/uid/supported_transfer_syntax.dart';
export 'package:core/src/values/uid/supported_uids.dart';
export 'package:core/src/values/uid/uid.dart';
...
class Uid {
  ...
  /// its argument, and its values is returned as the values of the [parse]
  ...
  /// Tries to parse [s] as [Uid] and return its values.
  ///
