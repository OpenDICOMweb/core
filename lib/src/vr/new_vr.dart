...
/// Returns _true_ if the VR with [vrIndex] is by definition always a valid length.
bool isVFLengthAlwaysValid(int vrIndex) => vrIndex >= kSQIndex && vrIndex <= kUTIndex;
...
bool isFloatVR(int vrIndex) =>
    vrIndex == kFLIndex ||  vrIndex == kFDIndex ||  vrIndex == kOFIndex ||
        vrIndex == kODIndex;
