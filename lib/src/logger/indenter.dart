...
class Indenter {
  ...
  Indenter(
      ...
      this.indent = 2})
      : _maxLineNumber =
            (lineNumberWidth <= 0) ? -1 : int.parse(''.padRight(lineNumberWidth, '9'));
  ...
  String get lineNo {
    ...
    return _line.toRadixString(lineNoRadix).padLeft(lineNumberWidth, lineNoPadChar);
  }
  ...
  String get info => '''Indenter: z: '$z' spaces: '$spaces'
  level: $_level, indent: $indent, prefix: '$prefix  line: $_line, maxLine: $_maxLineNumber,
...
//    print('out: $out');
  ...
  static Indenter get basic => new Indenter();
  static Indenter get lineNumbers => new Indenter(lineNumberWidth: 5);
}
