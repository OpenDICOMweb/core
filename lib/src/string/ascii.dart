...
/// A set of defined constants for Ascii codes, along with
/// a set of related predicates.
///
/// This library should be imported as follows:
/// ```import 'package:ascii/ascii.dart' as ascii;```
/// Constant [identifier]s for ASCII [code]s.
///
