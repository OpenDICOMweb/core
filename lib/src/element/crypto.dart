...
class Sha256<E> {
  ...
  static Uint8List uint8(List<int> v) => sha256.convert(v).bytes;

  /// Returns a Message [Digest] from a [List<int>].
  static Uint16List uint16(List<int> v) => _trim(v, uint8(v).buffer.asUint16List());

  /// Returns a Message [Digest] from a [List<int>].
  static Uint32List uint32(List<int> v) => _trim(v, uint8(v).buffer.asUint32List());

  /// Returns a Message [Digest] from a [List<int>].
  static Int16List int16(List<int> v) => _trim(v, uint8(v).buffer.asInt16List());

  /// Returns a Message [Digest] from a [List<int>].
  static Int32List int32(List<int> v) => _trim(v, uint8(v).buffer.asInt32List());

  /// Returns a Message [Digest] from a [List<int>].
  static Int64List int64(List<int> v) => _trim(v, uint8(v).buffer.asInt64List());

  /// Returns a Message [Digest] from a [List<double>].
  static Float32List float32(List<double> v) {
    final v32 = (v is Float32List) ? v : new Float32List.fromList(v);
    return _trim(v, uint8(v32.buffer.asUint8List()).buffer.asFloat32List());
  }

  /// Returns a Message [Digest] from a [List<double>].
  static Float64List float64(List<double> v) {
