  ...
  group('OWTag', () {
    ...
    test('OW update random', () {
      for (var i = 0; i < 10; i++) {
        ...
        final e1 =
            new OWtag(PTag.kGreenPaletteColorLookupTableData, vList0);
    ...
    test('OW hashCode and == random bad values', () {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        final e0 =
            new OWtag(PTag.kRedPaletteColorLookupTableData, vList1);

        final e2 =
            new OWtag(PTag.kGreenPaletteColorLookupTableData, vList1);
        ...
        final e3 =
            new OWtag(PTag.kRedPaletteColorLookupTableData, vList2);
