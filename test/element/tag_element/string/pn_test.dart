  ...
  group('PN', () {
    ...
    test('PN isValidVListLength VM.k1 good values', () {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        for (var tag in pnTags0) {
          expect(PN.isValidVListLength(tag, vList), true);
    ...
    test('PN isValidVListLength VM.k1 bad values', () {
      for (var i = 1; i < 10; i++) {
        ...
        for (var tag in pnTags0) {
          global.throwOnError = false;
          expect(PN.isValidVListLength(tag, vList), false);

          expect(PN.isValidVListLength(tag, invalidVList), false);

          global.throwOnError = true;
          expect(() => PN.isValidVListLength(tag, vList),
              throwsA(const isInstanceOf<InvalidValuesError>()));
        }
      }
    });
    ...
    test('PN isValidVListLength VM.k1_n good values', () {
      ...
      for (var i = 1; i < 10; i++) {
        ...
        for (var tag in pnTags1) {
          log.debug('tag: $tag');
          expect(PN.isValidVListLength(tag, vList0), true);
