...
*/
    ...
    test('UI isValidVListLength VM.k1 good values', () {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        for (var tag in uiTags0) {
          expect(UI.isValidVListLength(tag, vList), true);
    ...
    test('UI isValidVListLength VM.k1 bad values', () {
      for (var i = 1; i < 10; i++) {
        ...
        for (var tag in uiTags0) {
          global.throwOnError = false;
          expect(UI.isValidVListLength(tag, vList), false);

          expect(UI.isValidVListLength(tag, invalidVList), false);

          global.throwOnError = true;
          expect(() => UI.isValidVListLength(tag, vList),
              throwsA(const isInstanceOf<InvalidValuesError>()));
        }
      }
    });
    ...
    test('UI isValidVListLength VM.k1_n good values', () {
      ...
      for (var i = 1; i < 10; i++) {
        ...
        for (var tag in uiTags1) {
          log.debug('tag: $tag');
          expect(UI.isValidVListLength(tag, vList0), true);
