...
//        expect(e1.update(vList1).values, equals(vList1));
    ...
    test('UC fromBytes random', () {
      for (var i = 0; i < 10; i++) {
        ...
        final e0 =
            UCtag.fromBytes(PTag.kStrainDescription, bytes, Charset.utf8);
    ...
    test('UC fromBytes good values', () {
      for (var i = 0; i < 10; i++) {
        ...
        for (var listS in vList1) {
          ...
          //final bytes0 = Bytes();
          final e1 =
              UCtag.fromBytes(PTag.kSelectorUCValue, bytes0, Charset.utf8);
    ...
    test('UC fromBytes bad values', () {
      for (var i = 0; i < 10; i++) {
        ...
        for (var listS in vList1) {
          ...
          //final bytes0 = Bytes();
          final e1 =
              UCtag.fromBytes(PTag.kSelectorCSValue, bytes0, Charset.utf8);
          expect(e1, isNull);
