  ...
  group('SH', () {
    ...
    test('SH toBytes', () {
      for (var i = 0; i < 10; i++) {
        ...
        global.throwOnError = false;
        final toB0 = BytesDicom.fromUtf8List(vsList0, kMaxShortVF);
