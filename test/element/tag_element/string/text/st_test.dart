...
void main() {
  ...
  group('ST Tests', () {
    ...
    test('ST checkValues good values random', () {
      for (var i = 0; i < 10; i++) {
        final vList0 = rsg.getSTList(1, 1);
        final e0 = STtag(PTag.kSelectorSTValue, vList0);
    ...
    test('ST checkValues bad values random', () {
      final vList0 = rsg.getSTList(1, 1);
      final e1 = STtag(PTag.kSelectorSTValue, vList0);
    ...
    test('ST fromValueField', () {
      ...
      for (var i = 1; i < 10; i++) {
        global.throwOnError = false;
        final vList1 = rsg.getSTList(1, i);
  ...
  group('ST', () {
    ...
    test('ST fromUtf8', () {
      ...
      final s0 = vList[0];
      log
        ..debug('Bytes.fromUtf8List(vList1): ${Bytes.utf8(s0)}')
        ..debug('s0:"$s0"');
      final bytes = cvt.utf8.encode(vList[0]);
      expect(Bytes.utf8(s0), equals(bytes));
    });
