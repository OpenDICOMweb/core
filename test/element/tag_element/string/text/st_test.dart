  ...
  group('ST Tests', () {
    ...
    test('ST fromBytes random', () {
      for (var i = 0; i < 10; i++) {
        ...
        final e0 = STtag.fromBytes(bytes, PTag.kSelectorSTValue);
    ...
    test('ST fromBytes good values', () {
      for (var i = 0; i < 10; i++) {
        ...
        for (var listS in vList1) {
          ...
          final e1 = STtag.fromBytes(bytes0, PTag.kSelectorSTValue);
          log.debug('e1: ${e1.info}');
          expect(e1.hasValidValues, true);
        }
      }
    ...
    test('ST fromBytes bad values', () {
      for (var i = 0; i < 10; i++) {
        ...
        for (var listS in vList1) {
          ...
          final bytes0 = Bytes.fromAscii(listS);
          //final bytes0 = new Bytes();
          final e1 = STtag.fromBytes(bytes0, PTag.kSelectorCSValue);
          expect(e1, isNull);
 ...
 */
    ...
    test('ST isValidVFLength good values', () {
      ...
      expect(ST.isValidVFLength(ST.kMaxVFLength, null, PTag.kSelectorSTValue),
          true);
    });
