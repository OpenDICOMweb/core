...
void main() {
  ...
  group('OFTag', () {
    ...
    test('OF update', () {
      ...
      expect(e0.update([1.2, 1.3, 1.4]).values, equals([1.2, 1.3, 1.4]));

      final e1 = new OFtag(PTag.kUValueData, listFloat32Common0);
      expect(e1.update(listFloat32Common0).values, equals(listFloat32Common0));
      ...
      for (var i = 1; i <= floatUpdateValues.length - 1; i++) {
        final e2 = new OFtag(PTag.kSelectorOFValue,
      ...
      final e3 = new OFtag(PTag.lookupByCode(kUValueData),
          new Float32List.fromList(floatUpdateValues));
      expect(e3.update(new Float32List.fromList(floatUpdateValues)),
