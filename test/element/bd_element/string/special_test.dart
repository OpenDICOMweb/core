  ...
  group('AEtag', () {
    ...
    test('AEtag from VM.k1_n', () {
      for (var i = 1; i < 10; i++) {
        ...
        log.debug('vList0: ${vList0[0].codeUnits}');
        system.throwOnError = false;
  ...
  group('OFtag', () {
    ...
    test('OFtag from VM.k1', () {
      for (var i = 0; i < 10; i++) {
        ...
        log.debug('of1:$of1');
        final bd0 = Float32.toBytes(floatList0);
        log
          ..debug('bd.lengthInBytes: ${bd0.lengthInBytes}')
