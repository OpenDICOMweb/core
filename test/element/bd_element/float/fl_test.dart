...
void main() {
  ...
  test('FL hasValidValues: good values', () {
    ...
    final fl0 = makeFL(kVectorAccuracy, doubleList);
  ...
  test('FL hasValidValues random: good values', () {
    for (var i = 0; i < 10; i++) {
      ...
      final fl0 = makeFL(kSelectorFDValue, float32List0);
  ...
  test('FL hasValidValues: good values', () {
    for (var i = 0; i < 10; i++) {
      ...
      final fl0 = makeFL(kCornealVertexLocation, float32List0);
      log
  ...
  test('FL hasValidValues: bad values', () {
    for (var i = 0; i < 10; i++) {
      ...
      final flbd = makeFL(kCornealVertexLocation, floatList0);
  ...
  test('FL [] as values', () {
    final fl0 = makeFL(kTableOfParameterValues, []);
    expect(fl0.hasValidValues, true);
  ...
  test('FL hashCode and == random', () {
    ...
    for (var i = 0; i < 10; i++) {
      ...
      final fl0 = makeFL(kAbsoluteChannelDisplayScale, floatList0);

      //bd = makeFL(kAbsoluteChannelDisplayScale, floatList0);
      final fl1 = makeFL(kAbsoluteChannelDisplayScale, floatList0);
      log
      ...
      final fl2 = makeFL(kRecommendedDisplayFrameRateInFloat, floatList1);
      ...
      final fl3 = makeFL(kCornealVertexLocation, floatList2);
      ...
      final fl4 = makeFL(kCornealPointLocation, floatList3);
      ...
      final fl5 = makeFL(kPointsBoundingBoxCoordinates, floatList4);
      ...
      final fl6 = makeFL(kFractionalChannelDisplayScale, floatList5);
  ...
  test('Create FL.isValidValues', () {
    ...
    for (var i = 0; i <= doubleList.length - 1; i++) {
      final fl0 =
          makeFL(kExaminedBodyThickness, <double>[doubleList[i]]);
      log.debug('fl0: $fl0');
