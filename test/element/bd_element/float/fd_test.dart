...
void main() {
  ...
  group('FD Tests', () {
    test('FD hasValidValues: good values', () {
      system.throwOnError = false;
      final fd0 = makeFD(kInversionTimes, doubleList);
    ...
    test('FD hasValidValues random: good values', () {
      for (var i = 0; i < 10; i++) {
        ...
        final fd0 = makeFD(kDiffusionBValue, float64List);
        final v = fd0.vfBytes.getFloat32List();
        log.debug('fd0: $fd0');
        expect(fd0.hasValidValues, true);
    ...
    test('FD hasValidValues: good values', () {
      for (var i = 0; i < 10; i++) {
        ...
        final fd0 = makeFD(kReconstructionFieldOfView, float64List);
    ...
    test('FD hasValidValues: bad values', () {
      for (var i = 0; i < 10; i++) {
        ...
        final fd0 = makeFD(kTagThickness, float64List);
    ...
    test('FD [] as values', () {
      final fd0 = makeFD(kTagThickness, []);
      expect(fd0.hasValidValues, true);
    ...
    test('FD hashCode and == random', () {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        final fd0 = makeFD(kTagThickness, floatList0);
        final fd1 = makeFD(kTagThickness, floatList0);
        log
        ...
        final fd2 = makeFD(kTablePosition, floatList1);
        ...
        final fd3 = makeFD(kRecommendedRotationPoint, floatList2);
        ...
        final fd4 = makeFD(kThreeDDegreeOfFreedomAxis, floatList3);
        ...
        final fd5 = makeFD(kImageOrientationVolume, floatList4);
        ...
        final fd6 = makeFD(kTagThickness, floatList5);
    ...
    test('FD isValidValues', () {
      ...
      for (var i = 0; i <= doubleList.length - 1; i++) {
        final fd0 = makeFD(kTagThickness, <double>[doubleList[i]]);
        expect(
