...
void main() {
  Server.initialize(name: 'element_bytes/ur_test', level: Level.info);
  ...
  group('URbytes', () {
    ...
    test('URbytes from VM.k1', () {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        for (final code in urVM1Tags) {
          final e0 = URbytes.fromValues(code, vList0, type);
          log.debug('e0: $e0');
    ...
    test('URbytes from VM.k1_n', () {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        final e0 = URbytes.fromValues(kSelectorURValue, vList0, type);
        log.debug('e0: $e0');
        final e1 = ElementBytes.fromBytes(e0.be, rds, isEvr: true);
        log.debug('e1: $e1');
        expect(e0.hasValidValues, true);
