...
void main() {
  Server.initialize(name: 'element_bytes/ob_test', level: Level.info);
  ...
  group('OBbytes', () {
    ...
    test('OBbytes from VM.k1', () {
      for (var i = 0; i < 10; i++) {
        ...
        for (final code in obVM1Tags0) {
          final e0 = OBbytes.fromValues(code, vList0, type);
          log.debug('e0: $e0');
