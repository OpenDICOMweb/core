...
void main() {
  Server.initialize(
      name: 'element_bytes/pixel_data/un_pixel_data_test.dart', level: Level.info);
  ...
  group('UNbytes', () {
    test('UNbytes from VM.k1', () {
      for (var i = 1; i < 10; i++) {
        ...
        final e0 = UNbytes.fromValues(kPixelData, vList0, type);
        log.debug('e0: $e0');
        const ts = TransferSyntax.kExplicitVRLittleEndian;
        final e1 = UNbytesPixelData.fromBytes(e0.be, ts);
        log.debug('e1: $e1');
