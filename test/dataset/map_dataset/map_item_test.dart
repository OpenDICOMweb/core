...
void main() {
  ...
  group('MapItem', () {
    ...
    test('Simple UItag, replace, and replaceUid test', () {
      ...
      // Test replace
      final item = MapItem.empty(rds, null)..add(ui0);
    ...
    test('== and hashCode', () {
      final item0 = MapItem.empty(rds, null);
      final item1 = MapItem.empty(rds, null);
      final item2 = MapItem.empty(rds, null);
    ...
    test('copy', () {
      ...
      expect(copy0, equals(MapItem.from(item, rds, null)));
    ...
    test('getUid', () {
      ...
      final ui0 = UItag(PTag.kStudyInstanceUID, uidList);
      final ui1 = UItag(PTag.kSelectorUIValue, uidList);
      final un0 = UNtag(PTag.kNoName0, [123]);
