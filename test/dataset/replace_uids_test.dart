...
void main() {
  Server.initialize(name: 'replace_uids', level: Level.info);
    ...
    test('update', () {
      final ui0 = new UItag(PTag.kStudyInstanceUID, ['1.2.840.10008.5.1.4.34.5']);
      log.debug('ui0: $ui0');
      ...
      expect(rootDS0.update(ui0.tag.index, ['1.804.35.0.89'], required: true), isNull);
      ...
      expect(rootDS0.updateUid(ui0.tag.index, <Uid>[]), isNull);
			...
			system.throwOnError = false;
			expect(rootDS0.updateUid(ui0.tag.index, <Uid>[], required: false), isNull);
			...
			final ui4r1 = rootDS4.update(
					ui4.tag.code, ['1.2.840.10008.5.1.4.1.1.1']);
			...
			final ui5r = rootDS4.update(
					PTag.kAbortReason.code, ['1.2.840.10008.5.1.4.1.1.1']);
			log.debug('ui4r1:$ui4r1');
			expect(ui5r, isNull);
			...
			log.debug('ui6: $ui6');
			final uidList4r = ['1.2.840.10008.5.1.4.1.1.30', '1.2.840.10008.5.1.4.1.1.77.5.4'];
